...
Blockly.VerticalFlyout.prototype.CHECKBOX_SPACE_X =
  Blockly.VerticalFlyout.prototype.CHECKBOX_SIZE + 2 * Blockly.VerticalFlyout.prototype.CHECKBOX_MARGIN;
...
Blockly.VerticalFlyout.prototype.createDom = function (tagName) {
  ...
  */
  ...
  this.resizeHandle_ = Blockly.utils.createSvgElement(
    'rect',
    {
...
Blockly.VerticalFlyout.prototype.addBlockListeners_ = function (root, block, rect) {
  ...
  if (block.flyoutCheckbox) {
    this.listeners_.push(
      Blockly.bindEvent_(block.flyoutCheckbox.svgRoot, 'mousedown', null, this.checkboxClicked_(block.flyoutCheckbox))
    );
  }
};
