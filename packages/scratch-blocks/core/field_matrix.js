...
Blockly.FieldMatrix.prototype.init = function () {
  ...
  this.size_.width =
    Blockly.FieldMatrix.THUMBNAIL_SIZE + Blockly.FieldMatrix.ARROW_SIZE + Blockly.BlockSvg.DROPDOWN_ARROW_PADDING * 1.5;
  ...
  if (!this.arrow_) {
    var arrowX = Blockly.FieldMatrix.THUMBNAIL_SIZE + Blockly.BlockSvg.DROPDOWN_ARROW_PADDING * 1.5;
...
Blockly.FieldMatrix.prototype.showEditor_ = function () {
  ...
  for (var i = 0; i < 5; i++) {
    for (var n = 0; n < 5; n++) {
      var x = Blockly.FieldMatrix.MATRIX_NODE_SIZE * n + Blockly.FieldMatrix.MATRIX_NODE_PAD * (n + 1);
      var y = Blockly.FieldMatrix.MATRIX_NODE_SIZE * i + Blockly.FieldMatrix.MATRIX_NODE_PAD * (i + 1);
      var attr = {
        x: x + 'px',
        y: y + 'px',
