...
Blockly.ConnectionDB.prototype.findConnection = function (conn) {
  ...
  while (pointerMax < this.connections_.length && this.connections_[pointerMax].y_ == yPos) {
...
Blockly.ConnectionDB.prototype.searchForClosest = function (conn, maxRadius, dxy) {
  ...
  while (pointerMax < this.connections_.length && this.isInYRange_(pointerMax, conn.y_, maxRadius)) {
