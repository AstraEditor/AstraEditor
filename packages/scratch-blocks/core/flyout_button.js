...
Blockly.FlyoutButton = function (workspace, targetWorkspace, xml, isLabel) {
  ...
  } else if (!this.isLabel_ && !(callbackKey && targetWorkspace.getButtonCallback(callbackKey))) {
...
Blockly.FlyoutButton.prototype.addTextSvg = function (isLabel) {
  ...
  var rect = Blockly.utils.createSvgElement(
    'rect',
    {
      class: isLabel ? 'blocklyFlyoutLabelBackground' : 'blocklyFlyoutButtonBackground',
      rx: 4,
      ry: 4
    },
    this.svgGroup_
  ...
  svgText.setAttribute('dy', goog.userAgent.EDGE_OR_IE ? Blockly.Field.IE_TEXT_OFFSET : '0');
