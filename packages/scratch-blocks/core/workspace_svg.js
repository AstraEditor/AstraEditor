...
Blockly.WorkspaceSvg.prototype.getSvgXY = function (element) {
  ...
  var y = 0;
  var scale = 1;
  if (goog.dom.contains(this.getCanvas(), element) || goog.dom.contains(this.getBubbleCanvas(), element)) {
...
Blockly.WorkspaceSvg.prototype.refreshToolboxSelection_ = function () {
  ...
  // disabled.
  if (this.toolbox_) {
    if (this.toolbox_.flyout_ && !this.currentGesture_ && this.toolboxRefreshEnabled_) {
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function (e) {
  ...
  var deleteOption = {
    text: deleteCount == 1 ? Blockly.Msg.DELETE_BLOCK : Blockly.Msg.DELETE_X_BLOCKS.replace('%1', String(deleteCount)),
...
Blockly.WorkspaceSvg.getTopLevelWorkspaceMetrics_ = function () {
  ...
  var flyoutDimensions = Blockly.WorkspaceSvg.getDimensionsPx_(flyout);
