...
Blockly.WidgetDiv.createDom = function () {
  ...
  Blockly.WidgetDiv.DIV = goog.dom.createDom(goog.dom.TagName.DIV, 'blocklyWidgetDiv');
...
Blockly.WidgetDiv.repositionForWindowResize = function () {
  ...
  if (Blockly.WidgetDiv.owner_ && Blockly.WidgetDiv.owner_.getScaledBBox_ && Blockly.WidgetDiv.owner_.getSize) {
