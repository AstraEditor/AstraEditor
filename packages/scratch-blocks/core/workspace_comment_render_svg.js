...
Blockly.WorkspaceCommentSvg.prototype.resizeComment_ = function () {
  ...
  this.textarea_.style.height = this.height_ - doubleBorderWidth - textOffset - topOffset + 'px';
};
...
Blockly.WorkspaceCommentSvg.prototype.setSize = function (width, height) {
  ...
  if (this.RTL) {
    this.minimizeArrow_.setAttribute(
      'x',
      width - Blockly.WorkspaceCommentSvg.MINIMIZE_ICON_SIZE - Blockly.WorkspaceCommentSvg.TOP_BAR_ICON_INSET
    );
    this.deleteIcon_.setAttribute('x', -width + Blockly.WorkspaceCommentSvg.TOP_BAR_ICON_INSET);
    ...
    this.deleteIcon_.setAttribute(
      'x',
      width - Blockly.WorkspaceCommentSvg.DELETE_ICON_SIZE - Blockly.WorkspaceCommentSvg.TOP_BAR_ICON_INSET
    );
  }
  ...
  if (this.resizeGroup_) {
    if (this.RTL) {
      ...
      this.resizeGroup_.setAttribute(
        'transform',
        'translate(' + (width - doubleBorderWidth - resizeSize) + ',' + (height - doubleBorderWidth - resizeSize) + ')'
      );
    }
  }
...
Blockly.WorkspaceComment.prototype.setMinimized = function (minimize) {
  ...
  Blockly.Events.fire(
    new Blockly.Events.CommentChange(this, { minimized: this.isMinimized_ }, { minimized: minimize })
  );
