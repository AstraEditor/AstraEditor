...
Blockly.ScratchBlocks.VerticalExtensions.colourHelper = function (category) {
  ...
  if (!(colours && colours.primary && colours.secondary && colours.tertiary && colours.quaternary)) {
...
Blockly.ScratchBlocks.VerticalExtensions.PROCEDURE_CALL_CONTEXTMENU = {
  ...
  customContextMenu: function (menuOptions) {
    menuOptions.push(Blockly.Procedures.makeEditOption(this));
    if (!this.isInFlyout && Blockly.Procedures.USER_CAN_CHANGE_CALL_TYPE && this.workspace.procedureReturnsEnabled) {
...
Blockly.ScratchBlocks.VerticalExtensions.registerAll = function () {
  ...
  Blockly.Extensions.register('from_extension', Blockly.ScratchBlocks.VerticalExtensions.FROM_EXTENSION);
