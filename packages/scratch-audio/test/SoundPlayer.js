...
tap.test('SoundPlayer', (suite) => {
  ...
  suite.test('connect', (t) => {
    ...
    t.deepEqual(help.engineInputs, [soundPlayer.outputNode.toJSON()], 'output node connects to input node');
    t.end();
  });
  ...
  suite.test('play while playing', (t) => {
    ...
    return Promise.resolve()
      ...
      .then(() => {
        ...
        t.notEqual(help.engineInputs[0].gain.value, 1, 'old sound connected to gain node which will fade');
