!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(t)
      : ((e.ReactIntlLocaleData = e.ReactIntlLocaleData || {}), (e.ReactIntlLocaleData.index = t()));
})(this, function () {
  'use strict';
  return [
    {
      ...
      fields: {
        year: {
          displayName: 'jaar',
          relative: { 0: 'hierdie jaar', 1: 'volgende jaar', '-1': 'verlede jaar' },
          relativeTime: {
        ...
        'year-short': {
          ...
          relative: { 0: 'hierdie jaar', 1: 'volgende jaar', '-1': 'verlede jaar' },
          relativeTime: {
            future: { one: 'oor {0} j.', other: 'oor {0} j.' },
            past: { one: '{0} j. gelede', other: '{0} j. gelede' }
          }
        },
        month: {
          displayName: 'maand',
          relative: { 0: 'vandeesmaand', 1: 'volgende maand', '-1': 'verlede maand' },
          relativeTime: {
            future: { one: 'oor {0} maand', other: 'oor {0} maande' },
        ...
        'month-short': {
          ...
          relative: { 0: 'vandeesmaand', 1: 'volgende maand', '-1': 'verlede maand' },
          relativeTime: {
            future: { one: 'oor {0} md.', other: 'oor {0} md.' },
            past: { one: '{0} md. gelede', other: '{0} md. gelede' }
          }
        },
        day: {
          displayName: 'dag',
          relative: { 0: 'vandag', 1: 'môre', 2: 'oormôre', '-2': 'eergister', '-1': 'gister' },
          relativeTime: {
            future: { one: 'oor {0} dag', other: 'oor {0} dae' },
        ...
        'hour-short': {
          ...
          relative: { 0: 'hierdie uur' },
          relativeTime: {
            future: { one: 'oor {0} u.', other: 'oor {0} u.' },
            past: { one: '{0} u. gelede', other: '{0} u. gelede' }
          }
        },
        minute: {
          displayName: 'minuut',
          ...
          relativeTime: {
            future: { one: 'oor {0} minuut', other: 'oor {0} minute' },
        ...
        'minute-short': {
          ...
          relative: { 0: 'hierdie minuut' },
          relativeTime: {
            future: { one: 'oor {0} min.', other: 'oor {0} min.' },
            past: { one: '{0} min. gelede', other: '{0} min. gelede' }
          }
        },
        second: {
          displayName: 'sekonde',
        ...
        'second-short': {
          ...
          relative: { 0: 'nou' },
          relativeTime: {
            future: { one: 'oor {0} s.', other: 'oor {0} s.' },
            past: { one: '{0} s. gelede', other: '{0} s. gelede' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          ...
          relativeTime: {
            future: { one: 'በ{0} ዓመታት ውስጥ', other: 'በ{0} ዓመታት ውስጥ' },
            past: { one: 'ከ{0} ዓመታት በፊት', other: 'ከ{0} ዓመታት በፊት' }
          }
        },
        month: {
          displayName: 'ወር',
        ...
        'month-short': {
          ...
          relative: { 0: 'በዚህ ወር', 1: 'የሚቀጥለው ወር', '-1': 'ያለፈው ወር' },
          relativeTime: {
            future: { one: 'በ{0} ወራት ውስጥ', other: 'በ{0} ወራት ውስጥ' },
            past: { one: 'ከ{0} ወራት በፊት', other: 'ከ{0} ወራት በፊት' }
          }
        },
        day: {
          displayName: 'ቀን',
          relative: { 0: 'ዛሬ', 1: 'ነገ', 2: 'ከነገ ወዲያ', '-2': 'ከትናንት ወዲያ', '-1': 'ትናንት' },
          relativeTime: {
        ...
        'day-short': {
          displayName: 'ቀን',
          relative: { 0: 'ዛሬ', 1: 'ነገ', 2: 'ከነገ ወዲያ', '-2': 'ከትናንት ወዲያ', '-1': 'ትላንትና' },
          relativeTime: {
            future: { one: 'በ{0} ቀን ውስጥ', other: 'በ{0} ቀኖች ውስጥ' },
            past: { one: 'ከ {0} ቀን በፊት', other: 'ከ{0} ቀኖች በፊት' }
          }
        },
        hour: {
          displayName: 'ሰዓት',
    ...
    },
    {
      ...
      fields: {
        year: {
          displayName: 'السنة',
          relative: { 0: 'السنة الحالية', 1: 'السنة القادمة', '-1': 'السنة الماضية' },
          relativeTime: {
            future: {
              zero: 'خلال {0} سنة',
              one: 'خلال سنة واحدة',
        ...
        day: {
          displayName: 'يوم',
          relative: { 0: 'اليوم', 1: 'غدًا', 2: 'بعد الغد', '-2': 'أول أمس', '-1': 'أمس' },
          relativeTime: {
            future: {
              zero: 'خلال {0} يوم',
              one: 'خلال يوم واحد',
    ...
    },
    {
      ...
      fields: {
        year: {
          displayName: 'বছৰ',
          relative: { 0: 'এই বছৰ', 1: 'অহা বছৰ', '-1': 'যোৱা বছৰ' },
          relativeTime: {
            future: { one: '{0} বছৰত', other: '{0} বছৰত' },
            past: { one: '{0} বছৰৰ পূৰ্বে', other: '{0} বছৰৰ পূৰ্বে' }
          }
        },
        'year-short': {
          displayName: 'বছৰ',
        ...
        month: {
          displayName: 'মাহ',
          relative: { 0: 'এই মাহ', 1: 'অহা মাহ', '-1': 'যোৱা মাহ' },
          relativeTime: {
            future: { one: '{0} মাহত', other: '{0} মাহত' },
            past: { one: '{0} মাহ পূৰ্বে', other: '{0} মাহ পূৰ্বে' }
          }
        },
        'month-short': {
          displayName: 'মাহ',
        ...
        day: {
          displayName: 'দিন',
          relative: { 0: 'আজি', 1: 'কাইলৈ', 2: 'পৰহিলৈ', '-2': 'পৰহি', '-1': 'কালি' },
          relativeTime: {
            future: { one: '{0} দিনত', other: '{0} দিনত' },
            past: { one: '{0} দিন পূৰ্বে', other: '{0} দিন পূৰ্বে' }
          }
        },
        'day-short': {
          displayName: 'দিন',
        ...
        hour: {
          displayName: 'ঘণ্টা',
          relative: { 0: 'এইটো ঘণ্টাত' },
          relativeTime: {
            future: { one: '{0} ঘণ্টাত', other: '{0} ঘণ্টাত' },
            past: { one: '{0} ঘণ্টা পূৰ্বে', other: '{0} ঘণ্টা পূৰ্বে' }
          }
        },
        'hour-short': {
          displayName: 'ঘণ্টা',
        ...
        minute: {
          displayName: 'মিনিট',
          relative: { 0: 'এইটো মিনিটত' },
          relativeTime: {
            future: { one: '{0} মিনিটত', other: '{0} মিনিটত' },
            past: { one: '{0} মিনিট পূৰ্বে', other: '{0} মিনিট পূৰ্বে' }
          }
        },
        'minute-short': {
          displayName: 'মিনিট',
        ...
        second: {
          ...
          relative: { 0: 'এতিয়া' },
          relativeTime: {
            future: { one: '{0} ছেকেণ্ডত', other: '{0} ছেকেণ্ডত' },
            past: { one: '{0} ছেকেণ্ড পূৰ্বে', other: '{0} ছেকেণ্ড পূৰ্বে' }
          }
        },
        'second-short': {
          displayName: 'ছেকেণ্ড',
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          displayName: 'añu',
          relative: { 0: 'esti añu', 1: 'l’añu vin.', '-1': 'l’añu pas.' },
          relativeTime: {
            future: { one: 'en {0} añu', other: 'en {0} años' },
            past: { one: 'hai {0} añu', other: 'hai {0} años' }
          }
        ...
        'month-short': {
          displayName: 'mes',
          relative: { 0: 'esti mes', 1: 'mes vin.', '-1': 'mes pas.' },
          relativeTime: {
            future: { one: 'en {0} mes', other: 'en {0} meses' },
            past: { one: 'hai {0} mes', other: 'hai {0} meses' }
          }
        ...
        day: {
          displayName: 'día',
          relative: { 0: 'güei', 1: 'mañana', 2: 'pasao mañana', '-2': 'antayeri', '-1': 'ayeri' },
          relativeTime: {
        ...
        'hour-short': {
          ...
          relative: { 0: 'esta hora' },
          relativeTime: {
            future: { one: 'en {0} h.', other: 'en {0} h.' },
            past: { one: 'hai {0} h.', other: 'hai {0} h.' }
          }
        },
        minute: {
          displayName: 'minutu',
        ...
        'minute-short': {
          ...
          relativeTime: {
            ...
            past: { one: 'hai {0} min.', other: 'hai {0} min.' }
          }
        },
        second: {
          displayName: 'segundu',
        ...
        'second-short': {
          ...
          relative: { 0: 'agora' },
          relativeTime: {
            future: { one: 'en {0} seg.', other: 'en {0} seg.' },
            past: { one: 'hai {0} seg.', other: 'hai {0} seg.' }
          }
        }
      }
    },
    {
      ...
      pluralRuleFunction: function (e, t) {
        var a = String(e).split('.')[0],
          ...
          o = a.slice(-3);
        return t
          ? 1 == r || 2 == r || 5 == r || 7 == r || 8 == r || 20 == i || 50 == i || 70 == i || 80 == i
            ? 'one'
            : 3 == r ||
                4 == r ||
                100 == o ||
    ...
    },
    {
      ...
      fields: {
        year: {
          displayName: 'год',
          relative: { 0: 'у гэтым годзе', 1: 'у наступным годзе', '-1': 'у мінулым годзе' },
          relativeTime: {
            future: { one: 'праз {0} год', few: 'праз {0} гады', many: 'праз {0} гадоў', other: 'праз {0} года' },
            past: { one: '{0} год таму', few: '{0} гады таму', many: '{0} гадоў таму', other: '{0} года таму' }
          }
        },
        'year-short': {
          displayName: 'г.',
          relative: { 0: 'у гэтым годзе', 1: 'у наступным годзе', '-1': 'у мінулым годзе' },
          relativeTime: {
            future: { one: 'праз {0} г.', few: 'праз {0} г.', many: 'праз {0} г.', other: 'праз {0} г.' },
            past: { one: '{0} г. таму', few: '{0} г. таму', many: '{0} г. таму', other: '{0} г. таму' }
          }
        },
        month: {
          displayName: 'месяц',
          relative: { 0: 'у гэтым месяцы', 1: 'у наступным месяцы', '-1': 'у мінулым месяцы' },
          relativeTime: {
            future: {
              one: 'праз {0} месяц',
              few: 'праз {0} месяцы',
            ...
            past: { one: '{0} месяц таму', few: '{0} месяцы таму', many: '{0} месяцаў таму', other: '{0} месяца таму' }
          }
        },
        'month-short': {
          displayName: 'мес.',
          relative: { 0: 'у гэтым месяцы', 1: 'у наступным месяцы', '-1': 'у мінулым месяцы' },
          relativeTime: {
            future: { one: 'праз {0} мес.', few: 'праз {0} мес.', many: 'праз {0} мес.', other: 'праз {0} мес.' },
            past: { one: '{0} мес. таму', few: '{0} мес. таму', many: '{0} мес. таму', other: '{0} мес. таму' }
          }
        },
        day: {
          displayName: 'дзень',
          relative: { 0: 'сёння', 1: 'заўтра', 2: 'паслязаўтра', '-2': 'пазаўчора', '-1': 'учора' },
          relativeTime: {
            future: { one: 'праз {0} дзень', few: 'праз {0} дні', many: 'праз {0} дзён', other: 'праз {0} дня' },
            past: { one: '{0} дзень таму', few: '{0} дні таму', many: '{0} дзён таму', other: '{0} дня таму' }
          }
        },
        'day-short': {
          displayName: 'дзень',
        ...
        'hour-short': {
          ...
          relative: { 0: 'у гэту гадзіну' },
          relativeTime: {
            future: { one: 'праз {0} гадз', few: 'праз {0} гадз', many: 'праз {0} гадз', other: 'праз {0} гадз' },
            past: { one: '{0} гадз таму', few: '{0} гадз таму', many: '{0} гадз таму', other: '{0} гадз таму' }
          }
        },
        minute: {
          displayName: 'хвіліна',
        ...
        'minute-short': {
          ...
          relative: { 0: 'у гэту хвіліну' },
          relativeTime: {
            future: { one: 'праз {0} хв', few: 'праз {0} хв', many: 'праз {0} хв', other: 'праз {0} хв' },
            past: { one: '{0} хв таму', few: '{0} хв таму', many: '{0} хв таму', other: '{0} хв таму' }
          }
        },
        second: {
          displayName: 'секунда',
        ...
        'second-short': {
          ...
          relative: { 0: 'цяпер' },
          relativeTime: {
            future: { one: 'праз {0} с', few: 'праз {0} с', many: 'праз {0} с', other: 'праз {0} с' },
            past: { one: '{0} с таму', few: '{0} с таму', many: '{0} с таму', other: '{0} с таму' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        year: {
          displayName: 'година',
          relative: { 0: 'тази година', 1: 'следващата година', '-1': 'миналата година' },
          relativeTime: {
        ...
        'year-short': {
          displayName: 'г.',
          relative: { 0: 'т. г.', 1: 'следв. г.', '-1': 'мин. г.' },
          relativeTime: {
            future: { one: 'след {0} г.', other: 'след {0} г.' },
            past: { one: 'преди {0} г.', other: 'преди {0} г.' }
          }
        },
        month: {
          displayName: 'месец',
          relative: { 0: 'този месец', 1: 'следващ месец', '-1': 'предходен месец' },
          relativeTime: {
        ...
        'month-short': {
          displayName: 'мес.',
          relative: { 0: 'този мес.', 1: 'следв. мес.', '-1': 'мин. мес.' },
          relativeTime: {
            future: { one: 'след {0} м.', other: 'след {0} м.' },
            past: { one: 'преди {0} м.', other: 'преди {0} м.' }
          }
        },
        day: {
          displayName: 'ден',
          relative: { 0: 'днес', 1: 'утре', 2: 'вдругиден', '-2': 'онзи ден', '-1': 'вчера' },
          relativeTime: {
        ...
        'hour-short': {
          ...
          relative: { 0: 'в този час' },
          relativeTime: {
            future: { one: 'след {0} ч', other: 'след {0} ч' },
            past: { one: 'преди {0} ч', other: 'преди {0} ч' }
          }
        },
        minute: {
          displayName: 'минута',
        ...
        'minute-short': {
          ...
          relative: { 0: 'в тази минута' },
          relativeTime: {
            future: { one: 'след {0} мин', other: 'след {0} мин' },
            past: { one: 'преди {0} мин', other: 'преди {0} мин' }
          }
        },
        second: {
          displayName: 'секунда',
        ...
        'second-short': {
          ...
          relative: { 0: 'сега' },
          relativeTime: {
            future: { one: 'след {0} сек', other: 'след {0} сек' },
            past: { one: 'преди {0} сек', other: 'преди {0} сек' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'দিন',
          relative: { 0: 'আজ', 1: 'আগামীকাল', 2: 'আগামী পরশু', '-2': 'গত পরশু', '-1': 'গতকাল' },
          relativeTime: {
        ...
        minute: {
          ...
          relativeTime: {
            ...
            past: { one: '{0} মিনিট আগে', other: '{0} মিনিট আগে' }
          }
        },
        'minute-short': {
          displayName: 'মিনিট',
    ...
    { locale: 'bn-IN', parentLocale: 'bn' },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'ཉིན།',
          relative: { 0: 'དེ་རིང་', 1: 'སང་ཉིན་', 2: 'གནངས་ཉིན་', '-2': 'ཁས་ཉིན་', '-1': 'ཁས་ས་' },
          relativeTime: { future: { other: '+{0} d' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'ཉིན།',
    ...
    { locale: 'bo-IN', parentLocale: 'bo' },
    {
      ...
      pluralRuleFunction: function (e, t) {
        ...
        return t
          ...
          : 1 == i && 11 != o && 71 != o && 91 != o
            ...
            : 2 == i && 12 != o && 72 != o && 92 != o
              ? 'two'
              : (3 == i || 4 == i || 9 == i) && (o < 10 || o > 19) && (o < 70 || o > 79) && (o < 90 || o > 99)
                ? 'few'
                : 0 != e && r && 0 == n
                  ? 'many'
                  : 'other';
      ...
      fields: {
        ...
        'year-short': {
          displayName: 'bl.',
          relative: { 0: 'hevlene', 1: 'ar bl. a zeu', '-1': 'warlene' },
          relativeTime: {
            future: {
              one: 'a-benn {0} bl.',
              two: 'a-benn {0} bl.',
            ...
            past: { one: '{0} bl. zo', two: '{0} bl. zo', few: '{0} bl. zo', many: '{0} bl. zo', other: '{0} bl. zo' }
          }
        },
        month: {
          displayName: 'miz',
          relative: { 0: 'ar miz-mañ', 1: 'ar miz a zeu', '-1': 'ar miz diaraok' },
          relativeTime: {
            future: {
              one: 'a-benn {0} miz',
              two: 'a-benn {0} viz',
        ...
        day: {
          displayName: 'deiz',
          relative: { 0: 'hiziv', 1: 'warcʼhoazh', '-2': 'dercʼhent-decʼh', '-1': 'decʼh' },
          relativeTime: {
            future: {
              one: 'a-benn {0} deiz',
              two: 'a-benn {0} zeiz',
        ...
        'day-short': {
          ...
          relativeTime: {
            ...
            past: { one: '{0} d zo', two: '{0} d zo', few: '{0} d zo', many: '{0} d zo', other: '{0} d zo' }
          }
        },
        hour: {
          displayName: 'eur',
        ...
        'hour-short': {
          ...
          relativeTime: {
            ...
            past: { one: '{0} e zo', two: '{0} e zo', few: '{0} e zo', many: '{0} e zo', other: '{0} e zo' }
          }
        },
        minute: {
          displayName: 'munut',
        ...
        'minute-short': {
          ...
          relativeTime: {
            ...
            past: { one: '{0} min zo', two: '{0} min zo', few: '{0} min zo', many: '{0} min zo', other: '{0} min zo' }
          }
        },
        second: {
          displayName: 'eilenn',
        ...
        'second-short': {
          ...
          relativeTime: {
            ...
            past: { one: '{0} s zo', two: '{0} s zo', few: '{0} s zo', many: '{0} s zo', other: '{0} s zo' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      pluralRuleFunction: function (e, t) {
        ...
        return t
          ...
          : (o && 1 == n && 11 != s) || (1 == l && 11 != h)
            ? 'one'
            : (o && n >= 2 && n <= 4 && (s < 12 || s > 14)) || (l >= 2 && l <= 4 && (h < 12 || h > 14))
              ? 'few'
              : 'other';
      },
      fields: {
        year: {
          displayName: 'godina',
          relative: { 0: 'ove godine', 1: 'sljedeće godine', '-1': 'prošle godine' },
          relativeTime: {
            future: { one: 'za {0} godinu', few: 'za {0} godine', other: 'za {0} godina' },
            past: { one: 'prije {0} godinu', few: 'prije {0} godine', other: 'prije {0} godina' }
          }
        },
        'year-short': {
          displayName: 'god.',
          relative: { 0: 'ove godine', 1: 'sljedeće godine', '-1': 'prošle godine' },
          relativeTime: {
            future: { one: 'za {0} god.', few: 'za {0} god.', other: 'za {0} god.' },
            past: { one: 'prije {0} god.', few: 'prije {0} god.', other: 'prije {0} god.' }
          }
        },
        month: {
          displayName: 'mjesec',
          relative: { 0: 'ovaj mjesec', 1: 'sljedeći mjesec', '-1': 'prošli mjesec' },
          relativeTime: {
            future: { one: 'za {0} mjesec', few: 'za {0} mjeseca', other: 'za {0} mjeseci' },
            past: { one: 'prije {0} mjesec', few: 'prije {0} mjeseca', other: 'prije {0} mjeseci' }
          }
        },
        'month-short': {
          displayName: 'mj.',
          relative: { 0: 'ovaj mjesec', 1: 'sljedeći mjesec', '-1': 'prošli mjesec' },
          relativeTime: {
            future: { one: 'za {0} mj.', few: 'za {0} mj.', other: 'za {0} mj.' },
            past: { one: 'prije {0} mj.', few: 'prije {0} mj.', other: 'prije {0} mj.' }
          }
        },
        day: {
          displayName: 'dan',
          relative: { 0: 'danas', 1: 'sutra', 2: 'prekosutra', '-2': 'prekjučer', '-1': 'jučer' },
          relativeTime: {
            future: { one: 'za {0} dan', few: 'za {0} dana', other: 'za {0} dana' },
            past: { one: 'prije {0} dan', few: 'prije {0} dana', other: 'prije {0} dana' }
          }
        },
        'day-short': {
          displayName: 'dan',
          relative: { 0: 'danas', 1: 'sutra', 2: 'prekosutra', '-2': 'prekjučer', '-1': 'jučer' },
          relativeTime: {
            future: { one: 'za {0} d.', few: 'za {0} d.', other: 'za {0} d.' },
            past: { one: 'prije {0} d.', few: 'prije {0} d.', other: 'prije {0} d.' }
          }
        },
        hour: {
          displayName: 'sat',
          relative: { 0: 'ovaj sat' },
          relativeTime: {
            future: { one: 'za {0} sat', few: 'za {0} sata', other: 'za {0} sati' },
            past: { one: 'prije {0} sat', few: 'prije {0} sata', other: 'prije {0} sati' }
          }
        },
        'hour-short': {
          displayName: 'h',
        ...
        minute: {
          ...
          relativeTime: {
            future: { one: 'za {0} minutu', few: 'za {0} minute', other: 'za {0} minuta' },
            past: { one: 'prije {0} minutu', few: 'prije {0} minute', other: 'prije {0} minuta' }
          }
        },
        'minute-short': {
          displayName: 'min.',
          relative: { 0: 'ova minuta' },
          relativeTime: {
            future: { one: 'za {0} min.', few: 'za {0} min.', other: 'za {0} min.' },
            past: { one: 'prije {0} min.', few: 'prije {0} min.', other: 'prije {0} min.' }
          }
        },
        second: {
          displayName: 'sekunda',
          relative: { 0: 'sada' },
          relativeTime: {
            future: { one: 'za {0} sekundu', few: 'za {0} sekunde', other: 'za {0} sekundi' },
            past: { one: 'prije {0} sekundu', few: 'prije {0} sekunde', other: 'prije {0} sekundi' }
          }
        },
        'second-short': {
          displayName: 'sek.',
          relative: { 0: 'sada' },
          relativeTime: {
            future: { one: 'za {0} sek.', few: 'za {0} sek.', other: 'za {0} sek.' },
            past: { one: 'prije {0} sek.', few: 'prije {0} sek.', other: 'prije {0} sek.' }
          }
        }
      }
    },
    {
      ...
      fields: {
        year: {
          displayName: 'година',
          relative: { 0: 'Ове године', 1: 'Следеће године', '-1': 'Прошле године' },
          relativeTime: {
        ...
        month: {
          displayName: 'месец',
          relative: { 0: 'Овог месеца', 1: 'Следећег месеца', '-1': 'Прошлог месеца' },
          relativeTime: {
            future: { one: 'за {0} месец', few: 'за {0} месеца', other: 'за {0} месеци' },
            past: { one: 'пре {0} месец', few: 'пре {0} месеца', other: 'пре {0} месеци' }
          }
        },
        'month-short': {
          displayName: 'месец',
        ...
        day: {
          displayName: 'дан',
          relative: { 0: 'данас', 1: 'сутра', 2: 'прекосутра', '-2': 'прекјуче', '-1': 'јуче' },
          relativeTime: {
            future: { one: 'за {0} дан', few: 'за {0} дана', other: 'за {0} дана' },
            past: { one: 'пре {0} дан', few: 'пре {0} дана', other: 'пре {0} дана' }
          }
        },
        'day-short': {
          displayName: 'дан',
        ...
        hour: {
          ...
          relative: { 0: 'this hour' },
          relativeTime: {
            future: { one: 'за {0} сат', few: 'за {0} сата', other: 'за {0} сати' },
            past: { one: 'пре {0} сат', few: 'пре {0} сата', other: 'пре {0} сати' }
          }
        },
        'hour-short': {
          displayName: 'час',
        ...
        minute: {
          ...
          relative: { 0: 'this minute' },
          relativeTime: {
            future: { one: 'за {0} минут', few: 'за {0} минута', other: 'за {0} минута' },
            past: { one: 'пре {0} минут', few: 'пре {0} минута', other: 'пре {0} минута' }
          }
        },
        'minute-short': {
          displayName: 'минут',
        ...
        second: {
          ...
          relative: { 0: 'now' },
          relativeTime: {
            future: { one: 'за {0} секунд', few: 'за {0} секунде', other: 'за {0} секунди' },
            past: { one: 'пре {0} секунд', few: 'пре {0} секунде', other: 'пре {0} секунди' }
          }
        },
        'second-short': {
          displayName: 'секунд',
    ...
    { locale: 'bs-Latn', parentLocale: 'bs' },
    {
      ...
      fields: {
        ...
        month: {
          displayName: 'mes',
          relative: { 0: 'aquest mes', 1: 'el mes que ve', '-1': 'el mes passat' },
          relativeTime: {
        ...
        day: {
          displayName: 'dia',
          relative: { 0: 'avui', 1: 'demà', 2: 'demà passat', '-2': 'abans-d’ahir', '-1': 'ahir' },
          relativeTime: {
        ...
        'hour-short': {
          ...
          relative: { 0: 'aquesta hora' },
          relativeTime: {
            future: { one: 'd’aquí a {0} h', other: 'd’aquí a {0} h' },
            past: { one: 'fa {0} h', other: 'fa {0} h' }
          }
        },
        minute: {
          displayName: 'minut',
        ...
        'minute-short': {
          ...
          relative: { 0: 'aquest minut' },
          relativeTime: {
            future: { one: 'd’aquí a {0} min', other: 'd’aquí a {0} min' },
            past: { one: 'fa {0} min', other: 'fa {0} min' }
          }
        },
        second: {
          displayName: 'segon',
        ...
        'second-short': {
          ...
          relative: { 0: 'ara' },
          relativeTime: {
            future: { one: 'd’aquí a {0} s', other: 'd’aquí a {0} s' },
            past: { one: 'fa {0} s', other: 'fa {0} s' }
          }
        }
      }
    },
    ...
    { locale: 'ca-IT', parentLocale: 'ca' },
    {
      ...
      fields: {
        year: {
          displayName: '𑄝𑄧𑄏𑄧𑄢𑄴',
          relative: { 0: '𑄃𑄬 𑄝𑄧𑄏𑄧𑄢𑄴', 1: '𑄎𑄬𑄢𑄧 𑄝𑄧𑄏𑄧𑄢𑄴', '-1': '𑄉𑄬𑄣𑄳𑄠𑄬 𑄝𑄧𑄏𑄧𑄢𑄴' },
          relativeTime: {
            future: { one: '{0} 𑄝𑄧𑄏𑄧𑄢𑄬', other: '{0} 𑄝𑄧𑄏𑄧𑄢𑄬' },
            past: { one: '{0} 𑄝𑄧𑄏𑄧𑄢𑄴 𑄃𑄉𑄬', other: '{0} 𑄝𑄧𑄏𑄧𑄢𑄴 𑄃𑄉𑄬' }
          }
        },
        'year-short': {
          displayName: '𑄝𑄧𑄏𑄧𑄢𑄴',
          relative: { 0: '𑄃𑄳𑄆𑄬 𑄝𑄧𑄏𑄧𑄢𑄴', 1: '𑄛𑄧𑄢𑄬 𑄝𑄧𑄏𑄧𑄢𑄴', '-1': '𑄉𑄬𑄣𑄳𑄠𑄬 𑄝𑄧𑄏𑄧𑄢𑄴' },
          relativeTime: {
            future: { one: '{0} 𑄝𑄧𑄏𑄧𑄢𑄬', other: '{0} 𑄝𑄧𑄏𑄧𑄢𑄬' },
            past: { one: '{0} 𑄝𑄧𑄏𑄧𑄢𑄴 𑄃𑄉𑄬', other: '{0} 𑄝𑄧𑄏𑄧𑄢𑄴 𑄃𑄉𑄬' }
          }
        ...
        month: {
          displayName: '𑄟𑄏𑄴',
          relative: { 0: '𑄃𑄳𑄆𑄬 𑄟𑄏𑄴', 1: '𑄛𑄧𑄢𑄬 𑄟𑄏𑄴', '-1': '𑄉𑄬𑄣𑄧𑄘𑄬 𑄟𑄏𑄴' },
          relativeTime: {
            future: { one: '{0} 𑄟𑄏𑄬', other: '{0} 𑄟𑄏𑄬' },
            past: { one: '{0} 𑄟𑄏𑄧 𑄃𑄉𑄬', other: '{0} 𑄟𑄏𑄧 𑄃𑄉𑄬' }
          }
        },
        'month-short': {
          displayName: '𑄟𑄏𑄴',
          relative: { 0: '𑄃𑄳𑄆𑄬 𑄟𑄏𑄴', 1: '𑄛𑄧𑄢𑄬 𑄟𑄏𑄴', '-1': '𑄉𑄬𑄣𑄧𑄉𑄬 𑄟𑄏𑄴' },
          relativeTime: {
            future: { one: '{0} 𑄟𑄏𑄬', other: '{0} 𑄟𑄏𑄬' },
            past: { one: '{0} 𑄇𑄏𑄧 𑄃𑄉𑄬', other: '{0} 𑄟𑄏𑄧 𑄃𑄉𑄬' }
          }
        },
        day: {
          displayName: '𑄘𑄨𑄚𑄴',
          ...
          relativeTime: {
            future: { one: '{0} 𑄘𑄨𑄚𑄮 𑄟𑄧𑄖𑄴𑄙𑄳𑄠', other: '{0} 𑄘𑄨𑄚𑄮 𑄟𑄧𑄖𑄴𑄙𑄳𑄠' },
            past: { one: '{0} 𑄘𑄨𑄚𑄴 𑄃𑄉𑄬', other: '{0} 𑄘𑄨𑄚𑄴 𑄃𑄉𑄬' }
          }
        },
        'day-short': {
          displayName: '𑄘𑄨𑄚𑄴',
        ...
        hour: {
          displayName: '𑄊𑄮𑄚𑄴𑄓',
          relative: { 0: '𑄃𑄳𑄆𑄬 𑄊𑄮𑄚𑄴𑄓𑄠𑄴' },
          relativeTime: {
            future: { one: '{0} 𑄊𑄮𑄚𑄴𑄓𑄠𑄴', other: '{0} 𑄊𑄮𑄚𑄴𑄓𑄠𑄴' },
            past: { one: '{0} 𑄊𑄮𑄚𑄴𑄓 𑄃𑄉𑄬', other: '{0} 𑄊𑄮𑄚𑄴𑄓 𑄃𑄉𑄬' }
          }
        },
        'hour-short': {
          displayName: '𑄊𑄮𑄚𑄴𑄓',
        ...
        minute: {
          displayName: '𑄟𑄨𑄚𑄨𑄖𑄴',
          relative: { 0: '𑄃𑄳𑄆𑄬 𑄟𑄨𑄚𑄨𑄖𑄴' },
          relativeTime: {
            future: { one: '{0} 𑄟𑄨𑄚𑄨𑄘𑄬', other: '{0} 𑄟𑄨𑄚𑄨𑄘𑄬' },
            past: { one: '{0} 𑄟𑄨𑄚𑄨𑄖𑄴 𑄃𑄉𑄬', other: '{0} 𑄟𑄨𑄚𑄨𑄖𑄴 𑄃𑄉𑄬' }
          }
        },
        'minute-short': {
          displayName: '𑄟𑄨𑄚𑄨𑄖𑄴',
        ...
        second: {
          ...
          relative: { 0: '𑄃𑄨𑄇𑄴𑄅𑄚𑄪' },
          relativeTime: {
            future: { one: '{0} 𑄥𑄬𑄉𑄬𑄚𑄴𑄘𑄬', other: '{0} 𑄥𑄬𑄉𑄬𑄚𑄴𑄘𑄬' },
            past: { one: '{0} 𑄥𑄬𑄉𑄬𑄚𑄴 𑄃𑄉𑄬', other: '{0} 𑄥𑄬𑄉𑄬𑄚𑄴 𑄃𑄉𑄬' }
          }
        },
        'second-short': {
          displayName: '𑄥𑄬𑄉𑄬𑄚𑄴',
    ...
    { locale: 'ccp-IN', parentLocale: 'ccp' },
    {
      locale: 'ce',
      pluralRuleFunction: function (e, t) {
        return t ? 'other' : 1 == e ? 'one' : 'other';
      ...
      fields: {
        year: {
          displayName: 'шо',
          relative: { 0: 'карарчу шарахь', 1: 'рогӀерчу шарахь', '-1': 'даханчу шарахь' },
          relativeTime: {
        ...
        'year-short': {
          ...
          relative: { 0: 'карарчу шарахь', 1: 'рогӀерчу шарахь', '-1': 'даханчу шарахь' },
          relativeTime: {
            future: { one: '{0} ш. даьлча', other: '{0} ш. даьлча' },
            past: { one: '{0} ш. хьалха', other: '{0} ш. хьалха' }
          }
        },
        month: {
          displayName: 'бутт',
          relative: { 0: 'карарчу баттахь', 1: 'рогӀерчу баттахь', '-1': 'баханчу баттахь' },
          relativeTime: {
        ...
        'month-short': {
          ...
          relative: { 0: 'карарчу баттахь', 1: 'рогӀерчу баттахь', '-1': 'баханчу баттахь' },
          relativeTime: {
            future: { one: '{0} б. баьлча', other: '{0} б. баьлча' },
            past: { one: '{0} б. хьалха', other: '{0} б. хьалха' }
          }
        },
        day: {
          displayName: 'де',
        ...
        'day-short': {
          ...
          relative: { 0: 'тахана', 1: 'кхана', '-1': 'селхана' },
          relativeTime: {
            future: { one: '{0} д. даьлча', other: '{0} д. даьлча' },
            past: { one: '{0} д. хьалха', other: '{0} де хьалха' }
          }
        },
        hour: {
          displayName: 'сахьт',
          relative: { 0: 'хӀокху сахьтехь' },
          relativeTime: {
        ...
        'hour-short': {
          ...
          relative: { 0: 'хӀокху сахьтехь' },
          relativeTime: {
            future: { one: '{0} сахь. даьлча', other: '{0} сахь. даьлча' },
            past: { one: '{0} сахь. хьалха', other: '{0} сахь. хьалха' }
          }
        },
        minute: {
          displayName: 'минот',
          relative: { 0: 'хӀокху минотехь' },
          relativeTime: {
        ...
        'minute-short': {
          ...
          relative: { 0: 'хӀокху минотехь' },
          relativeTime: {
            future: { one: '{0} мин. яьлча', other: '{0} мин. яьлча' },
            past: { one: '{0} мин. хьалха', other: '{0} мин. хьалха' }
          }
        },
        second: {
          displayName: 'секунд',
        ...
        'second-short': {
          ...
          relative: { 0: 'хӀинца' },
          relativeTime: {
            future: { one: '{0} сек. яьлча', other: '{0} сек. яьлча' },
            past: { one: '{0} сек. хьалха', other: '{0} сек. хьалха' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          ...
          relative: { 0: 'ᎯᎠ ᏧᏕᏘᏴᏒᏘ', 1: 'ᎡᏘᏴᎢ', '-1': 'ᎡᏘ ᏥᎨᏒ' },
          relativeTime: {
            future: { one: 'ᎾᎿ {0} ᎤᏕ.', other: 'ᎾᎿ {0} ᎤᏕ.' },
            past: { one: '{0} ᎤᏕ. ᏥᎨᏒ', other: '{0} ᎤᏕ. ᏥᎨᏒ' }
          }
        },
        month: {
          displayName: 'ᎧᎸᎢ',
          ...
          relativeTime: {
            ...
            past: { one: '{0} ᎧᎸᎢ ᏥᎨᏒ', other: '{0} ᏗᎧᎸᎢ ᏥᎨᏒ' }
          }
        },
        'month-short': {
          displayName: 'ᎧᎸ.',
          relative: { 0: 'ᎯᎠ ᎧᎸᎢ', 1: 'ᏔᎵᏁ ᎧᎸᎢ', '-1': 'ᎧᎸᎢ ᏥᎨᏒ' },
          relativeTime: {
            future: { one: 'ᎾᎿ {0} ᎧᎸ.', other: 'ᎾᎿ {0} ᎧᎸ.' },
            past: { one: '{0} ᎧᎸ. ᏥᎨᏒ', other: '{0} ᎧᎸ. ᏥᎨᏒ' }
          }
        },
        day: {
          displayName: 'ᎢᎦ',
        ...
        'hour-short': {
          ...
          relative: { 0: 'ᎯᎠ ᏑᏟᎶᏓ' },
          relativeTime: {
            future: { one: 'ᎾᎿ {0} ᏑᏟ.', other: 'ᎾᎿ {0} ᏑᏟ.' },
            past: { one: '{0} ᏑᏟ. ᏥᎨᏒ', other: '{0} ᏑᏟ. ᏥᎨᏒ' }
          }
        },
        minute: {
          displayName: 'ᎢᏯᏔᏬᏍᏔᏅ',
          ...
          relativeTime: {
            ...
            past: { one: '{0} ᎢᏯᏔᏬᏍᏔᏅ ᏥᎨᏒ', other: '{0} ᎢᏯᏔᏬᏍᏔᏅ ᏥᎨᏒ' }
          }
        },
        'minute-short': {
          displayName: 'ᎢᏯᏔ.',
          relative: { 0: 'ᎯᎠ ᎢᏯᏔᏬᏍᏔᏅ' },
          relativeTime: {
            future: { one: 'ᎾᎿ {0} ᎢᏯᏔ.', other: 'ᎾᎿ {0} ᎢᏯᏔ.' },
            past: { one: '{0} ᎢᏯᏔ. ᏥᎨᏒ', other: '{0} ᎢᏯᏔ. ᏥᎨᏒ' }
          }
        },
        second: {
          displayName: 'ᎠᏎᏢ',
        ...
        'second-short': {
          ...
          relative: { 0: 'ᏃᏊ' },
          relativeTime: {
            future: { one: 'ᎾᎿ {0} ᎠᏎ.', other: 'ᎾᎿ {0} ᎠᏎ.' },
            past: { one: '{0} ᎠᏎ. ᏥᎨᏒ', other: '{0} ᎠᏎ. ᏥᎨᏒ' }
          }
        }
      }
    },
    ...
    { locale: 'ckb-IR', parentLocale: 'ckb' },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: {
            future: { one: 'za {0} rok', few: 'za {0} roky', many: 'za {0} roku', other: 'za {0} let' },
            past: { one: 'před {0} rokem', few: 'před {0} lety', many: 'před {0} roku', other: 'před {0} lety' }
          }
        },
        'year-short': {
          displayName: 'r.',
          relative: { 0: 'tento rok', 1: 'příští rok', '-1': 'minulý rok' },
          relativeTime: {
            future: { one: 'za {0} r.', few: 'za {0} r.', many: 'za {0} r.', other: 'za {0} l.' },
            past: { one: 'před {0} r.', few: 'před {0} r.', many: 'před {0} r.', other: 'před {0} l.' }
          }
        },
        month: {
          displayName: 'měsíc',
          ...
          relativeTime: {
            future: { one: 'za {0} měsíc', few: 'za {0} měsíce', many: 'za {0} měsíce', other: 'za {0} měsíců' },
            past: { one: 'před {0} měsícem', few: 'před {0} měsíci', many: 'před {0} měsíce', other: 'před {0} měsíci' }
          }
        },
        'month-short': {
          displayName: 'měs.',
          ...
          relativeTime: {
            future: { one: 'za {0} měs.', few: 'za {0} měs.', many: 'za {0} měs.', other: 'za {0} měs.' },
            past: { one: 'před {0} měs.', few: 'před {0} měs.', many: 'před {0} měs.', other: 'před {0} měs.' }
          }
        },
        day: {
          displayName: 'den',
          relative: { 0: 'dnes', 1: 'zítra', 2: 'pozítří', '-2': 'předevčírem', '-1': 'včera' },
          relativeTime: {
            future: { one: 'za {0} den', few: 'za {0} dny', many: 'za {0} dne', other: 'za {0} dní' },
            past: { one: 'před {0} dnem', few: 'před {0} dny', many: 'před {0} dne', other: 'před {0} dny' }
          }
        },
        'day-short': {
          displayName: 'den',
        ...
        hour: {
          ...
          relativeTime: {
            future: { one: 'za {0} hodinu', few: 'za {0} hodiny', many: 'za {0} hodiny', other: 'za {0} hodin' },
            past: {
              one: 'před {0} hodinou',
              few: 'před {0} hodinami',
              many: 'před {0} hodiny',
        ...
        'hour-short': {
          ...
          relativeTime: {
            ...
            past: { one: 'před {0} h', few: 'před {0} h', many: 'před {0} h', other: 'před {0} h' }
          }
        },
        minute: {
          displayName: 'minuta',
          ...
          relativeTime: {
            future: { one: 'za {0} minutu', few: 'za {0} minuty', many: 'za {0} minuty', other: 'za {0} minut' },
            past: {
              one: 'před {0} minutou',
              few: 'před {0} minutami',
              many: 'před {0} minuty',
        ...
        'minute-short': {
          ...
          relative: { 0: 'tuto minutu' },
          relativeTime: {
            future: { one: 'za {0} min', few: 'za {0} min', many: 'za {0} min', other: 'za {0} min' },
            past: { one: 'před {0} min', few: 'před {0} min', many: 'před {0} min', other: 'před {0} min' }
          }
        },
        second: {
          displayName: 'sekunda',
          relative: { 0: 'nyní' },
          relativeTime: {
            future: { one: 'za {0} sekundu', few: 'za {0} sekundy', many: 'za {0} sekundy', other: 'za {0} sekund' },
            past: {
              one: 'před {0} sekundou',
        ...
        'second-short': {
          ...
          relativeTime: {
            ...
            past: { one: 'před {0} s', few: 'před {0} s', many: 'před {0} s', other: 'před {0} s' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'diwrnod',
          relative: { 0: 'heddiw', 1: 'yfory', 2: 'drennydd', '-2': 'echdoe', '-1': 'ddoe' },
          relativeTime: {
            future: {
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'dag',
          relative: { 0: 'i dag', 1: 'i morgen', 2: 'i overmorgen', '-2': 'i forgårs', '-1': 'i går' },
          relativeTime: {
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: {
            future: { one: 'za {0} lěto', two: 'za {0} lěśe', few: 'za {0} lěta', other: 'za {0} lět' },
            past: { one: 'pśed {0} lětom', two: 'pśed {0} lětoma', few: 'pśed {0} lětami', other: 'pśed {0} lětami' }
          }
        },
        'year-short': {
          displayName: 'l.',
          relative: { 0: 'lětosa', 1: 'znowa', '-1': 'łoni' },
          relativeTime: {
            future: { one: 'za {0} l.', two: 'za {0} l.', few: 'za {0} l.', other: 'za {0} l.' },
            past: { one: 'pśed {0} l.', two: 'pśed {0} l.', few: 'pśed {0} l.', other: 'pśed {0} l.' }
          }
        },
        month: {
          displayName: 'mjasec',
          relative: { 0: 'ten mjasec', 1: 'pśiducy mjasec', '-1': 'slědny mjasec' },
          relativeTime: {
            future: { one: 'za {0} mjasec', two: 'za {0} mjaseca', few: 'za {0} mjasecy', other: 'za {0} mjasecow' },
            past: {
              one: 'pśed {0} mjasecom',
        ...
        'month-short': {
          ...
          relative: { 0: 'ten mjasec', 1: 'pśiducy mjasec', '-1': 'slědny mjasec' },
          relativeTime: {
            future: { one: 'za {0} mjas.', two: 'za {0} mjas.', few: 'za {0} mjas.', other: 'za {0} mjas.' },
            past: { one: 'pśed {0} mjas.', two: 'pśed {0} mjas.', few: 'pśed {0} mjas.', other: 'pśed {0} mjas.' }
          }
        },
        day: {
          displayName: 'źeń',
          ...
          relativeTime: {
            future: { one: 'za {0} źeń', two: 'za {0} dnja', few: 'za {0} dny', other: 'za {0} dnjow' },
            past: { one: 'pśed {0} dnjom', two: 'pśed {0} dnjoma', few: 'pśed {0} dnjami', other: 'pśed {0} dnjami' }
          }
        },
        'day-short': {
          displayName: 'źeń',
          relative: { 0: 'źinsa', 1: 'witśe', '-1': 'cora' },
          relativeTime: {
            future: { one: 'za {0} źeń', two: 'za {0} dnj.', few: 'za {0} dny', other: 'za {0} dnj.' },
            past: { one: 'pśed {0} dnj.', two: 'pśed {0} dnj.', few: 'pśed {0} dnj.', other: 'pśed {0} dnj.' }
          }
        },
        hour: {
          displayName: 'góźina',
          relative: { 0: 'this hour' },
          relativeTime: {
            future: { one: 'za {0} góźinu', two: 'za {0} góźinje', few: 'za {0} góźiny', other: 'za {0} góźin' },
            past: {
              one: 'pśed {0} góźinu',
              two: 'pśed {0} góźinoma',
              few: 'pśed {0} góźinami',
        ...
        'hour-short': {
          ...
          relative: { 0: 'this hour' },
          relativeTime: {
            future: { one: 'za {0} góź.', two: 'za {0} góź.', few: 'za {0} góź.', other: 'za {0} góź.' },
            past: { one: 'pśed {0} góź.', two: 'pśed {0} góź.', few: 'pśed {0} góź.', other: 'pśed {0} góź.' }
          }
        },
        minute: {
          displayName: 'minuta',
        ...
        'minute-short': {
          ...
          relative: { 0: 'this minute' },
          relativeTime: {
            future: { one: 'za {0} min.', two: 'za {0} min.', few: 'za {0} min.', other: 'za {0} min.' },
            past: { one: 'pśed {0} min.', two: 'pśed {0} min.', few: 'pśed {0} min.', other: 'pśed {0} min.' }
          }
        },
        second: {
          displayName: 'sekunda',
          relative: { 0: 'now' },
          relativeTime: {
            future: { one: 'za {0} sekundu', two: 'za {0} sekunźe', few: 'za {0} sekundy', other: 'za {0} sekundow' },
            past: {
              one: 'pśed {0} sekundu',
        ...
        'second-short': {
          ...
          relative: { 0: 'now' },
          relativeTime: {
            future: { one: 'za {0} sek.', two: 'za {0} sek.', few: 'za {0} sek.', other: 'za {0} sek.' },
            past: { one: 'pśed {0} sek.', two: 'pśed {0} sek.', few: 'pśed {0} sek.', other: 'pśed {0} sek.' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        year: {
          displayName: 'ལོ',
          relative: { 0: 'this year', 1: 'next year', '-1': 'last year' },
          relativeTime: { future: { other: 'ལོ་འཁོར་ {0} ནང་' }, past: { other: 'ལོ་འཁོར་ {0} ཧེ་མ་' } }
        },
        'year-short': {
          displayName: 'ལོ',
          relative: { 0: 'this year', 1: 'next year', '-1': 'last year' },
        ...
        month: {
          displayName: 'ཟླ་ཝ་',
          relative: { 0: 'this month', 1: 'next month', '-1': 'last month' },
          relativeTime: { future: { other: 'ཟླཝ་ {0} ནང་' }, past: { other: 'ཟླཝ་ {0} ཧེ་མ་' } }
        },
        'month-short': {
          displayName: 'ཟླ་ཝ་',
          relative: { 0: 'this month', 1: 'next month', '-1': 'last month' },
        ...
        day: {
          displayName: 'ཚེས་',
          relative: { 0: 'ད་རིས་', 1: 'ནངས་པ་', 2: 'གནངས་ཚེ', '-2': 'ཁ་ཉིམ', '-1': 'ཁ་ཙ་' },
          relativeTime: { future: { other: 'ཉིནམ་ {0} ནང་' }, past: { other: 'ཉིནམ་ {0} ཧེ་མ་' } }
        },
        'day-short': {
          displayName: 'ཚེས་',
          relative: { 0: 'ད་རིས་', 1: 'ནངས་པ་', 2: 'གནངས་ཚེ', '-2': 'ཁ་ཉིམ', '-1': 'ཁ་ཙ་' },
        ...
        hour: {
          displayName: 'ཆུ་ཚོད',
          relative: { 0: 'this hour' },
          relativeTime: { future: { other: 'ཆུ་ཚོད་ {0} ནང་' }, past: { other: 'ཆུ་ཚོད་ {0} ཧེ་མ་' } }
        },
        'hour-short': {
          displayName: 'ཆུ་ཚོད',
          relative: { 0: 'this hour' },
        ...
        minute: {
          displayName: 'སྐར་མ',
          relative: { 0: 'this minute' },
          relativeTime: { future: { other: 'སྐར་མ་ {0} ནང་' }, past: { other: 'སྐར་མ་ {0} ཧེ་མ་' } }
        },
        'minute-short': {
          displayName: 'སྐར་མ',
          relative: { 0: 'this minute' },
        ...
        second: {
          displayName: 'སྐར་ཆཱ་',
          relative: { 0: 'now' },
          relativeTime: { future: { other: 'སྐར་ཆ་ {0} ནང་' }, past: { other: 'སྐར་ཆ་ {0} ཧེ་མ་' } }
        },
        'second-short': {
          displayName: 'སྐར་ཆཱ་',
          relative: { 0: 'now' },
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          ...
          relativeTime: {
            future: { one: 'le ƒe {0} me', other: 'le ƒe {0} me' },
            past: { one: 'le ƒe {0} si va yi me', other: 'le ƒe {0} si va yi me' }
          }
        },
        month: {
          displayName: 'ɣleti',
          relative: { 0: 'ɣleti sia', 1: 'ɣleti si gbɔ na', '-1': 'ɣleti si va yi' },
          relativeTime: {
        ...
        minute: {
          ...
          relative: { 0: 'this minute' },
          relativeTime: {
            future: { one: 'le aɖabaƒoƒo {0} me', other: 'le aɖabaƒoƒo {0} wo me' },
            past: { one: 'aɖabaƒoƒo {0} si va yi', other: 'aɖabaƒoƒo {0} si wo va yi' }
          }
        },
        'minute-short': {
          displayName: 'aɖabaƒoƒo',
    ...
    { locale: 'ee-TG', parentLocale: 'ee' },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'ημέρα',
          relative: { 0: 'σήμερα', 1: 'αύριο', 2: 'μεθαύριο', '-2': 'προχθές', '-1': 'χθες' },
          relativeTime: {
        ...
        'day-short': {
          ...
          relative: { 0: 'σήμερα', 1: 'αύριο', 2: 'μεθαύριο', '-2': 'προχθές', '-1': 'χθες' },
          relativeTime: {
            future: { one: 'σε {0} ημ.', other: 'σε {0} ημ.' },
            past: { one: 'πριν από {0} ημ.', other: 'πριν από {0} ημ.' }
          }
        },
        hour: {
          displayName: 'ώρα',
        ...
        'hour-short': {
          ...
          relative: { 0: 'τρέχουσα ώρα' },
          relativeTime: {
            future: { one: 'σε {0} ώ.', other: 'σε {0} ώ.' },
            past: { one: 'πριν από {0} ώ.', other: 'πριν από {0} ώ.' }
          }
        },
        minute: {
          displayName: 'λεπτό',
        ...
        'minute-short': {
          ...
          relative: { 0: 'τρέχον λεπτό' },
          relativeTime: {
            future: { one: 'σε {0} λεπ.', other: 'σε {0} λεπ.' },
            past: { one: 'πριν από {0} λεπ.', other: 'πριν από {0} λεπ.' }
          }
        },
        second: {
        ...
        'second-short': {
          ...
          relative: { 0: 'τώρα' },
          relativeTime: {
            future: { one: 'σε {0} δευτ.', other: 'σε {0} δευτ.' },
            past: { one: 'πριν από {0} δευτ.', other: 'πριν από {0} δευτ.' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'día',
          relative: { 0: 'hoy', 1: 'mañana', 2: 'pasado mañana', '-2': 'antier', '-1': 'ayer' },
          relativeTime: {
            future: { one: 'dentro de {0} día', other: 'dentro de {0} días' },
            past: { one: 'hace {0} día', other: 'hace {0} días' }
          }
    ...
    { locale: 'es-VE', parentLocale: 'es-419' },
    {
      ...
      fields: {
        year: {
          displayName: 'aasta',
          relative: { 0: 'käesolev aasta', 1: 'järgmine aasta', '-1': 'eelmine aasta' },
          relativeTime: {
        ...
        'year-short': {
          ...
          relative: { 0: 'käesolev aasta', 1: 'järgmine aasta', '-1': 'eelmine aasta' },
          relativeTime: {
            future: { one: '{0} a pärast', other: '{0} a pärast' },
            past: { one: '{0} a eest', other: '{0} a eest' }
          }
        },
        month: {
          displayName: 'kuu',
        ...
        day: {
          displayName: 'päev',
          relative: { 0: 'täna', 1: 'homme', 2: 'ülehomme', '-2': 'üleeile', '-1': 'eile' },
          relativeTime: {
        ...
        'day-short': {
          ...
          relative: { 0: 'täna', 1: 'homme', 2: 'ülehomme', '-2': 'üleeile', '-1': 'eile' },
          relativeTime: {
            future: { one: '{0} p pärast', other: '{0} p pärast' },
            past: { one: '{0} p eest', other: '{0} p eest' }
          }
        },
        hour: {
          displayName: 'tund',
        ...
        'hour-short': {
          ...
          relative: { 0: 'praegusel tunnil' },
          relativeTime: {
            future: { one: '{0} t pärast', other: '{0} t pärast' },
            past: { one: '{0} t eest', other: '{0} t eest' }
          }
        },
        minute: {
          displayName: 'minut',
        ...
        'minute-short': {
          ...
          relative: { 0: 'praegusel minutil' },
          relativeTime: {
            future: { one: '{0} min pärast', other: '{0} min pärast' },
            past: { one: '{0} min eest', other: '{0} min eest' }
          }
        },
        second: {
          displayName: 'sekund',
        ...
        'second-short': {
          ...
          relative: { 0: 'nüüd' },
          relativeTime: {
            future: { one: '{0} sek pärast', other: '{0} sek pärast' },
            past: { one: '{0} sek eest', other: '{0} sek eest' }
          }
        }
      }
    },
    {
      ...
      fields: {
        year: {
          displayName: 'urtea',
          relative: { 0: 'aurten', 1: 'hurrengo urtean', '-1': 'iaz' },
          relativeTime: {
        ...
        month: {
          ...
          relative: { 0: 'hilabete honetan', 1: 'hurrengo hilabetean', '-1': 'aurreko hilabetean' },
          relativeTime: {
        ...
        day: {
          displayName: 'eguna',
          relative: { 0: 'gaur', 1: 'bihar', 2: 'etzi', '-2': 'herenegun', '-1': 'atzo' },
          relativeTime: {
    ...
    },
    {
      ...
      fields: {
        ...
        'month-short': {
          displayName: 'ماه',
          relative: { 0: 'این ماه', 1: 'ماه آینده', '-1': 'ماه پیش' },
          relativeTime: {
            future: { one: '{0} ماه بعد', other: '{0} ماه بعد' },
            past: { one: '{0} ماه پیش', other: '{0} ماه پیش' }
          }
        ...
        day: {
          displayName: 'روز',
          relative: { 0: 'امروز', 1: 'فردا', 2: 'پس‌فردا', '-2': 'پریروز', '-1': 'دیروز' },
          relativeTime: {
    ...
    { locale: 'ff-Latn', parentLocale: 'ff' },
    { locale: 'ff-Latn-BF', parentLocale: 'ff-Latn' },
    { locale: 'ff-Latn-CM', parentLocale: 'ff-Latn' },
    { locale: 'ff-Latn-GH', parentLocale: 'ff-Latn' },
    { locale: 'ff-Latn-GM', parentLocale: 'ff-Latn' },
    { locale: 'ff-Latn-GN', parentLocale: 'ff-Latn' },
    { locale: 'ff-Latn-GW', parentLocale: 'ff-Latn' },
    { locale: 'ff-Latn-LR', parentLocale: 'ff-Latn' },
    { locale: 'ff-Latn-MR', parentLocale: 'ff-Latn' },
    { locale: 'ff-Latn-NE', parentLocale: 'ff-Latn' },
    { locale: 'ff-Latn-NG', parentLocale: 'ff-Latn' },
    { locale: 'ff-Latn-SL', parentLocale: 'ff-Latn' },
    {
      locale: 'fi',
      pluralRuleFunction: function (e, t) {
        var a = !String(e).split('.')[1];
    ...
    },
    {
      ...
      fields: {
        year: {
          displayName: 'taon',
          relative: { 0: 'ngayong taon', 1: 'susunod na taon', '-1': 'nakaraang taon' },
          relativeTime: {
            future: { one: 'sa {0} taon', other: 'sa {0} (na) taon' },
            past: { one: '{0} taon ang nakalipas', other: '{0} (na) taon ang nakalipas' }
          }
        },
        'year-short': {
          displayName: 'taon',
        ...
        month: {
          displayName: 'buwan',
          relative: { 0: 'ngayong buwan', 1: 'susunod na buwan', '-1': 'nakaraang buwan' },
          relativeTime: {
            future: { one: 'sa {0} buwan', other: 'sa {0} (na) buwan' },
            past: { one: '{0} buwan ang nakalipas', other: '{0} (na) buwan ang nakalipas' }
          }
        },
        'month-short': {
          displayName: 'buwan',
        ...
        day: {
          displayName: 'araw',
          relative: { 0: 'ngayong araw', 1: 'bukas', 2: 'Samakalawa', '-2': 'Araw bago ang kahapon', '-1': 'kahapon' },
          relativeTime: {
            future: { one: 'sa {0} araw', other: 'sa {0} (na) araw' },
            past: { one: '{0} araw ang nakalipas', other: '{0} (na) araw ang nakalipas' }
          }
        },
        'day-short': {
          displayName: 'araw',
          relative: { 0: 'ngayong araw', 1: 'bukas', 2: 'Samakalawa', '-2': 'Araw bago ang kahapon', '-1': 'kahapon' },
          relativeTime: {
            future: { one: 'sa {0} (na) araw', other: 'sa {0} (na) araw' },
            past: { one: '{0} (na) araw ang nakalipas', other: '{0} (na) araw ang nakalipas' }
          }
        },
        hour: {
          displayName: 'oras',
          ...
          relativeTime: {
            ...
            past: { one: '{0} oras ang nakalipas', other: '{0} (na) oras ang nakalipas' }
          }
        },
        'hour-short': {
          displayName: 'oras',
        ...
        minute: {
          ...
          relativeTime: {
            ...
            past: { one: '{0} minuto ang nakalipas', other: '{0} (na) minuto ang nakalipas' }
          }
        },
        'minute-short': {
          displayName: 'min.',
          relative: { 0: 'sa minutong ito' },
          relativeTime: {
            future: { one: 'sa {0} min.', other: 'sa {0} (na) min.' },
            past: { one: '{0} min. ang nakalipas', other: '{0} (na) min. ang nakalipas' }
          }
        },
        second: {
          displayName: 'segundo',
          ...
          relativeTime: {
            ...
            past: { one: '{0} segundo ang nakalipas', other: '{0} (na) segundo ang nakalipas' }
          }
        },
        'second-short': {
          displayName: 'seg.',
          relative: { 0: 'ngayon' },
          relativeTime: {
            future: { one: 'sa {0} seg.', other: 'sa {0} (na) seg.' },
            past: { one: '{0} seg. ang nakalipas', other: '{0} (na) seg. nakalipas' }
          }
        }
      }
    },
    {
      ...
      fields: {
        ...
        month: {
          displayName: 'mánaður',
          relative: { 0: 'henda mánaðin', 1: 'næsta mánað', '-1': 'seinasta mánað' },
          relativeTime: {
        ...
        'month-short': {
          ...
          relative: { 0: 'henda mánaðin', 1: 'næsta mánað', '-1': 'seinasta mánað' },
          relativeTime: {
            future: { one: 'um {0} mnð.', other: 'um {0} mnð.' },
            past: { one: '{0} mnð. síðan', other: '{0} mnð. síðan' }
          }
        },
        day: {
          displayName: 'dagur',
          relative: { 0: 'í dag', 1: 'í morgin', 2: 'í ovurmorgin', '-2': 'fyrradagin', '-1': 'í gjár' },
          relativeTime: {
        ...
        'day-short': {
          ...
          relative: { 0: 'í dag', 1: 'í morgin', 2: 'í ovurmorgin', '-2': 'fyrradagin', '-1': 'í gjár' },
          relativeTime: {
            future: { one: 'um {0} da.', other: 'um {0} da.' },
            past: { one: '{0} da. síðan', other: '{0} da. síðan' }
          }
        },
        hour: {
          displayName: 'tími',
        ...
        'hour-short': {
          ...
          relative: { 0: 'hendan tíman' },
          relativeTime: {
            future: { one: 'um {0} t.', other: 'um {0} t.' },
            past: { one: '{0} t. síðan', other: '{0} t. síðan' }
          }
        },
        minute: {
        ...
        'minute-short': {
          ...
          relative: { 0: 'hendan minuttin' },
          relativeTime: {
            future: { one: 'um {0} min.', other: 'um {0} min.' },
            past: { one: '{0} min. síðan', other: '{0} min. síðan' }
          }
        },
        second: {
          displayName: 'sekund',
        ...
        'second-short': {
          ...
          relative: { 0: 'nú' },
          relativeTime: {
            future: { one: 'um {0} sek.', other: 'um {0} sek.' },
            past: { one: '{0} sek. síðan', other: '{0} sek. síðan' }
          }
        }
      }
    },
    ...
    { locale: 'fr-YT', parentLocale: 'fr' },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'dì',
          relative: { 0: 'vuê', 1: 'doman', 2: 'passantdoman', '-2': 'îr l’altri', '-1': 'îr' },
          relativeTime: {
    ...
    },
    {
      ...
      fields: {
        ...
        month: {
          displayName: 'Moanne',
          relative: { 0: 'dizze moanne', 1: 'folgjende moanne', '-1': 'foarige moanne' },
          relativeTime: {
        ...
        day: {
          displayName: 'dei',
          relative: { 0: 'vandaag', 1: 'morgen', 2: 'Oermorgen', '-2': 'eergisteren', '-1': 'gisteren' },
          relativeTime: {
    ...
    },
    {
      ...
      fields: {
        year: {
          displayName: 'Bliain',
          relative: { 0: 'an bhliain seo', 1: 'an bhliain seo chugainn', '-1': 'anuraidh' },
          relativeTime: {
            future: {
        ...
        'year-short': {
          displayName: 'bl.',
          relative: { 0: 'an bhl. seo', 1: 'an bhl. seo chugainn', '-1': 'anuraidh' },
          relativeTime: {
            future: {
              one: 'i gceann {0} bl.',
              two: 'i gceann {0} bhl.',
        ...
        month: {
          displayName: 'Mí',
          relative: { 0: 'an mhí seo', 1: 'an mhí seo chugainn', '-1': 'an mhí seo caite' },
          relativeTime: {
            future: {
              one: 'i gceann {0} mhí',
              two: 'i gceann {0} mhí',
        ...
        day: {
          displayName: 'Lá',
          relative: { 0: 'inniu', 1: 'amárach', 2: 'arú amárach', '-2': 'arú inné', '-1': 'inné' },
          relativeTime: {
            future: {
              one: 'i gceann {0} lá',
              two: 'i gceann {0} lá',
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relative: { 0: 'am bliadhna', 1: 'an ath-bhliadhna', '-2': 'a-bhòn-uiridh', '-1': 'an-uiridh' },
          relativeTime: {
            future: {
        ...
        'year-short': {
          ...
          relative: { 0: 'am bliadhna', 1: 'an ath-bhliadhna', '-2': 'a-bhòn-uiridh', '-1': 'an-uiridh' },
          relativeTime: {
            future: { one: 'an {0} bhlia.', two: 'an {0} bhlia.', few: 'an {0} blia.', other: 'an {0} blia.' },
            past: { one: 'o {0} bhlia.', two: 'o {0} bhlia.', few: 'o {0} blia.', other: 'o {0} blia.' }
          }
        },
        month: {
          displayName: 'mìos',
          relative: { 0: 'am mìos seo', 1: 'an ath-mhìos', '-1': 'am mìos seo chaidh' },
          relativeTime: {
            future: {
        ...
        'month-short': {
          displayName: 'mìos',
          relative: { 0: 'am mìos seo', 1: 'an ath-mhìos', '-1': 'am mìos sa chaidh' },
          relativeTime: {
            future: { one: 'an {0} mhìos.', two: 'an {0} mhìos.', few: 'an {0} mìos.', other: 'an {0} mìos.' },
            past: { one: 'o {0} mhìos.', two: 'o {0} mhìos.', few: 'o {0} mìos.', other: 'o {0} mìos.' }
          }
        },
        day: {
          displayName: 'latha',
        ...
        'day-short': {
          ...
          relativeTime: {
            future: { one: 'an {0} là', two: 'an {0} là', few: 'an {0} là.', other: 'an {0} là' },
            past: { one: 'o {0} là', two: 'o {0} là', few: 'o {0} là.', other: 'o {0} là' }
          }
        },
        hour: {
          displayName: 'uair a thìde',
          relative: { 0: 'am broinn uair a thìde' },
          relativeTime: {
            future: {
        ...
        'hour-short': {
          displayName: 'uair',
          relative: { 0: 'am broinn uair' },
          relativeTime: {
            future: { one: 'an {0} uair', two: 'an {0} uair', few: 'an {0} uair.', other: 'an {0} uair' },
            past: { one: 'o {0} uair', two: 'o {0} uair', few: 'o {0} uair.', other: 'o {0} uair' }
          }
        },
        minute: {
          displayName: 'mionaid',
          relative: { 0: 'am broinn mionaid' },
          relativeTime: {
            future: {
        ...
        'minute-short': {
          displayName: 'mion.',
          relative: { 0: 'am broinn mion.' },
          relativeTime: {
            future: { one: 'an {0} mhion.', two: 'an {0} mhion.', few: 'an {0} mion.', other: 'an {0} mion.' },
            past: { one: 'o {0} mhion.', two: 'o {0} mhion.', few: 'o {0} mion.', other: 'o {0} mion.' }
          }
        },
        second: {
          displayName: 'diog',
        ...
        'second-short': {
          ...
          relative: { 0: 'an-dràsta' },
          relativeTime: {
            future: { one: 'an {0} diog', two: 'an {0} dhiog', few: 'an {0} diog.', other: 'an {0} diog' },
            past: { one: 'o {0} diog', two: 'o {0} dhiog', few: 'o {0} diog.', other: 'o {0} diog' }
          }
        }
      }
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          displayName: 'ano',
          relative: { 0: 'este ano', 1: 'seguinte ano', '-1': 'ano pasado' },
          relativeTime: {
            future: { one: 'en {0} ano', other: 'en {0} anos' },
            past: { one: 'hai {0} ano', other: 'hai {0} anos' }
          }
        ...
        'month-short': {
          displayName: 'mes',
          relative: { 0: 'este m.', 1: 'm. seguinte', '-1': 'm. pasado' },
          relativeTime: {
            future: { one: 'en {0} mes', other: 'en {0} meses' },
            past: { one: 'hai {0} mes', other: 'hai {0} meses' }
          }
        ...
        day: {
          displayName: 'día',
          relative: { 0: 'hoxe', 1: 'mañá', 2: 'pasadomañá', '-2': 'antonte', '-1': 'onte' },
          relativeTime: {
            future: { one: 'en {0} día', other: 'en {0} días' },
        ...
        'second-short': {
          ...
          relativeTime: {
            future: { one: 'en {0} s', other: 'en {0} s' },
            past: { one: 'hai {0} s', other: 'hai {0} s' }
          }
        }
      }
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'Tag',
          relative: { 0: 'hüt', 1: 'moorn', 2: 'übermoorn', '-2': 'vorgeschter', '-1': 'geschter' },
          relativeTime: { future: { other: '+{0} d' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'Tag',
    ...
    { locale: 'gsw-LI', parentLocale: 'gsw' },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'દિવસ',
          relative: { 0: 'આજે', 1: 'આવતીકાલે', 2: 'પરમદિવસે', '-2': 'ગયા પરમદિવસે', '-1': 'ગઈકાલે' },
          relativeTime: {
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: {
            future: { one: 'בעוד שנה', two: 'בעוד שנתיים', many: 'בעוד {0} שנה', other: 'בעוד {0} שנים' },
            past: { one: 'לפני שנה', two: 'לפני שנתיים', many: 'לפני {0} שנה', other: 'לפני {0} שנים' }
          }
        },
        'year-short': {
          displayName: 'שנ׳',
        ...
        month: {
          ...
          relativeTime: {
            future: { one: 'בעוד חודש', two: 'בעוד חודשיים', many: 'בעוד {0} חודשים', other: 'בעוד {0} חודשים' },
            past: { one: 'לפני חודש', two: 'לפני חודשיים', many: 'לפני {0} חודשים', other: 'לפני {0} חודשים' }
          }
        },
        'month-short': {
          displayName: 'חו׳',
        ...
        day: {
          displayName: 'יום',
          relative: { 0: 'היום', 1: 'מחר', 2: 'מחרתיים', '-2': 'שלשום', '-1': 'אתמול' },
          relativeTime: {
            future: { one: 'בעוד יום {0}', two: 'בעוד יומיים', many: 'בעוד {0} ימים', other: 'בעוד {0} ימים' },
            past: { one: 'לפני יום {0}', two: 'לפני יומיים', many: 'לפני {0} ימים', other: 'לפני {0} ימים' }
          }
        },
        'day-short': {
          displayName: 'יום',
          relative: { 0: 'היום', 1: 'מחר', 2: 'מחרתיים', '-2': 'שלשום', '-1': 'אתמול' },
          relativeTime: {
            future: { one: 'מחר', two: 'בעוד יומיים', many: 'בעוד {0} ימים', other: 'בעוד {0} ימים' },
            past: { one: 'אתמול', two: 'לפני יומיים', many: 'לפני {0} ימים', other: 'לפני {0} ימים' }
          }
        },
        hour: {
          displayName: 'שעה',
          relative: { 0: 'בשעה זו' },
          relativeTime: {
            future: { one: 'בעוד שעה', two: 'בעוד שעתיים', many: 'בעוד {0} שעות', other: 'בעוד {0} שעות' },
            past: { one: 'לפני שעה', two: 'לפני שעתיים', many: 'לפני {0} שעות', other: 'לפני {0} שעות' }
          }
        },
        'hour-short': {
          displayName: 'שעה',
          relative: { 0: 'בשעה זו' },
          relativeTime: {
            future: { one: 'בעוד שעה', two: 'בעוד שעתיים', many: 'בעוד {0} שע׳', other: 'בעוד {0} שע׳' },
            past: { one: 'לפני שעה', two: 'לפני שעתיים', many: 'לפני {0} שע׳', other: 'לפני {0} שע׳' }
          }
        },
        minute: {
          displayName: 'דקה',
          relative: { 0: 'בדקה זו' },
          relativeTime: {
            future: { one: 'בעוד דקה', two: 'בעוד שתי דקות', many: 'בעוד {0} דקות', other: 'בעוד {0} דקות' },
            past: { one: 'לפני דקה', two: 'לפני שתי דקות', many: 'לפני {0} דקות', other: 'לפני {0} דקות' }
          }
        },
        'minute-short': {
          displayName: 'דק׳',
          relative: { 0: 'בדקה זו' },
          relativeTime: {
            future: { one: 'בעוד דקה', two: 'בעוד שתי דק׳', many: 'בעוד {0} דק׳', other: 'בעוד {0} דק׳' },
            past: { one: 'לפני דקה', two: 'לפני {0} דק׳', many: 'לפני {0} דק׳', other: 'לפני {0} דק׳' }
          }
        },
        second: {
          displayName: 'שנייה',
          relative: { 0: 'עכשיו' },
          relativeTime: {
            future: { one: 'בעוד שנייה', two: 'בעוד שתי שניות', many: 'בעוד {0} שניות', other: 'בעוד {0} שניות' },
            past: { one: 'לפני שנייה', two: 'לפני שתי שניות', many: 'לפני {0} שניות', other: 'לפני {0} שניות' }
          }
        },
        'second-short': {
          displayName: 'שנ׳',
          relative: { 0: 'עכשיו' },
          relativeTime: {
            future: { one: 'בעוד שנ׳', two: 'בעוד שתי שנ׳', many: 'בעוד {0} שנ׳', other: 'בעוד {0} שנ׳' },
            past: { one: 'לפני שנ׳', two: 'לפני שתי שנ׳', many: 'לפני {0} שנ׳', other: 'לפני {0} שנ׳' }
          }
        }
      }
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'दिन',
          relative: { 0: 'आज', 1: 'कल', 2: 'परसों', '-2': 'परसों', '-1': 'कल' },
          relativeTime: {
        ...
        'hour-short': {
          ...
          relative: { 0: 'यह घंटा' },
          relativeTime: {
            future: { one: '{0} घं॰ में', other: '{0} घं॰ में' },
            past: { one: '{0} घं॰ पहले', other: '{0} घं॰ पहले' }
          }
        },
        minute: {
          displayName: 'मिनट',
        ...
        'minute-short': {
          ...
          relative: { 0: 'यह मिनट' },
          relativeTime: {
            future: { one: '{0} मि॰ में', other: '{0} मि॰ में' },
            past: { one: '{0} मि॰ पहले', other: '{0} मि॰ पहले' }
          }
        },
        second: {
          displayName: 'सेकंड',
        ...
        'second-short': {
          ...
          relative: { 0: 'अब' },
          relativeTime: {
            future: { one: '{0} से॰ में', other: '{0} से॰ में' },
            past: { one: '{0} से॰ पहले', other: '{0} से॰ पहले' }
          }
        }
      }
    },
      ...
      fields: {
        ...
        'year-short': {
          ...
          relativeTime: {
            ...
            past: { one: 'prije {0} g.', few: 'prije {0} g.', other: 'prije {0} g.' }
          }
        },
        month: {
          displayName: 'mjesec',
        ...
        'hour-short': {
          ...
          relativeTime: {
            ...
            past: { one: 'prije {0} h', few: 'prije {0} h', other: 'prije {0} h' }
          }
        },
        minute: {
          displayName: 'minuta',
        ...
        'second-short': {
          ...
          relativeTime: {
            ...
            past: { one: 'prije {0} s', few: 'prije {0} s', other: 'prije {0} s' }
          }
        }
      }
    },
    { locale: 'hr-BA', parentLocale: 'hr' },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: {
            future: { one: 'za {0} lěto', two: 'za {0} lěće', few: 'za {0} lěta', other: 'za {0} lět' },
            past: { one: 'před {0} lětom', two: 'před {0} lětomaj', few: 'před {0} lětami', other: 'před {0} lětami' }
          }
        },
        'year-short': {
          displayName: 'l.',
          ...
          relativeTime: {
            future: { one: 'za {0} l.', two: 'za {0} l.', few: 'za {0} l.', other: 'za {0} l.' },
            past: { one: 'před {0} l.', two: 'před {0} l.', few: 'před {0} l.', other: 'před {0} l.' }
          }
        },
        month: {
          displayName: 'měsac',
          relative: { 0: 'tutón měsac', 1: 'přichodny měsac', '-1': 'zašły měsac' },
          relativeTime: {
            future: { one: 'za {0} měsac', two: 'za {0} měsacaj', few: 'za {0} měsacy', other: 'za {0} měsacow' },
            past: {
              one: 'před {0} měsacom',
        ...
        'month-short': {
          ...
          relative: { 0: 'tutón měsac', 1: 'přichodny měsac', '-1': 'zašły měsac' },
          relativeTime: {
            future: { one: 'za {0} měs.', two: 'za {0} měs.', few: 'za {0} měs.', other: 'za {0} měs.' },
            past: { one: 'před {0} měs.', two: 'před {0} měs.', few: 'před {0} měs.', other: 'před {0} měs.' }
          }
        },
        day: {
          displayName: 'dźeń',
          ...
          relativeTime: {
            future: { one: 'za {0} dźeń', two: 'za {0} dnjej', few: 'za {0} dny', other: 'za {0} dnjow' },
            past: { one: 'před {0} dnjom', two: 'před {0} dnjomaj', few: 'před {0} dnjemi', other: 'před {0} dnjemi' }
          }
        },
        'day-short': {
          displayName: 'dźeń',
          relative: { 0: 'dźensa', 1: 'jutře', '-1': 'wčera' },
          relativeTime: {
            future: { one: 'za {0} dźeń', two: 'za {0} dnj.', few: 'za {0} dny', other: 'za {0} dnj.' },
            past: { one: 'před {0} dnj.', two: 'před {0} dnj.', few: 'před {0} dnj.', other: 'před {0} dnj.' }
          }
        },
        hour: {
          displayName: 'hodźina',
          relative: { 0: 'this hour' },
          relativeTime: {
            future: { one: 'za {0} hodźinu', two: 'za {0} hodźinje', few: 'za {0} hodźiny', other: 'za {0} hodźin' },
            past: {
              one: 'před {0} hodźinu',
        ...
        'hour-short': {
          ...
          relative: { 0: 'this hour' },
          relativeTime: {
            future: { one: 'za {0} hodź.', two: 'za {0} hodź.', few: 'za {0} hodź.', other: 'za {0} hodź.' },
            past: { one: 'před {0} hodź.', two: 'před {0} hodź.', few: 'před {0} hodź.', other: 'před {0} hodź.' }
          }
        },
        minute: {
          displayName: 'minuta',
        ...
        'minute-short': {
          ...
          relativeTime: {
            future: { one: 'za {0} min.', two: 'za {0} min.', few: 'za {0} min.', other: 'za {0} min.' },
            past: { one: 'před {0} min.', two: 'před {0} min.', few: 'před {0} min.', other: 'před {0} min.' }
          }
        },
        second: {
          displayName: 'sekunda',
          relative: { 0: 'now' },
          relativeTime: {
            future: { one: 'za {0} sekundu', two: 'za {0} sekundźe', few: 'za {0} sekundy', other: 'za {0} sekundow' },
            past: {
              one: 'před {0} sekundu',
        ...
        'second-short': {
          ...
          relativeTime: {
            future: { one: 'za {0} sek.', two: 'za {0} sek.', few: 'za {0} sek.', other: 'za {0} sek.' },
            past: { one: 'před {0} sek.', two: 'před {0} sek.', few: 'před {0} sek.', other: 'před {0} sek.' }
          }
        }
      }
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'nap',
          relative: { 0: 'ma', 1: 'holnap', 2: 'holnapután', '-2': 'tegnapelőtt', '-1': 'tegnap' },
          relativeTime: {
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          ...
          relativeTime: {
            future: { one: '{0} տարուց', other: '{0} տարուց' },
            past: { one: '{0} տ առաջ', other: '{0} տ առաջ' }
          }
        },
        month: {
          displayName: 'ամիս',
        ...
        'month-short': {
          displayName: 'ամս',
          relative: { 0: 'այս ամիս', 1: 'հաջորդ ամիս', '-1': 'անցյալ ամիս' },
          relativeTime: {
            future: { one: '{0} ամսից', other: '{0} ամսից' },
            past: { one: '{0} ամիս առաջ', other: '{0} ամիս առաջ' }
          }
        ...
        day: {
          displayName: 'օր',
          relative: { 0: 'այսօր', 1: 'վաղը', 2: 'վաղը չէ մյուս օրը', '-2': 'երեկ չէ առաջի օրը', '-1': 'երեկ' },
          relativeTime: {
        ...
        'hour-short': {
          ...
          relative: { 0: 'այս ժամին' },
          relativeTime: {
            future: { one: '{0} ժ-ից', other: '{0} ժ-ից' },
            past: { one: '{0} ժ առաջ', other: '{0} ժ առաջ' }
          }
        },
        minute: {
          displayName: 'րոպե',
        ...
        'minute-short': {
          ...
          relative: { 0: 'այս րոպեին' },
          relativeTime: {
            future: { one: '{0} ր-ից', other: '{0} ր-ից' },
            past: { one: '{0} ր առաջ', other: '{0} ր առաջ' }
          }
        },
        second: {
        ...
        'second-short': {
          ...
          relative: { 0: 'հիմա' },
          relativeTime: {
            future: { one: '{0} վրկ-ից', other: '{0} վրկ-ից' },
            past: { one: '{0} վրկ առաջ', other: '{0} վրկ առաջ' }
          }
        }
      }
    },
    {
      ...
      fields: {
        year: {
          displayName: 'anno',
          relative: { 0: 'iste anno', 1: 'le anno proxime', '-1': 'le anno passate' },
          relativeTime: { future: { other: '+{0} y' }, past: { other: '-{0} y' } }
        },
        'year-short': {
          displayName: 'an.',
        ...
        month: {
          displayName: 'mense',
          relative: { 0: 'iste mense', 1: 'le mense proxime', '-1': 'le mense passate' },
          relativeTime: { future: { other: '+{0} m' }, past: { other: '-{0} m' } }
        },
        'month-short': {
          displayName: 'mns.',
        ...
        day: {
          displayName: 'die',
          relative: { 0: 'hodie', 1: 'deman', '-1': 'heri' },
          relativeTime: { future: { other: '+{0} d' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'die',
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          displayName: 'thn.',
          relative: { 0: 'tahun ini', 1: 'tahun depan', '-1': 'tahun lalu' },
          relativeTime: { future: { other: 'dlm {0} thn' }, past: { other: '{0} thn lalu' } }
        },
        month: {
          displayName: 'bulan',
        ...
        'month-short': {
          displayName: 'bln.',
          relative: { 0: 'bulan ini', 1: 'bulan berikutnya', '-1': 'bulan lalu' },
          relativeTime: { future: { other: 'dlm {0} bln' }, past: { other: '{0} bln lalu' } }
        },
        day: {
          displayName: 'hari',
          relative: { 0: 'hari ini', 1: 'besok', 2: 'lusa', '-2': 'kemarin dulu', '-1': 'kemarin' },
          relativeTime: { future: { other: 'dalam {0} hari' }, past: { other: '{0} hari yang lalu' } }
        },
        'day-short': {
          displayName: 'h',
          relative: { 0: 'hari ini', 1: 'besok', 2: 'lusa', '-2': 'kemarin dulu', '-1': 'kemarin' },
          relativeTime: { future: { other: 'dalam {0} h' }, past: { other: '{0} h lalu' } }
        },
        hour: {
          displayName: 'Jam',
          relative: { 0: 'jam ini' },
        ...
        'hour-short': {
          displayName: 'jam',
          relative: { 0: 'jam ini' },
          relativeTime: { future: { other: 'dalam {0} jam' }, past: { other: '{0} jam lalu' } }
        },
        minute: {
          displayName: 'menit',
        ...
        'minute-short': {
          displayName: 'mnt.',
          relative: { 0: 'menit ini' },
          relativeTime: { future: { other: 'dlm {0} mnt' }, past: { other: '{0} mnt lalu' } }
        },
        second: {
          displayName: 'detik',
          relative: { 0: 'sekarang' },
        ...
        'second-short': {
          displayName: 'dtk.',
          relative: { 0: 'sekarang' },
          relativeTime: { future: { other: 'dlm {0} dtk' }, past: { other: '{0} dtk lalu' } }
        }
      }
    },
    {
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'ꑍ',
          relative: { 0: 'ꀃꑍ', 1: 'ꃆꏂꑍ', 2: 'ꌕꀿꑍ', '-2': 'ꎴꂿꋍꑍ', '-1': 'ꀋꅔꉈ' },
          relativeTime: { future: { other: '+{0} d' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'ꑍ',
    ...
    },
    {
      ...
      fields: {
        ...
        'month-short': {
          displayName: 'mán.',
          relative: { 0: 'í þessum mán.', 1: 'í næsta mán.', '-1': 'í síðasta mán.' },
          relativeTime: {
            future: { one: 'eftir {0} mán.', other: 'eftir {0} mán.' },
            past: { one: 'fyrir {0} mán.', other: 'fyrir {0} mán.' }
          }
        },
        day: {
          displayName: 'dagur',
          relative: { 0: 'í dag', 1: 'á morgun', 2: 'eftir tvo daga', '-2': 'í fyrradag', '-1': 'í gær' },
          relativeTime: {
        ...
        hour: {
          ...
          relativeTime: {
            future: { one: 'eftir {0} klukkustund', other: 'eftir {0} klukkustundir' },
            past: { one: 'fyrir {0} klukkustund', other: 'fyrir {0} klukkustundum' }
          }
        },
        'hour-short': {
          displayName: 'klst.',
          relative: { 0: 'þessa stundina' },
          relativeTime: {
            future: { one: 'eftir {0} klst.', other: 'eftir {0} klst.' },
            past: { one: 'fyrir {0} klst.', other: 'fyrir {0} klst.' }
          }
        },
        minute: {
          displayName: 'mínúta',
        ...
        'minute-short': {
          ...
          relative: { 0: 'á þessari mínútu' },
          relativeTime: {
            future: { one: 'eftir {0} mín.', other: 'eftir {0} mín.' },
            past: { one: 'fyrir {0} mín.', other: 'fyrir {0} mín.' }
          }
        },
        second: {
          displayName: 'sekúnda',
        ...
        'second-short': {
          ...
          relative: { 0: 'núna' },
          relativeTime: {
            future: { one: 'eftir {0} sek.', other: 'eftir {0} sek.' },
            past: { one: 'fyrir {0} sek.', other: 'fyrir {0} sek.' }
          }
        }
      }
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'giorno',
          relative: { 0: 'oggi', 1: 'domani', 2: 'dopodomani', '-2': 'l’altro ieri', '-1': 'ieri' },
          relativeTime: {
    ...
    },
    {
      ...
      fields: {
        year: {
          displayName: 'taun',
          relative: { 0: 'taun iki', 1: 'taun ngarep', '-1': 'taun wingi' },
          relativeTime: { future: { other: '+{0} y' }, past: { other: '-{0} y' } }
        },
        'year-short': {
          displayName: 'taun',
        ...
        month: {
          displayName: 'sasi',
          relative: { 0: 'sasi iki', 1: 'sasi ngarep', '-1': 'sasi wingi' },
          relativeTime: { future: { other: '+{0} m' }, past: { other: '-{0} m' } }
        },
        'month-short': {
          displayName: 'sasi',
        ...
        day: {
          displayName: 'dino',
          relative: { 0: 'saiki', 1: 'sesuk', '-1': 'wingi' },
          relativeTime: { future: { other: '+{0} d' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'dino',
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          ...
          relative: { 0: 'ამ წელს', 1: 'მომავალ წელს', '-1': 'გასულ წელს' },
          relativeTime: {
            future: { one: '{0} წელში', other: '{0} წელში' },
            past: { one: '{0} წლის წინ', other: '{0} წლის წინ' }
          }
        },
        month: {
        ...
        day: {
          displayName: 'დღე',
          relative: { 0: 'დღეს', 1: 'ხვალ', 2: 'ზეგ', '-2': 'გუშინწინ', '-1': 'გუშინ' },
          relativeTime: {
        ...
        'hour-short': {
          ...
          relativeTime: {
            future: { one: '{0} საათში', other: '{0} საათში' },
            past: { one: '{0} სთ წინ', other: '{0} სთ წინ' }
          }
        },
        minute: {
          displayName: 'წუთი',
        ...
        'minute-short': {
          ...
          relativeTime: {
            future: { one: '{0} წუთში', other: '{0} წუთში' },
            past: { one: '{0} წთ წინ', other: '{0} წთ წინ' }
          }
        },
        second: {
          displayName: 'წამი',
        ...
        'second-short': {
          ...
          relativeTime: {
            future: { one: '{0} წამში', other: '{0} წამში' },
            past: { one: '{0} წმ წინ', other: '{0} წმ წინ' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: { future: { other: 'di li {0} anu' }, past: { other: 'a ten {0} anu' } }
        },
        'year-short': {
          displayName: 'anu',
          relative: { 0: 'es anu li', 1: 'prósimu anu', '-1': 'anu pasadu' },
        ...
        month: {
          ...
          relativeTime: { future: { other: 'di li {0} mes' }, past: { other: 'a ten {0} mes' } }
        },
        'month-short': {
          displayName: 'mes',
          relative: { 0: 'es mes li', 1: 'prósimu mes', '-1': 'mes pasadu' },
        ...
        day: {
          ...
          relativeTime: { future: { other: 'di li {0} dia' }, past: { other: 'a ten {0} dia' } }
        },
        'day-short': {
          displayName: 'dia',
          relative: { 0: 'oji', 1: 'manha', '-1': 'onti' },
        ...
        hour: {
          displayName: 'Ora',
          relative: { 0: 'this hour' },
          relativeTime: { future: { other: 'di li {0} ora' }, past: { other: 'a ten {0} ora' } }
        },
        'hour-short': {
          displayName: 'ora',
          relative: { 0: 'this hour' },
        ...
        minute: {
          displayName: 'Minutu',
          relative: { 0: 'this minute' },
          relativeTime: { future: { other: 'di li {0} minutu' }, past: { other: 'a ten {0} minutu' } }
        },
        'minute-short': {
          displayName: 'min',
          relative: { 0: 'this minute' },
          relativeTime: { future: { other: 'di li {0} min' }, past: { other: 'a ten {0} min' } }
        },
        second: {
          displayName: 'Sigundu',
          relative: { 0: 'now' },
          relativeTime: { future: { other: 'di li {0} sigundu' }, past: { other: 'a ten {0} sigundu' } }
        },
        'second-short': {
          displayName: 'sig',
          relative: { 0: 'now' },
          relativeTime: { future: { other: 'di li {0} sig' }, past: { other: 'a ten {0} sig' } }
        }
      }
    },
    {
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          ...
          relative: { 0: 'биылғы жыл', 1: 'келесі жыл', '-1': 'былтырғы жыл' },
          relativeTime: {
            future: { one: '{0} ж. кейін', other: '{0} ж. кейін' },
            past: { one: '{0} ж. бұрын', other: '{0} ж. бұрын' }
          }
        },
        month: {
          displayName: 'ай',
        ...
        day: {
          displayName: 'күн',
          relative: { 0: 'бүгін', 1: 'ертең', 2: 'бүрсігүні', '-2': 'алдыңгүні', '-1': 'кеше' },
          relativeTime: {
        ...
        'day-short': {
          displayName: 'күн',
          relative: { 0: 'бүгін', 1: 'ертең', 2: 'бүрсігүні', '-2': 'алдыңғы күні', '-1': 'кеше' },
          relativeTime: {
            future: { one: '{0} күннен кейін', other: '{0} күннен кейін' },
            past: { one: '{0} күн бұрын', other: '{0} күн бұрын' }
          }
        ...
        'hour-short': {
          ...
          relative: { 0: 'осы сағат' },
          relativeTime: {
            future: { one: '{0} сағ. кейін', other: '{0} сағ. кейін' },
            past: { one: '{0} сағ. бұрын', other: '{0} сағ. бұрын' }
          }
        },
        minute: {
          displayName: 'минут',
        ...
        'minute-short': {
          ...
          relative: { 0: 'осы минут' },
          relativeTime: {
            future: { one: '{0} мин. кейін', other: '{0} мин. кейін' },
            past: { one: '{0} мин. бұрын', other: '{0} мин. бұрын' }
          }
        },
        second: {
          displayName: 'секунд',
        ...
        'second-short': {
          ...
          relative: { 0: 'қазір' },
          relativeTime: {
            future: { one: '{0} сек. кейін', other: '{0} сек. кейін' },
            past: { one: '{0} сек. бұрын', other: '{0} сек. бұрын' }
          }
        }
      }
    },
      ...
      fields: {
        ...
        month: {
          ...
          relativeTime: {
            ...
            past: { one: 'for {0} qaammat siden', other: 'for {0} qaammat siden' }
          }
        },
        'month-short': {
          displayName: 'Month',
        ...
        day: {
          ...
          relative: { 0: 'today', 1: 'tomorrow', '-1': 'yesterday' },
          relativeTime: {
            future: { one: 'om {0} ulloq unnuarlu', other: 'om {0} ulloq unnuarlu' },
            past: { one: 'for {0} ulloq unnuarlu siden', other: 'for {0} ulloq unnuarlu siden' }
          }
        },
        'day-short': {
          displayName: 'Day',
        ...
        hour: {
          ...
          relative: { 0: 'this hour' },
          relativeTime: {
            future: { one: 'om {0} nalunaaquttap-akunnera', other: 'om {0} nalunaaquttap-akunnera' },
            past: { one: 'for {0} nalunaaquttap-akunnera siden', other: 'for {0} nalunaaquttap-akunnera siden' }
          }
        },
        'hour-short': {
          displayName: 'Hour',
        ...
        minute: {
          ...
          relativeTime: {
            ...
            past: { one: 'for {0} minutsi siden', other: 'for {0} minutsi siden' }
          }
        },
        'minute-short': {
          displayName: 'Minute',
        ...
        second: {
          ...
          relativeTime: {
            ...
            past: { one: 'for {0} sekundi siden', other: 'for {0} sekundi siden' }
          }
        },
        'second-short': {
          displayName: 'Second',
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          displayName: 'ವರ್ಷ',
          relative: { 0: 'ಈ ವರ್ಷ', 1: 'ಮುಂದಿನ ವರ್ಷ', '-1': 'ಕಳೆದ ವರ್ಷ' },
          relativeTime: {
            future: { one: '{0} ವರ್ಷದಲ್ಲಿ', other: '{0} ವರ್ಷಗಳಲ್ಲಿ' },
            past: { one: '{0} ವರ್ಷದ ಹಿಂದೆ', other: '{0} ವರ್ಷಗಳ ಹಿಂದೆ' }
          }
        ...
        month: {
          ...
          relativeTime: {
            ...
            past: { one: '{0} ತಿಂಗಳ ಹಿಂದೆ', other: '{0} ತಿಂಗಳುಗಳ ಹಿಂದೆ' }
          }
        },
        'month-short': {
          displayName: 'ತಿಂಗಳು',
          ...
          relativeTime: {
            future: { one: '{0} ತಿಂಗಳಲ್ಲಿ', other: '{0} ತಿಂಗಳುಗಳಲ್ಲಿ' },
            past: { one: '{0} ತಿಂಗಳು ಹಿಂದೆ', other: '{0} ತಿಂಗಳುಗಳ ಹಿಂದೆ' }
          }
        },
        day: {
          displayName: 'ದಿನ',
          relative: { 0: 'ಇಂದು', 1: 'ನಾಳೆ', 2: 'ನಾಡಿದ್ದು', '-2': 'ಮೊನ್ನೆ', '-1': 'ನಿನ್ನೆ' },
          relativeTime: {
        ...
        minute: {
          ...
          relativeTime: {
            ...
            past: { one: '{0} ನಿಮಿಷದ ಹಿಂದೆ', other: '{0} ನಿಮಿಷಗಳ ಹಿಂದೆ' }
          }
        },
        'minute-short': {
          displayName: 'ನಿಮಿಷ',
    ...
    { locale: 'ko-KP', parentLocale: 'ko' },
    {
      ...
      fields: {
        year: {
          displayName: 'वर्स',
          relative: { 0: 'हें वर्स', 1: 'फुडलें वर्स', '-1': 'फाटलें वर्स' },
          relativeTime: { future: { other: '{0} वर्सांनीं' }, past: { other: '{0} वर्सां आदीं' } }
        },
        'year-short': {
          displayName: 'वर्स',
          relative: { 0: 'हें वर्स', 1: 'फुडलें वर्स', '-1': 'फाटलें वर्स' },
          relativeTime: { future: { other: '{0} वर्सांनीं' }, past: { other: '{0} वर्स आदीं' } }
        },
        month: {
          displayName: 'म्हयनो',
          relative: { 0: 'हो म्हयनो', 1: 'फुडलो म्हयनो', '-1': 'फाटलो म्हयनो' },
          relativeTime: { future: { other: '{0} म्हयन्यानीं' }, past: { other: '{0} म्हयन्यां आदीं' } }
        },
        'month-short': {
          displayName: 'म्हयनो',
          relative: { 0: 'हो म्हयनो', 1: 'फुडलो म्हयनो', '-1': 'फाटलो म्हयनो' },
        ...
        day: {
          displayName: 'दीस',
          relative: { 0: 'आयज', 1: 'फाल्यां', '-1': 'काल' },
          relativeTime: { future: { other: '{0} दिसानीं' }, past: { other: '{0} दीस आदीं' } }
        },
        'day-short': {
          displayName: 'दीस',
          relative: { 0: 'आयज', 1: 'फाल्यां', '-1': 'काल' },
        ...
        hour: {
          displayName: 'वर',
          relative: { 0: 'हें वर' },
          relativeTime: { future: { other: '{0} वरांनीं' }, past: { other: '{0} वरा आदीं' } }
        },
        'hour-short': {
          displayName: 'वर',
          relative: { 0: 'हें वर' },
        ...
        minute: {
          displayName: 'मिनीट',
          relative: { 0: 'हें मिनीट' },
          relativeTime: { future: { other: '{0} मिन्टां' }, past: { other: '{0} मिन्टां आदीं' } }
        },
        'minute-short': {
          displayName: 'मिनीट',
          relative: { 0: 'हें मिनीट' },
        ...
        second: {
          displayName: 'सेकंद',
          relative: { 0: 'आतां' },
          relativeTime: { future: { other: '{0} सेकंदानीं' }, past: { other: '{0} सेकंद आदीं' } }
        },
        'second-short': {
          displayName: 'सेकंद',
          relative: { 0: 'आतां' },
          relativeTime: { future: { other: '{0} सेकंदानीं' }, past: { other: '{0} से. आदीं' } }
        }
      }
    },
    {
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: {
            future: { zero: 'en keinem Johr', one: 'en {0} Johr', other: 'en {0} Johre' },
            past: { zero: 'vör keijnem Johr', one: 'vör {0} Johr', other: 'vör {0} Johre' }
          }
        },
        'year-short': {
          displayName: 'J.',
        ...
        month: {
          displayName: 'Mohnd',
          relative: { 0: 'diese Mohnd', 1: 'nächste Mohnd', '-1': 'lätzde Mohnd' },
          relativeTime: { future: { other: '+{0} m' }, past: { other: '-{0} m' } }
        },
        'month-short': {
          displayName: 'Mohnd',
        ...
        day: {
          displayName: 'Daach',
          relative: { 0: 'hück', 1: 'morje', 2: 'övvermorje', '-2': 'vörjestere', '-1': 'jestere' },
          relativeTime: { future: { other: '+{0} d' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'D.',
    ...
    },
    {
      ...
      fields: {
        year: {
          displayName: 'sal',
          relative: { 0: 'îsal', 1: 'sala piştî', '-1': 'par' },
          relativeTime: { future: { other: '+{0} y' }, past: { other: '-{0} y' } }
        },
        'year-short': {
          displayName: 'sal',
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          ...
          relative: { 0: 'быйыл', 1: 'эмдиги жылы', '-1': 'былтыр' },
          relativeTime: {
            future: { one: '{0} жыл. кийин', other: '{0} жыл. кийин' },
            past: { one: '{0} жыл мурун', other: '{0} жыл мурун' }
          }
        },
        month: {
        ...
        'month-short': {
          ...
          relative: { 0: 'бул айда', 1: 'эмдиги айда', '-1': 'өткөн айда' },
          relativeTime: {
            future: { one: '{0} айд. кийин', other: '{0} айд. кийин' },
            past: { one: '{0} ай мурун', other: '{0} ай мурун' }
          }
        },
        day: {
          displayName: 'күн',
          relative: { 0: 'бүгүн', 1: 'эртең', 2: 'бүрсүгүнү', '-2': 'мурдагы күнү', '-1': 'кечээ' },
          relativeTime: {
        ...
        'day-short': {
          ...
          relative: { 0: 'бүгүн', 1: 'эртең', 2: 'бүрсүгүнү', '-2': 'мурдагы күнү', '-1': 'кечээ' },
          relativeTime: {
            future: { one: '{0} күн. кийин', other: '{0} күн. кийин' },
            past: { one: '{0} күн мурун', other: '{0} күн мурун' }
          }
        },
        hour: {
        ...
        'hour-short': {
          ...
          relative: { 0: 'ушул саатта' },
          relativeTime: {
            future: { one: '{0} саат. кийин', other: '{0} саат. кийин' },
            past: { one: '{0} саат. мурун', other: '{0} саат. мурун' }
          }
        },
        minute: {
        ...
        'minute-short': {
          ...
          relative: { 0: 'ушул мүнөттө' },
          relativeTime: {
            future: { one: '{0} мүн. кийин', other: '{0} мүн. кийин' },
            past: { one: '{0} мүн. мурун', other: '{0} мүн. мурун' }
          }
        },
        second: {
          displayName: 'секунд',
        ...
        'second-short': {
          ...
          relative: { 0: 'азыр' },
          relativeTime: {
            future: { one: '{0} сек. кийин', other: '{0} сек. кийин' },
            past: { one: '{0} сек. мурун', other: '{0} сек. мурун' }
          }
        }
      }
    },
    {
      ...
      pluralRuleFunction: function (e, t) {
        var a = String(e).split('.')[0];
        return t ? 'other' : 0 == e ? 'zero' : (0 != a && 1 != a) || 0 == e ? 'other' : 'one';
      },
      fields: {
        year: {
          displayName: 'Mwaáka',
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          ...
          relative: { 0: 'dëst Joer', 1: 'nächst Joer', '-1': 'lescht Joer' },
          relativeTime: {
            future: { one: 'an {0} J.', other: 'a(n) {0} J.' },
            past: { one: 'virun {0} J.', other: 'viru(n) {0} J.' }
          }
        },
        month: {
          displayName: 'Mount',
          relative: { 0: 'dëse Mount', 1: 'nächste Mount', '-1': 'leschte Mount' },
          relativeTime: {
        ...
        'month-short': {
          ...
          relative: { 0: 'dëse Mount', 1: 'nächste Mount', '-1': 'leschte Mount' },
          relativeTime: {
            future: { one: 'an {0} M.', other: 'a(n) {0} M.' },
            past: { one: 'virun {0} M.', other: 'viru(n) {0} M.' }
          }
        },
        day: {
          displayName: 'Dag',
        ...
        'day-short': {
          ...
          relative: { 0: 'haut', 1: 'muer', '-1': 'gëschter' },
          relativeTime: {
            future: { one: 'an {0} D.', other: 'a(n) {0} D.' },
            past: { one: 'virun {0} D.', other: 'viru(n) {0} D.' }
          }
        },
        hour: {
          displayName: 'Stonn',
        ...
        'hour-short': {
          ...
          relative: { 0: 'this hour' },
          relativeTime: {
            future: { one: 'an {0} St.', other: 'a(n) {0} St.' },
            past: { one: 'virun {0} St.', other: 'viru(n) {0} St.' }
          }
        },
        minute: {
          displayName: 'Minutt',
        ...
        'minute-short': {
          ...
          relative: { 0: 'this minute' },
          relativeTime: {
            future: { one: 'an {0} Min.', other: 'a(n) {0} Min.' },
            past: { one: 'virun {0} Min.', other: 'viru(n) {0} Min.' }
          }
        },
        second: {
          displayName: 'Sekonn',
        ...
        'second-short': {
          ...
          relative: { 0: 'now' },
          relativeTime: {
            future: { one: 'an {0} Sek.', other: 'a(n) {0} Sek.' },
            past: { one: 'virun {0} Sek.', other: 'viru(n) {0} Sek.' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        year: {
          displayName: 'Ómakȟa',
          relative: { 0: 'Lé ómakȟa kiŋ', 1: 'Tȟokáta ómakȟa kiŋháŋ', '-1': 'Ómakȟa kʼuŋ héhaŋ' },
          relativeTime: {
        ...
        month: {
          displayName: 'Wí',
          relative: { 0: 'Lé wí kiŋ', 1: 'Tȟokáta wí kiŋháŋ', '-1': 'Wí kʼuŋ héhaŋ' },
          relativeTime: {
        ...
        day: {
          displayName: 'Aŋpétu',
          relative: { 0: 'Lé aŋpétu kiŋ', 1: 'Híŋhaŋni kiŋháŋ', '-1': 'Ȟtálehaŋ' },
          relativeTime: { future: { other: 'Letáŋhaŋ {0}-čháŋ kiŋháŋ' }, past: { other: 'Hékta {0}-čháŋ k’uŋ héhaŋ' } }
        },
        'day-short': {
          displayName: 'Aŋpétu',
          relative: { 0: 'Lé aŋpétu kiŋ', 1: 'Híŋhaŋni kiŋháŋ', '-1': 'Ȟtálehaŋ' },
        ...
        second: {
          displayName: 'Okpí',
          relative: { 0: 'now' },
          relativeTime: { future: { other: 'Letáŋhaŋ okpí {0} kiŋháŋ' }, past: { other: 'Hékta okpí {0} k’uŋ héhaŋ' } }
        },
        'second-short': {
          displayName: 'Okpí',
          relative: { 0: 'now' },
    ...
    { locale: 'ln-CG', parentLocale: 'ln' },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: { future: { other: 'ໃນອີກ {0} ປີ' }, past: { other: '{0} ປີກ່ອນ' } }
        },
        'year-short': {
          displayName: 'ປີ',
          relative: { 0: 'ປີນີ້', 1: 'ປີໜ້າ', '-1': 'ປີກາຍ' },
        ...
        month: {
          ...
          relativeTime: { future: { other: 'ໃນອີກ {0} ເດືອນ' }, past: { other: '{0} ເດືອນກ່ອນ' } }
        },
        'month-short': {
          displayName: 'ດ.',
          relative: { 0: 'ເດືອນນີ້', 1: 'ເດືອນໜ້າ', '-1': 'ເດືອນແລ້ວ' },
          relativeTime: { future: { other: 'ໃນອີກ {0} ດ.' }, past: { other: '{0} ດ. ກ່ອນ' } }
        },
        day: {
          displayName: 'ມື້',
          relative: { 0: 'ມື້ນີ້', 1: 'ມື້ອື່ນ', 2: 'ມື້ຮື', '-2': 'ມື້ກ່ອນ', '-1': 'ມື້ວານ' },
          relativeTime: { future: { other: 'ໃນອີກ {0} ມື້' }, past: { other: '{0} ມື້ກ່ອນ' } }
        },
        'day-short': {
          displayName: 'ມື້',
          relative: { 0: 'ມື້ນີ້', 1: 'ມື້ອື່ນ', 2: 'ມື້ຮື', '-2': 'ມື້ກ່ອນ', '-1': 'ມື້ວານ' },
        ...
        hour: {
          ...
          relativeTime: { future: { other: 'ໃນອີກ {0} ຊົ່ວໂມງ' }, past: { other: '{0} ຊົ່ວໂມງກ່ອນ' } }
        },
        'hour-short': {
          displayName: 'ຊມ.',
          relative: { 0: 'ຊົ່ວໂມງນີ້' },
          relativeTime: { future: { other: 'ໃນອີກ {0} ຊມ.' }, past: { other: '{0} ຊມ. ກ່ອນ' } }
        },
        minute: {
          displayName: 'ນາທີ',
          relative: { 0: 'ນາທີນີ້' },
          relativeTime: { future: { other: '{0} ໃນອີກ 0 ນາທີ' }, past: { other: '{0} ນາທີກ່ອນ' } }
        },
        'minute-short': {
          displayName: 'ນທ.',
          relative: { 0: 'ນາທີນີ້' },
          relativeTime: { future: { other: 'ໃນ {0} ນທ.' }, past: { other: '{0} ນທ. ກ່ອນ' } }
        },
        second: {
          displayName: 'ວິນາທີ',
          relative: { 0: 'ຕອນນີ້' },
          relativeTime: { future: { other: 'ໃນອີກ {0} ວິນາທີ' }, past: { other: '{0} ວິນາທີກ່ອນ' } }
        },
        'second-short': {
          displayName: 'ວິ.',
          relative: { 0: 'ຕອນນີ້' },
          relativeTime: { future: { other: 'ໃນ {0} ວິ.' }, past: { other: '{0} ວິ. ກ່ອນ' } }
        }
      }
    },
    {
    ...
    { locale: 'lrc-IQ', parentLocale: 'lrc' },
    {
      ...
      fields: {
        year: {
          displayName: 'metai',
          relative: { 0: 'šiais metais', 1: 'kitais metais', '-1': 'praėjusiais metais' },
          relativeTime: {
            future: { one: 'po {0} metų', few: 'po {0} metų', many: 'po {0} metų', other: 'po {0} metų' },
            past: { one: 'prieš {0} metus', few: 'prieš {0} metus', many: 'prieš {0} metų', other: 'prieš {0} metų' }
          }
        },
        'year-short': {
          displayName: 'm.',
          relative: { 0: 'šiais metais', 1: 'kitais metais', '-1': 'praėjusiais metais' },
          relativeTime: {
            future: { one: 'po {0} m.', few: 'po {0} m.', many: 'po {0} m.', other: 'po {0} m.' },
            past: { one: 'prieš {0} m.', few: 'prieš {0} m.', many: 'prieš {0} m.', other: 'prieš {0} m.' }
          }
        },
        month: {
          displayName: 'mėnuo',
          ...
          relativeTime: {
            future: { one: 'po {0} mėnesio', few: 'po {0} mėnesių', many: 'po {0} mėnesio', other: 'po {0} mėnesių' },
            past: {
              one: 'prieš {0} mėnesį',
        ...
        'month-short': {
          ...
          relative: { 0: 'šį mėnesį', 1: 'kitą mėnesį', '-1': 'praėjusį mėnesį' },
          relativeTime: {
            future: { one: 'po {0} mėn.', few: 'po {0} mėn.', many: 'po {0} mėn.', other: 'po {0} mėn.' },
            past: { one: 'prieš {0} mėn.', few: 'prieš {0} mėn.', many: 'prieš {0} mėn.', other: 'prieš {0} mėn.' }
          }
        },
        day: {
          displayName: 'diena',
          relative: { 0: 'šiandien', 1: 'rytoj', 2: 'poryt', '-2': 'užvakar', '-1': 'vakar' },
          relativeTime: {
            future: { one: 'po {0} dienos', few: 'po {0} dienų', many: 'po {0} dienos', other: 'po {0} dienų' },
            past: {
              one: 'prieš {0} dieną',
              few: 'prieš {0} dienas',
              many: 'prieš {0} dienos',
        ...
        'day-short': {
          ...
          relative: { 0: 'šiandien', 1: 'rytoj', 2: 'poryt', '-2': 'užvakar', '-1': 'vakar' },
          relativeTime: {
            future: { one: 'po {0} d.', few: 'po {0} d.', many: 'po {0} d.', other: 'po {0} d.' },
            past: { one: 'prieš {0} d.', few: 'prieš {0} d.', many: 'prieš {0} d.', other: 'prieš {0} d.' }
          }
        },
        hour: {
          displayName: 'valanda',
          ...
          relativeTime: {
            future: { one: 'po {0} valandos', few: 'po {0} valandų', many: 'po {0} valandos', other: 'po {0} valandų' },
            past: {
              one: 'prieš {0} valandą',
        ...
        'hour-short': {
          ...
          relative: { 0: 'šią valandą' },
          relativeTime: {
            future: { one: 'po {0} val.', few: 'po {0} val.', many: 'po {0} val.', other: 'po {0} val.' },
            past: { one: 'prieš {0} val.', few: 'prieš {0} val.', many: 'prieš {0} val.', other: 'prieš {0} val.' }
          }
        },
        minute: {
          displayName: 'minutė',
          ...
          relativeTime: {
            future: { one: 'po {0} minutės', few: 'po {0} minučių', many: 'po {0} minutės', other: 'po {0} minučių' },
            past: {
              one: 'prieš {0} minutę',
              few: 'prieš {0} minutes',
        ...
        'minute-short': {
          ...
          relative: { 0: 'šią minutę' },
          relativeTime: {
            future: { one: 'po {0} min.', few: 'po {0} min.', many: 'po {0} min.', other: 'po {0} min.' },
            past: { one: 'prieš {0} min.', few: 'prieš {0} min.', many: 'prieš {0} min.', other: 'prieš {0} min.' }
          }
        },
        second: {
          displayName: 'sekundė',
        ...
        'second-short': {
          ...
          relative: { 0: 'dabar' },
          relativeTime: {
            future: { one: 'po {0} sek.', few: 'po {0} sek.', many: 'po {0} sek.', other: 'po {0} sek.' },
            past: { one: 'prieš {0} sek.', few: 'prieš {0} sek.', many: 'prieš {0} sek.', other: 'prieš {0} sek.' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      pluralRuleFunction: function (e, t) {
        ...
        return t
          ? 'other'
          : (o && 0 == n) || (s >= 11 && s <= 19) || (2 == i && l >= 11 && l <= 19)
            ? 'zero'
            : (1 == n && 11 != s) || (2 == i && 1 == h && 11 != l) || (2 != i && 1 == h)
              ? 'one'
              : 'other';
      },
      fields: {
        year: {
          displayName: 'gads',
          relative: { 0: 'šajā gadā', 1: 'nākamajā gadā', '-1': 'pagājušajā gadā' },
          relativeTime: {
            future: { zero: 'pēc {0} gadiem', one: 'pēc {0} gada', other: 'pēc {0} gadiem' },
            past: { zero: 'pirms {0} gadiem', one: 'pirms {0} gada', other: 'pirms {0} gadiem' }
          }
        },
        'year-short': {
          displayName: 'g.',
          relative: { 0: 'šajā gadā', 1: 'nākamajā gadā', '-1': 'pagājušajā gadā' },
          relativeTime: {
            future: { zero: 'pēc {0} g.', one: 'pēc {0} g.', other: 'pēc {0} g.' },
            past: { zero: 'pirms {0} g.', one: 'pirms {0} g.', other: 'pirms {0} g.' }
          }
        },
        month: {
          displayName: 'mēnesis',
          relative: { 0: 'šajā mēnesī', 1: 'nākamajā mēnesī', '-1': 'pagājušajā mēnesī' },
          relativeTime: {
            future: { zero: 'pēc {0} mēnešiem', one: 'pēc {0} mēneša', other: 'pēc {0} mēnešiem' },
            past: { zero: 'pirms {0} mēnešiem', one: 'pirms {0} mēneša', other: 'pirms {0} mēnešiem' }
          }
        },
        'month-short': {
          displayName: 'mēn.',
          relative: { 0: 'šajā mēnesī', 1: 'nākamajā mēnesī', '-1': 'pagājušajā mēnesī' },
          relativeTime: {
            future: { zero: 'pēc {0} mēn.', one: 'pēc {0} mēn.', other: 'pēc {0} mēn.' },
            past: { zero: 'pirms {0} mēn.', one: 'pirms {0} mēn.', other: 'pirms {0} mēn.' }
          }
        },
        day: {
          displayName: 'diena',
          relative: { 0: 'šodien', 1: 'rīt', 2: 'parīt', '-2': 'aizvakar', '-1': 'vakar' },
          relativeTime: {
            future: { zero: 'pēc {0} dienām', one: 'pēc {0} dienas', other: 'pēc {0} dienām' },
            past: { zero: 'pirms {0} dienām', one: 'pirms {0} dienas', other: 'pirms {0} dienām' }
          }
        },
        'day-short': {
          displayName: 'd.',
          relative: { 0: 'šodien', 1: 'rīt', 2: 'parīt', '-2': 'aizvakar', '-1': 'vakar' },
          relativeTime: {
            future: { zero: 'pēc {0} d.', one: 'pēc {0} d.', other: 'pēc {0} d.' },
            past: { zero: 'pirms {0} d.', one: 'pirms {0} d.', other: 'pirms {0} d.' }
          }
        },
        hour: {
          displayName: 'stundas',
          ...
          relativeTime: {
            future: { zero: 'pēc {0} stundām', one: 'pēc {0} stundas', other: 'pēc {0} stundām' },
            past: { zero: 'pirms {0} stundām', one: 'pirms {0} stundas', other: 'pirms {0} stundām' }
          }
        },
        'hour-short': {
          displayName: 'st.',
          relative: { 0: 'šajā stundā' },
          relativeTime: {
            future: { zero: 'pēc {0} st.', one: 'pēc {0} st.', other: 'pēc {0} st.' },
            past: { zero: 'pirms {0} st.', one: 'pirms {0} st.', other: 'pirms {0} st.' }
          }
        },
        minute: {
          displayName: 'minūtes',
          ...
          relativeTime: {
            future: { zero: 'pēc {0} minūtēm', one: 'pēc {0} minūtes', other: 'pēc {0} minūtēm' },
            past: { zero: 'pirms {0} minūtēm', one: 'pirms {0} minūtes', other: 'pirms {0} minūtēm' }
          }
        },
        'minute-short': {
          displayName: 'min.',
          relative: { 0: 'šajā minūtē' },
          relativeTime: {
            future: { zero: 'pēc {0} min.', one: 'pēc {0} min.', other: 'pēc {0} min.' },
            past: { zero: 'pirms {0} min.', one: 'pirms {0} min.', other: 'pirms {0} min.' }
          }
        },
        second: {
          ...
          relative: { 0: 'tagad' },
          relativeTime: {
            future: { zero: 'pēc {0} sekundēm', one: 'pēc {0} sekundes', other: 'pēc {0} sekundēm' },
            past: { zero: 'pirms {0} sekundēm', one: 'pirms {0} sekundes', other: 'pirms {0} sekundēm' }
          }
        },
        'second-short': {
          displayName: 'sek.',
          relative: { 0: 'tagad' },
          relativeTime: {
            future: { zero: 'pēc {0} sek.', one: 'pēc {0} sek.', other: 'pēc {0} sek.' },
            past: { zero: 'pirms {0} sek.', one: 'pirms {0} sek.', other: 'pirms {0} sek.' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        ...
        month: {
          displayName: 'iməg',
          relative: { 0: 'this month', 1: 'next month', '-1': 'last month' },
          relativeTime: { future: { one: '+{0} m', other: '+{0} m' }, past: { one: '-{0} m', other: '-{0} m' } }
        },
        'month-short': {
          displayName: 'iməg',
          relative: { 0: 'this month', 1: 'next month', '-1': 'last month' },
        ...
        day: {
          ...
          relativeTime: { future: { one: '+{0} d', other: '+{0} d' }, past: { one: '-{0} d', other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'anəg',
          relative: { 0: 'tèchɔ̀ŋ', 1: 'isu', 2: 'isu ywi', '-1': 'ikwiri' },
        ...
        hour: {
          displayName: 'Hour',
          relative: { 0: 'this hour' },
          relativeTime: { future: { one: '+{0} h', other: '+{0} h' }, past: { one: '-{0} h', other: '-{0} h' } }
        },
        'hour-short': {
          displayName: 'Hour',
          relative: { 0: 'this hour' },
        ...
        minute: {
          displayName: 'Minute',
          relative: { 0: 'this minute' },
          relativeTime: { future: { one: '+{0} min', other: '+{0} min' }, past: { one: '-{0} min', other: '-{0} min' } }
        },
        'minute-short': {
          displayName: 'Minute',
          relative: { 0: 'this minute' },
        ...
        second: {
          displayName: 'Second',
          relative: { 0: 'now' },
          relativeTime: { future: { one: '+{0} s', other: '+{0} s' }, past: { one: '-{0} s', other: '-{0} s' } }
        },
        'second-short': {
          displayName: 'Second',
          relative: { 0: 'now' },
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'rā',
          relative: { 0: 'āianei', 1: 'āpōpō', '-1': 'inanahi' },
          relativeTime: { future: { other: '+{0} d' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'rā',
    ...
    },
    {
      ...
      fields: {
        year: {
          displayName: 'година',
          relative: { 0: 'оваа година', 1: 'следната година', '-1': 'минатата година' },
          relativeTime: {
        ...
        'year-short': {
          ...
          relative: { 0: 'оваа година', 1: 'следната година', '-1': 'минатата година' },
          relativeTime: {
            future: { one: 'за {0} год.', other: 'за {0} год.' },
            past: { one: 'пред {0} год.', other: 'пред {0} год.' }
          }
        },
        month: {
          displayName: 'месец',
          relative: { 0: 'овој месец', 1: 'следниот месец', '-1': 'минатиот месец' },
          relativeTime: {
        ...
        day: {
          displayName: 'ден',
          relative: { 0: 'денес', 1: 'утре', 2: 'задутре', '-2': 'завчера', '-1': 'вчера' },
          relativeTime: {
        ...
        'minute-short': {
          ...
          relative: { 0: 'оваа минута' },
          relativeTime: {
            future: { one: 'за {0} мин.', other: 'за {0} мин.' },
            past: { one: 'пред {0} мин.', other: 'пред {0} мин.' }
          }
        },
        second: {
          displayName: 'секунда',
        ...
        'second-short': {
          ...
          relative: { 0: 'сега' },
          relativeTime: {
            future: { one: 'за {0} сек.', other: 'за {0} сек.' },
            past: { one: 'пред {0} сек.', other: 'пред {0} сек.' }
          }
        }
      }
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'ദിവസം',
          relative: { 0: 'ഇന്ന്', 1: 'നാളെ', 2: 'മറ്റന്നാൾ', '-2': 'മിനിഞ്ഞാന്ന്', '-1': 'ഇന്നലെ' },
          relativeTime: {
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'өдөр',
          relative: { 0: 'өнөөдөр', 1: 'маргааш', 2: 'нөгөөдөр', '-2': 'уржигдар', '-1': 'өчигдөр' },
          relativeTime: {
        ...
        'hour-short': {
          ...
          relative: { 0: 'энэ цаг' },
          relativeTime: {
            future: { one: '{0} ц дараа', other: '{0} ц дараа' },
            past: { one: '{0} ц өмнө', other: '{0} ц өмнө' }
          }
        },
        minute: {
          displayName: 'минут',
        ...
        'minute-short': {
          ...
          relative: { 0: 'энэ минут' },
          relativeTime: {
            future: { one: '{0} мин дараа', other: '{0} мин дараа' },
            past: { one: '{0} мин өмнө', other: '{0} мин өмнө' }
          }
        },
        second: {
          displayName: 'секунд',
        ...
        'second-short': {
          ...
          relative: { 0: 'одоо' },
          relativeTime: {
            future: { one: '{0} сек дараа', other: '{0} сек дараа' },
            past: { one: '{0} сек өмнө', other: '{0} сек өмнө' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: {
            future: { one: 'येत्या {0} वर्षामध्ये', other: 'येत्या {0} वर्षांमध्ये' },
        ...
        month: {
          ...
          relativeTime: {
            future: { one: 'येत्या {0} महिन्यामध्ये', other: 'येत्या {0} महिन्यांमध्ये' },
        ...
        'month-short': {
          ...
          relative: { 0: 'हा महिना', 1: 'पुढील महिना', '-1': 'मागील महिना' },
          relativeTime: {
            future: { one: '{0} महिन्यामध्ये', other: '{0} महिन्यामध्ये' },
            past: { one: '{0} महिन्यापूर्वी', other: '{0} महिन्यांपूर्वी' }
          }
        },
        day: {
          ...
          relativeTime: {
            future: { one: 'येत्या {0} दिवसामध्ये', other: 'येत्या {0} दिवसांमध्ये' },
        ...
        'day-short': {
          ...
          relative: { 0: 'आज', 1: 'उद्या', '-1': 'काल' },
          relativeTime: {
            future: { one: '{0} दिवसामध्ये', other: 'येत्या {0} दिवसांमध्ये' },
            past: { one: '{0} दिवसापूर्वी', other: '{0} दिवसांपूर्वी' }
          }
        },
        hour: {
        ...
        'minute-short': {
          ...
          relative: { 0: 'या मिनिटात' },
          relativeTime: {
            future: { one: '{0} मिनि. मध्ये', other: '{0} मिनि. मध्ये' },
            past: { one: '{0} मिनि. पूर्वी', other: '{0} मिनि. पूर्वी' }
          }
        },
        second: {
          displayName: 'सेकंद',
        ...
        'second-short': {
          ...
          relative: { 0: 'आत्ता' },
          relativeTime: {
            future: { one: '{0} से. मध्ये', other: '{0} से. मध्ये' },
            past: { one: '{0} से. पूर्वी', other: '{0} से. पूर्वी' }
          }
        }
      }
    },
    {
      ...
      fields: {
        year: {
          displayName: 'tahun',
          relative: { 0: 'tahun ini', 1: 'tahun depan', '-1': 'tahun lalu' },
          relativeTime: { future: { other: 'dalam {0} tahun' }, past: { other: '{0} tahun lalu' } }
        },
        'year-short': {
          displayName: 'thn',
          relative: { 0: 'thn ini', 1: 'thn depan', '-1': 'thn lepas' },
          relativeTime: { future: { other: 'dalam {0} thn' }, past: { other: '{0} thn lalu' } }
        },
        month: {
          displayName: 'bulan',
          relative: { 0: 'bulan ini', 1: 'bulan depan', '-1': 'bulan lalu' },
          relativeTime: { future: { other: 'dalam {0} bulan' }, past: { other: '{0} bulan lalu' } }
        },
        'month-short': {
          displayName: 'bln',
          relative: { 0: 'bln ini', 1: 'bln depan', '-1': 'bln lalu' },
          relativeTime: { future: { other: 'dlm {0} bln' }, past: { other: '{0} bln lalu' } }
        },
        day: {
          displayName: 'hari',
          relative: { 0: 'hari ini', 1: 'esok', 2: 'lusa', '-2': 'kelmarin', '-1': 'semalam' },
          relativeTime: { future: { other: 'dalam {0} hari' }, past: { other: '{0} hari lalu' } }
        },
        'day-short': {
          displayName: 'hari',
          relative: { 0: 'hari ini', 1: 'esok', 2: 'lusa', '-2': 'kelmarin', '-1': 'semlm' },
          relativeTime: { future: { other: 'dlm {0} hari' }, past: { other: '{0} hari lalu' } }
        },
        hour: {
          displayName: 'jam',
          relative: { 0: 'jam ini' },
        ...
        'hour-short': {
          displayName: 'jam',
          relative: { 0: 'jam ini' },
          relativeTime: { future: { other: 'dlm {0} jam' }, past: { other: '{0} jam lalu' } }
        },
        minute: {
          displayName: 'minit',
          relative: { 0: 'pada minit ini' },
          relativeTime: { future: { other: 'dalam {0} minit' }, past: { other: '{0} minit lalu' } }
        },
        'minute-short': {
          displayName: 'min',
          relative: { 0: 'pada minit ini' },
          relativeTime: { future: { other: 'dlm {0} min' }, past: { other: '{0} min lalu' } }
        },
        second: {
          displayName: 'saat',
          relative: { 0: 'sekarang' },
          relativeTime: { future: { other: 'dalam {0} saat' }, past: { other: '{0} saat lalu' } }
        },
        'second-short': {
          displayName: 'saat',
          relative: { 0: 'sekarang' },
          relativeTime: { future: { other: 'dlm {0} saat' }, past: { other: '{0} saat lalu' } }
        }
      }
    },
    {
    ...
    { locale: 'ms-SG', parentLocale: 'ms' },
    {
      ...
      fields: {
        year: {
          displayName: 'Sena',
          relative: { 0: 'din is-sena', 1: 'is-sena d-dieħla', '-1': 'is-sena l-oħra' },
          relativeTime: {
            future: {
              one: 'fi żmien sena',
            ...
            past: { one: 'sena ilu', few: '{0} snin ilu', many: '{0} snin ilu', other: '{0} snin ilu' }
          }
        },
        'year-short': {
          displayName: 'Sena',
          ...
          relativeTime: {
            ...
            past: { one: 'sa sena ilu', few: '{0} snin ilu', many: '{0} snin ilu', other: '{0} snin ilu' }
          }
        },
        month: {
          displayName: 'xahar',
          relative: { 0: 'Dan ix-xahar', 1: 'Ix-xahar id-dieħel', '-1': 'Ix-xahar li għadda' },
          relativeTime: {
            future: {
              one: 'sa xahar ieħor',
              few: 'fi {0} xhur oħra',
            ...
            past: { one: 'xahar ilu', few: '{0} xhur ilu', many: '{0} xhur ilu', other: '{0} xhur ilu' }
          }
        },
        'month-short': {
          displayName: 'Xahar',
          ...
          relativeTime: {
            ...
            past: { one: '{0} xahar ilu', few: '{0} xhur ilu', many: '{0} xhur ilu', other: '{0} xhur ilu' }
          }
        },
        day: {
          displayName: 'jum',
          relative: { 0: 'illum', 1: 'għada', '-1': 'lbieraħ' },
          relativeTime: {
            future: {
            ...
            past: { one: 'ġurnata ilu', few: '{0} ġranet ilu', many: '{0}-il ġurnata ilu', other: '{0}-il ġurnata ilu' }
          }
        },
        'day-short': {
          displayName: 'Jum',
        ...
        hour: {
          ...
          relativeTime: {
            ...
            past: { one: 'siegħa ilu', few: '{0} sigħat ilu', many: '{0} sigħat ilu', other: '{0} sigħat ilu' }
          }
        },
        'hour-short': {
          displayName: 'siegħa',
        ...
        minute: {
          ...
          relativeTime: {
            ...
            past: { one: 'minuta ilu', few: '{0} minuti ilu', many: '{0} minuti ilu', other: '{0} minuti ilu' }
          }
        },
        'minute-short': {
          displayName: 'min.',
          ...
          relativeTime: {
            ...
            past: { one: 'min. ilu', few: '{0} min. ilu', many: '{0} minuti ilu', other: '{0} min. ilu' }
          }
        },
        second: {
          displayName: 'sekonda',
          ...
          relativeTime: {
            ...
            past: { one: 'sekonda ilu', few: '{0} sekondi ilu', many: '{0} sekondi ilu', other: '{0} sekondi ilu' }
          }
        },
        'second-short': {
          displayName: 'sek.',
          ...
          relativeTime: {
            ...
            past: { one: 'sek. ilu', few: '{0} sek. ilu', many: '{0} sek. ilu', other: '{0} sek. ilu' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: { future: { other: '{0} နှစ်အတွင်း' }, past: { other: 'ပြီးခဲ့သည့် {0} နှစ်' } }
        },
        'year-short': {
          displayName: 'နှစ်',
          relative: { 0: 'ယခုနှစ်', 1: 'လာမည့်နှစ်', '-1': 'ယမန်နှစ်' },
        ...
        month: {
          ...
          relativeTime: { future: { other: '{0} လအတွင်း' }, past: { other: 'ပြီးခဲ့သည့် {0} လ' } }
        },
        'month-short': {
          displayName: 'လ',
          relative: { 0: 'ယခုလ', 1: 'လာမည့်လ', '-1': 'ပြီးခဲ့သည့်လ' },
        ...
        day: {
          displayName: 'ရက်',
          relative: { 0: 'ယနေ့', 1: 'မနက်ဖြန်', 2: 'သန်ဘက်ခါ', '-2': 'တစ်နေ့က', '-1': 'မနေ့က' },
          relativeTime: { future: { other: '{0} ရက်အတွင်း' }, past: { other: 'ပြီးခဲ့သည့် {0} ရက်' } }
        },
        'day-short': {
          displayName: 'ရက်',
          relative: { 0: 'ယနေ့', 1: 'မနက်ဖြန်', 2: 'သန်ဘက်ခါ', '-2': 'တစ်နေ့က', '-1': 'မနေ့က' },
        ...
        hour: {
          displayName: 'နာရီ',
          relative: { 0: 'ဤအချိန်' },
          relativeTime: { future: { other: '{0} နာရီအတွင်း' }, past: { other: 'ပြီးခဲ့သည့် {0} နာရီ' } }
        },
        'hour-short': {
          displayName: 'နာရီ',
          relative: { 0: 'ဤအချိန်' },
        ...
        minute: {
          displayName: 'မိနစ်',
          relative: { 0: 'ဤမိနစ်' },
          relativeTime: { future: { other: '{0} မိနစ်အတွင်း' }, past: { other: 'ပြီးခဲ့သည့် {0} မိနစ်' } }
        },
        'minute-short': {
          displayName: 'မိနစ်',
          relative: { 0: 'ဤမိနစ်' },
        ...
        second: {
          displayName: 'စက္ကန့်',
          relative: { 0: 'ယခု' },
          relativeTime: { future: { other: '{0} စက္ကန့်အတွင်း' }, past: { other: 'ပြီးခဲ့သည့် {0} စက္ကန့်' } }
        },
        'second-short': {
          displayName: 'စက္ကန့်',
          relative: { 0: 'ယခု' },
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: { future: { other: '{0} سال دله' }, past: { other: '{0} سال پیش' } }
        },
        'year-short': {
          displayName: 'سال',
          relative: { 0: 'امسال', 1: 'سال دیگه', '-1': 'پارسال' },
        ...
        month: {
          ...
          relativeTime: { future: { other: '{0} ماه دله' }, past: { other: '{0} ماه پیش' } }
        },
        'month-short': {
          displayName: 'ماه',
          relative: { 0: 'این ماه', 1: 'ماه ِبعد', '-1': 'ماه قبل' },
        ...
        day: {
          ...
          relativeTime: { future: { other: '{0} روز دله' }, past: { other: '{0} روز پیش' } }
        },
        'day-short': {
          displayName: 'روز',
          relative: { 0: 'اَمروز', 1: 'فِردا', '-1': 'دیروز' },
        ...
        hour: {
          displayName: 'ساعِت',
          relative: { 0: 'this hour' },
          relativeTime: { future: { other: '{0} ساعِت دله' }, past: { other: '{0} ساعِت پیش' } }
        },
        'hour-short': {
          displayName: 'ساعت',
          relative: { 0: 'this hour' },
          relativeTime: { future: { other: '{0} ساعت دله' }, past: { other: '{0} ساعت پیش' } }
        },
        minute: {
          displayName: 'دقیقه',
          relative: { 0: 'this minute' },
          relativeTime: { future: { other: '{0} دقیقه دله' }, past: { other: '{0} دَقه پیش' } }
        },
        'minute-short': {
          displayName: 'دَقه',
          relative: { 0: 'this minute' },
          relativeTime: { future: { other: '{0} دَقه دله' }, past: { other: '{0} دَقه پیش' } }
        },
        second: {
          displayName: 'ثانیه',
          relative: { 0: 'now' },
          relativeTime: { future: { other: '{0} ثانیه دله' }, past: { other: '{0} ثانیه پیش' } }
        },
        'second-short': {
          displayName: 'ثانیه',
          relative: { 0: 'now' },
    ...
    },
    {
      ...
      fields: {
        ...
        month: {
          displayName: 'måned',
          relative: { 0: 'denne måneden', 1: 'neste måned', '-1': 'forrige måned' },
          relativeTime: {
            future: { one: 'om {0} måned', other: 'om {0} måneder' },
            past: { one: 'for {0} måned siden', other: 'for {0} måneder siden' }
          }
        ...
        'month-short': {
          displayName: 'mnd.',
          relative: { 0: 'denne md.', 1: 'neste md.', '-1': 'forrige md.' },
          relativeTime: {
            future: { one: 'om {0} md.', other: 'om {0} md.' },
            past: { one: 'for {0} md. siden', other: 'for {0} md. siden' }
          }
        },
        day: {
          displayName: 'dag',
        ...
        'day-short': {
          ...
          relativeTime: {
            ...
            past: { one: 'for {0} d. siden', other: 'for {0} d. siden' }
          }
        },
        hour: {
          displayName: 'time',
        ...
        'hour-short': {
          ...
          relative: { 0: 'denne timen' },
          relativeTime: {
            future: { one: 'om {0} t', other: 'om {0} t' },
            past: { one: 'for {0} t siden', other: 'for {0} t siden' }
          }
        },
        minute: {
          displayName: 'minutt',
          ...
          relativeTime: {
            ...
            past: { one: 'for {0} minutt siden', other: 'for {0} minutter siden' }
          }
        },
        'minute-short': {
          displayName: 'min',
    ...
    { locale: 'nds-NL', parentLocale: 'nds' },
    {
      ...
      fields: {
        year: {
          displayName: 'वर्ष',
          relative: { 0: 'यो वर्ष', 1: 'आगामी वर्ष', '-1': 'गत वर्ष' },
          relativeTime: {
        ...
        day: {
          displayName: 'बार',
          relative: { 0: 'आज', 1: 'भोलि', 2: 'पर्सि', '-2': 'अस्ति', '-1': 'हिजो' },
          relativeTime: {
        ...
        second: {
          ...
          relative: { 0: 'अहिले' },
          relativeTime: {
            future: { one: '{0} सेकेन्डमा', other: '{0} सेकेन्डमा' },
            past: { one: '{0} सेकेन्ड पहिले', other: '{0} सेकेन्ड पहिले' }
          }
        },
        'second-short': {
          displayName: 'सेकेन्ड',
    ...
    { locale: 'ne-IN', parentLocale: 'ne' },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'dag',
          relative: { 0: 'vandaag', 1: 'morgen', 2: 'overmorgen', '-2': 'eergisteren', '-1': 'gisteren' },
          relativeTime: {
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: {
            future: { one: 'om {0} år', other: 'om {0} år' },
            past: { one: 'for {0} år sidan', other: 'for {0} år sidan' }
          }
        },
        'year-short': {
          displayName: 'år',
        ...
        month: {
          displayName: 'månad',
          relative: { 0: 'denne månaden', 1: 'neste månad', '-1': 'førre månad' },
          relativeTime: {
            future: { one: 'om {0} månad', other: 'om {0} månadar' },
            past: { one: 'for {0} månad sidan', other: 'for {0} månadar sidan' }
          }
        },
        'month-short': {
          displayName: 'mnd.',
          ...
          relativeTime: {
            future: { one: 'om {0} md.', other: 'om {0} md.' },
            past: { one: 'for {0} md. sidan', other: 'for {0} md. sidan' }
          }
        },
        day: {
          displayName: 'dag',
          relative: { 0: 'i dag', 1: 'i morgon', 2: 'i overmorgon', '-2': 'i førgår', '-1': 'i går' },
          relativeTime: {
            future: { one: 'om {0} døgn', other: 'om {0} døgn' },
            past: { one: 'for {0} døgn sidan', other: 'for {0} døgn sidan' }
          }
        },
        'day-short': {
          displayName: 'dag',
          ...
          relativeTime: {
            future: { one: 'om {0} d.', other: 'om {0} d.' },
            past: { one: 'for {0} d. sidan', other: 'for {0} d. sidan' }
          }
        },
        hour: {
          displayName: 'time',
          relative: { 0: 'denne timen' },
          relativeTime: {
            future: { one: 'om {0} time', other: 'om {0} timar' },
            past: { one: 'for {0} time sidan', other: 'for {0} timar sidan' }
          }
        },
        'hour-short': {
          displayName: 't',
          ...
          relativeTime: {
            future: { one: 'om {0} t', other: 'om {0} t' },
            past: { one: 'for {0} t sidan', other: 'for {0} t sidan' }
          }
        },
        minute: {
          displayName: 'minutt',
          relative: { 0: 'dette minuttet' },
          relativeTime: {
            future: { one: 'om {0} minutt', other: 'om {0} minutt' },
            past: { one: 'for {0} minutt sidan', other: 'for {0} minutt sidan' }
          }
        },
        'minute-short': {
          displayName: 'min',
          ...
          relativeTime: {
            future: { one: 'om {0} min', other: 'om {0} min' },
            past: { one: 'for {0} min sidan', other: 'for {0} min sidan' }
          }
        },
        second: {
          displayName: 'sekund',
          relative: { 0: 'no' },
          relativeTime: {
            future: { one: 'om {0} sekund', other: 'om {0} sekund' },
            past: { one: 'for {0} sekund sidan', other: 'for {0} sekund sidan' }
          }
        },
        'second-short': {
          displayName: 'sek',
          ...
          relativeTime: {
            future: { one: 'om {0} sek', other: 'om {0} sek' },
            past: { one: 'for {0} sek sidan', other: 'for {0} sek sidan' }
          }
        }
      }
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'lyɛ̌ʼ',
          relative: { 0: 'lyɛ̌ʼɔɔn', 1: 'jǔɔ gẅie à ne ntóo', '-1': 'jǔɔ gẅie à ka tɔ̌g' },
          relativeTime: { future: { other: '+{0} d' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'lyɛ̌ʼ',
    ...
    { locale: 'om-KE', parentLocale: 'om' },
    {
      ...
      fields: {
        year: {
          displayName: 'ବର୍ଷ',
          relative: { 0: 'ଏହି ବର୍ଷ', 1: 'ଆଗାମୀ ବର୍ଷ', '-1': 'ଗତ ବର୍ଷ' },
          relativeTime: {
            future: { one: '{0} ବର୍ଷରେ', other: '{0} ବର୍ଷରେ' },
            past: { one: '{0} ବର୍ଷ ପୂର୍ବେ', other: '{0} ବର୍ଷ ପୂର୍ବେ' }
          }
        },
        'year-short': {
          displayName: 'ବ.',
          relative: { 0: 'ଏହି ବର୍ଷ', 1: 'ଆଗାମୀ ବର୍ଷ', '-1': 'ଗତ ବର୍ଷ' },
          relativeTime: {
            future: { one: '{0} ବ. ରେ', other: '{0} ବ. ରେ' },
            past: { one: '{0} ବ. ପୂର୍ବେ', other: '{0} ବ. ପୂର୍ବେ' }
          }
        },
        month: {
          displayName: 'ମାସ',
          relative: { 0: 'ଏହି ମାସ', 1: 'ଆଗାମୀ ମାସ', '-1': 'ଗତ ମାସ' },
          relativeTime: {
            future: { one: '{0} ମାସରେ', other: '{0} ମାସରେ' },
            past: { one: '{0} ମାସ ପୂର୍ବେ', other: '{0} ମାସ ପୂର୍ବେ' }
          }
        },
        'month-short': {
          displayName: 'ମା.',
          relative: { 0: 'ଏହି ମାସ', 1: 'ଆଗାମୀ ମାସ', '-1': 'ଗତ ମାସ' },
          relativeTime: {
            future: { one: '{0} ମା. ରେ', other: '{0} ମା. ରେ' },
            past: { one: '{0} ମା. ପୂର୍ବେ', other: '{0} ମା. ପୂର୍ବେ' }
          }
        },
        day: {
          displayName: 'ଦିନ',
          relative: { 0: 'ଆଜି', 1: 'ଆସନ୍ତାକାଲି', '-1': 'ଗତକାଲି' },
          relativeTime: {
            future: { one: '{0} ଦିନରେ', other: '{0} ଦିନରେ' },
            past: { one: '{0} ଦିନ ପୂର୍ବେ', other: '{0} ଦିନ ପୂର୍ବେ' }
          }
        },
        'day-short': {
          displayName: 'ଦିନ',
        ...
        hour: {
          ...
          relativeTime: {
            future: { one: '{0} ଘଣ୍ଟାରେ', other: '{0} ଘଣ୍ଟାରେ' },
            past: { one: '{0} ଘଣ୍ଟା ପୂର୍ବେ', other: '{0} ଘଣ୍ଟା ପୂର୍ବେ' }
          }
        },
        'hour-short': {
          displayName: 'ଘ.',
          relative: { 0: 'ଏହି ଘଣ୍ଟା' },
          relativeTime: {
            future: { one: '{0} ଘ. ରେ', other: '{0} ଘ. ରେ' },
            past: { one: '{0} ଘ. ପୂର୍ବେ', other: '{0} ଘ. ପୂର୍ବେ' }
          }
        },
        minute: {
          displayName: 'ମିନିଟ୍',
          ...
          relativeTime: {
            future: { one: '{0} ମିନିଟ୍‌‌ରେ', other: '{0} ମିନିଟ୍‌‌ରେ' },
            past: { one: '{0} ମିନିଟ୍ ପୂର୍ବେ', other: '{0} ମିନିଟ୍ ପୂର୍ବେ' }
          }
        },
        'minute-short': {
          displayName: 'ମି.',
          relative: { 0: 'ଏହି ମିନିଟ୍' },
          relativeTime: {
            future: { one: '{0} ମି. ରେ', other: '{0} ମି. ରେ' },
            past: { one: '{0} ମି. ପୂର୍ବେ', other: '{0} ମି. ପୂର୍ବେ' }
          }
        },
        second: {
          ...
          relativeTime: {
            future: { one: '{0} ସେକେଣ୍ଡରେ', other: '{0} ସେକେଣ୍ଡରେ' },
            past: { one: '{0} ସେକେଣ୍ଡ ପୂର୍ବେ', other: '{0} ସେକେଣ୍ଡ ପୂର୍ବେ' }
          }
        },
        'second-short': {
          displayName: 'ସେକେଣ୍ଡ୍',
          relative: { 0: 'ବର୍ତ୍ତମାନ' },
          relativeTime: {
            future: { one: '{0} ସେ. ରେ', other: '{0} ସେ. ରେ' },
            past: { one: '{0} ସେ. ପୂର୍ବେ', other: '{0} ସେ. ପୂର୍ବେ' }
          }
        }
      }
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'Бон',
          relative: { 0: 'Абон', 1: 'Сом', 2: 'Иннӕбон', '-2': 'Ӕндӕрӕбон', '-1': 'Знон' },
          relativeTime: {
      ...
      pluralRuleFunction: function (e, t) {
        ...
        return t
          ...
          : 1 == e && i
            ...
            : i && o >= 2 && o <= 4 && (n < 12 || n > 14)
              ? 'few'
              : (i && 1 != r && (0 == o || 1 == o)) || (i && o >= 5 && o <= 9) || (i && n >= 12 && n <= 14)
                ? 'many'
                : 'other';
      },
      fields: {
        ...
        'month-short': {
          ...
          relative: { 0: 'w tym miesiącu', 1: 'w przyszłym miesiącu', '-1': 'w zeszłym miesiącu' },
          relativeTime: {
            future: { one: 'za {0} mies.', few: 'za {0} mies.', many: 'za {0} mies.', other: 'za {0} mies.' },
            past: { one: '{0} mies. temu', few: '{0} mies. temu', many: '{0} mies. temu', other: '{0} mies. temu' }
          }
        },
        day: {
          displayName: 'dzień',
        ...
        'hour-short': {
          ...
          relative: { 0: 'ta godzina' },
          relativeTime: {
            future: { one: 'za {0} godz.', few: 'za {0} godz.', many: 'za {0} godz.', other: 'za {0} godz.' },
            past: { one: '{0} godz. temu', few: '{0} godz. temu', many: '{0} godz. temu', other: '{0} godz. temu' }
          }
        },
        minute: {
          displayName: 'minuta',
        ...
        'second-short': {
          ...
          relative: { 0: 'teraz' },
          relativeTime: {
            future: { one: 'za {0} sek.', few: 'za {0} sek.', many: 'za {0} sek.', other: 'za {0} sek.' },
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'dia',
          relative: { 0: 'hoje', 1: 'amanhã', 2: 'depois de amanhã', '-2': 'anteontem', '-1': 'ontem' },
          relativeTime: {
        ...
        'hour-short': {
          displayName: 'h',
          relative: { 0: 'esta hora' },
          relativeTime: { future: { one: 'em {0} h', other: 'em {0} h' }, past: { one: 'há {0} h', other: 'há {0} h' } }
        },
        minute: {
          displayName: 'minuto',
          relative: { 0: 'este minuto' },
        ...
        'second-short': {
          ...
          relative: { 0: 'agora' },
          relativeTime: {
            future: { one: 'em {0} seg.', other: 'em {0} seg.' },
            past: { one: 'há {0} seg.', other: 'há {0} seg.' }
          }
        }
      }
    },
    ...
    { locale: 'pt-TL', parentLocale: 'pt-PT' },
    {
      ...
      fields: {
        year: {
          displayName: 'Year',
          relative: { 0: 'kunan wata', 1: 'hamuq wata', '-1': 'qayna wata' },
          relativeTime: { future: { other: '+{0} y' }, past: { other: '-{0} y' } }
        },
        'year-short': {
          displayName: 'Year',
        ...
        month: {
          displayName: 'Month',
          relative: { 0: 'kunan killa', 1: 'hamuq killa', '-1': 'qayna killa' },
          relativeTime: { future: { other: '+{0} m' }, past: { other: '-{0} m' } }
        },
        'month-short': {
          displayName: 'Month',
        ...
        day: {
          displayName: 'Day',
          relative: { 0: 'kunan punchaw', 1: 'paqarin', '-1': 'qayna punchaw' },
          relativeTime: { future: { other: '+{0} d' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'Day',
    ...
    { locale: 'qu-EC', parentLocale: 'qu' },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'Tag',
          relative: { 0: 'oz', 1: 'damaun', 2: 'puschmaun', '-2': 'stersas', '-1': 'ier' },
          relativeTime: { future: { other: '+{0} d' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'Tag',
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: {
            future: { one: 'peste {0} an', few: 'peste {0} ani', other: 'peste {0} de ani' },
            past: { one: 'acum {0} an', few: 'acum {0} ani', other: 'acum {0} de ani' }
          }
        },
        'year-short': {
          displayName: 'an',
        ...
        month: {
          displayName: 'lună',
          relative: { 0: 'luna aceasta', 1: 'luna viitoare', '-1': 'luna trecută' },
          relativeTime: {
            future: { one: 'peste {0} lună', few: 'peste {0} luni', other: 'peste {0} de luni' },
            past: { one: 'acum {0} lună', few: 'acum {0} luni', other: 'acum {0} de luni' }
          }
        },
        'month-short': {
          displayName: 'lună',
          relative: { 0: 'luna aceasta', 1: 'luna viitoare', '-1': 'luna trecută' },
          relativeTime: {
            future: { one: 'peste {0} lună', few: 'peste {0} luni', other: 'peste {0} luni' },
            past: { one: 'acum {0} lună', few: 'acum {0} luni', other: 'acum {0} luni' }
          }
        },
        day: {
          displayName: 'zi',
          relative: { 0: 'azi', 1: 'mâine', 2: 'poimâine', '-2': 'alaltăieri', '-1': 'ieri' },
          relativeTime: {
            future: { one: 'peste {0} zi', few: 'peste {0} zile', other: 'peste {0} de zile' },
            past: { one: 'acum {0} zi', few: 'acum {0} zile', other: 'acum {0} de zile' }
          }
        },
        'day-short': {
          displayName: 'zi',
        ...
        hour: {
          ...
          relativeTime: {
            future: { one: 'peste {0} oră', few: 'peste {0} ore', other: 'peste {0} de ore' },
            past: { one: 'acum {0} oră', few: 'acum {0} ore', other: 'acum {0} de ore' }
          }
        },
        'hour-short': {
          displayName: 'h',
          relative: { 0: 'ora aceasta' },
          relativeTime: {
            future: { one: 'peste {0} h', few: 'peste {0} h', other: 'peste {0} h' },
            past: { one: 'acum {0} h', few: 'acum {0} h', other: 'acum {0} h' }
          }
        },
        minute: {
          displayName: 'minut',
          ...
          relativeTime: {
            future: { one: 'peste {0} minut', few: 'peste {0} minute', other: 'peste {0} de minute' },
            past: { one: 'acum {0} minut', few: 'acum {0} minute', other: 'acum {0} de minute' }
          }
        },
        'minute-short': {
          displayName: 'min.',
          relative: { 0: 'minutul acesta' },
          relativeTime: {
            future: { one: 'peste {0} min.', few: 'peste {0} min.', other: 'peste {0} min.' },
            past: { one: 'acum {0} min.', few: 'acum {0} min.', other: 'acum {0} min.' }
          }
        },
        second: {
          displayName: 'secundă',
          relative: { 0: 'acum' },
          relativeTime: {
            future: { one: 'peste {0} secundă', few: 'peste {0} secunde', other: 'peste {0} de secunde' },
            past: { one: 'acum {0} secundă', few: 'acum {0} secunde', other: 'acum {0} de secunde' }
          }
        },
        'second-short': {
          displayName: 'sec.',
          relative: { 0: 'acum' },
          relativeTime: {
            future: { one: 'peste {0} sec.', few: 'peste {0} sec.', other: 'peste {0} sec.' },
            past: { one: 'acum {0} sec.', few: 'acum {0} sec.', other: 'acum {0} sec.' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          displayName: 'г.',
          relative: { 0: 'в этом г.', 1: 'в след. г.', '-1': 'в прошлом г.' },
          relativeTime: {
            future: { one: 'через {0} г.', few: 'через {0} г.', many: 'через {0} л.', other: 'через {0} г.' },
            past: { one: '{0} г. назад', few: '{0} г. назад', many: '{0} л. назад', other: '{0} г. назад' }
          }
        },
        month: {
          displayName: 'месяц',
        ...
        'month-short': {
          displayName: 'мес.',
          relative: { 0: 'в этом мес.', 1: 'в следующем мес.', '-1': 'в прошлом мес.' },
          relativeTime: {
            future: { one: 'через {0} мес.', few: 'через {0} мес.', many: 'через {0} мес.', other: 'через {0} мес.' },
            past: { one: '{0} мес. назад', few: '{0} мес. назад', many: '{0} мес. назад', other: '{0} мес. назад' }
          }
        },
        day: {
          displayName: 'день',
          ...
          relativeTime: {
            future: { one: 'через {0} день', few: 'через {0} дня', many: 'через {0} дней', other: 'через {0} дня' },
        ...
        'day-short': {
          ...
          relative: { 0: 'сегодня', 1: 'завтра', 2: 'послезавтра', '-2': 'позавчера', '-1': 'вчера' },
          relativeTime: {
            future: { one: 'через {0} дн.', few: 'через {0} дн.', many: 'через {0} дн.', other: 'через {0} дн.' },
            past: { one: '{0} дн. назад', few: '{0} дн. назад', many: '{0} дн. назад', other: '{0} дн. назад' }
          }
        },
        hour: {
          displayName: 'час',
        ...
        'hour-short': {
          ...
          relative: { 0: 'в этот час' },
          relativeTime: {
            future: { one: 'через {0} ч.', few: 'через {0} ч.', many: 'через {0} ч.', other: 'через {0} ч.' },
            past: { one: '{0} ч. назад', few: '{0} ч. назад', many: '{0} ч. назад', other: '{0} ч. назад' }
          }
        },
        minute: {
          displayName: 'минута',
        ...
        'minute-short': {
          ...
          relative: { 0: 'в эту минуту' },
          relativeTime: {
            future: { one: 'через {0} мин.', few: 'через {0} мин.', many: 'через {0} мин.', other: 'через {0} мин.' },
            past: { one: '{0} мин. назад', few: '{0} мин. назад', many: '{0} мин. назад', other: '{0} мин. назад' }
          }
        },
        second: {
          displayName: 'секунда',
        ...
        'second-short': {
          ...
          relative: { 0: 'сейчас' },
          relativeTime: {
            future: { one: 'через {0} сек.', few: 'через {0} сек.', many: 'через {0} сек.', other: 'через {0} сек.' },
            past: { one: '{0} сек. назад', few: '{0} сек. назад', many: '{0} сек. назад', other: '{0} сек. назад' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: { future: { other: '{0} сылынан' }, past: { other: '{0} сыл ынараа өттүгэр' } }
        },
        'year-short': {
          displayName: 'Сыл',
          relative: { 0: 'быйыл', 1: 'эһиил', '-1': 'Былырыын' },
        ...
        month: {
          ...
          relativeTime: { future: { other: '{0} ыйынан' }, past: { other: '{0} ый ынараа өттүгэр' } }
        },
        'month-short': {
          displayName: 'Ый',
          relative: { 0: 'бу ый', 1: 'аныгыскы ый', '-1': 'ааспыт ый' },
        ...
        day: {
          displayName: 'Күн',
          relative: { 0: 'Бүгүн', 1: 'Сарсын', 2: 'Өйүүн', '-2': 'Иллэрээ күн', '-1': 'Бэҕэһээ' },
          relativeTime: { future: { other: '{0} күнүнэн' }, past: { other: '{0} күн ынараа өттүгэр' } }
        },
        'day-short': {
          displayName: 'Күн',
          relative: { 0: 'Бүгүн', 1: 'Сарсын', 2: 'Өйүүн', '-2': 'Иллэрээ күн', '-1': 'Бэҕэһээ' },
        ...
        hour: {
          displayName: 'Чаас',
          relative: { 0: 'this hour' },
          relativeTime: { future: { other: '{0} чааһынан' }, past: { other: '{0} чаас ынараа өттүгэр' } }
        },
        'hour-short': {
          displayName: 'Чаас',
          relative: { 0: 'this hour' },
        ...
        minute: {
          displayName: 'Мүнүүтэ',
          relative: { 0: 'this minute' },
          relativeTime: { future: { other: '{0} мүнүүтэннэн' }, past: { other: '{0} мүнүүтэ ынараа өттүгэр' } }
        },
        'minute-short': {
          displayName: 'Мүнүүтэ',
          relative: { 0: 'this minute' },
        ...
        second: {
          ...
          relative: { 0: 'билигин' },
          relativeTime: { future: { other: '{0} сөкүүндэннэн' }, past: { other: '{0} сөкүүндэ ынараа өттүгэр' } }
        },
        'second-short': {
          displayName: 'Сөкүүндэ',
          relative: { 0: 'билигин' },
          relativeTime: { future: { other: '{0} сөкүүндэннэн' }, past: { other: '{0} сөк. анараа өттүгэр' } }
        }
      }
    },
    {
    ...
    },
    {
      ...
      fields: {
        year: {
          displayName: 'سال',
          relative: { 0: 'پويون سال', 1: 'پويون سال', '-1': 'پويون سال' },
          relativeTime: {
            future: { one: '{0} سالن ۾', other: '{0} سالن ۾' },
            past: { one: '{0} سال پهرين', other: '{0} سال پهرين' }
          }
        },
        'year-short': {
          displayName: 'سال',
        ...
        month: {
          displayName: 'مهينو',
          relative: { 0: 'هن مهيني', 1: 'اڳين مهيني', '-1': 'پوئين مهيني' },
          relativeTime: {
            future: { one: '{0} مهينن ۾', other: '{0} مهينن ۾' },
            past: { one: '{0} مهينا پهرين', other: '{0} مهينا پهرين' }
          }
        },
        'month-short': {
          displayName: 'مهينو',
        ...
        day: {
          displayName: 'ڏينهن',
          relative: { 0: 'اڄ', 1: 'سڀاڻي', '-1': 'ڪل' },
          relativeTime: {
            future: { one: '{0} ڏينهن ۾', other: '{0} ڏينهن ۾' },
            past: { one: '{0} ڏينهن پهرين', other: '{0} ڏينهن پهرين' }
          }
        },
        'day-short': {
          displayName: 'ڏينهن',
        ...
        hour: {
          ...
          relative: { 0: 'هن ڪلڪ' },
          relativeTime: {
            future: { one: '{0} ڪلاڪ ۾', other: '{0} ڪلاڪ ۾' },
            past: { one: '{0} ڪلاڪ پهرين', other: '{0} ڪلاڪ پهرين' }
          }
        },
        'hour-short': {
          displayName: 'ڪلاڪ',
        ...
        minute: {
          ...
          relative: { 0: 'هن منٽ' },
          relativeTime: {
            future: { one: '{0} منٽن ۾', other: '+{0} min' },
            past: { one: '{0} منٽ پهرين', other: '{0} منٽ پهرين' }
          }
        },
        'minute-short': {
          displayName: 'منٽ',
          relative: { 0: 'هن منٽ' },
          relativeTime: {
            future: { one: '{0} منٽن ۾', other: '{0} منٽن ۾' },
            past: { one: '{0} منٽ پهرين', other: '{0} منٽ پهرين' }
          }
        },
        second: {
          ...
          relative: { 0: 'هاڻي' },
          relativeTime: {
            future: { one: '{0} سيڪنڊن ۾', other: '{0} سيڪنڊن ۾' },
            past: { one: '{0} سيڪنڊ پهرين', other: '{0} سيڪنڊ پهرين' }
          }
        },
        'second-short': {
          displayName: 'سيڪنڊ',
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relative: { 0: 'this year', 1: 'next year', '-1': 'last year' },
          relativeTime: {
            future: { one: '{0} jahki maŋŋilit', two: '{0} jahkki maŋŋilit', other: '{0} jahkki maŋŋilit' },
            past: { one: '{0} jahki árat', two: '{0} jahkki árat', other: '{0} jahkki árat' }
          }
        },
        'year-short': {
          displayName: 'jáhki',
        ...
        month: {
          ...
          relativeTime: {
            ...
            past: { one: '{0} mánotbadji árat', two: '{0} mánotbadji árat', other: '{0} mánotbadji árat' }
          }
        },
        'month-short': {
          displayName: 'mánnu',
        ...
        day: {
          displayName: 'beaivi',
          relative: { 0: 'odne', 1: 'ihttin', 2: 'paijeelittáá', '-2': 'oovdebpeivvi', '-1': 'ikte' },
          relativeTime: {
            future: { one: '{0} jándor maŋŋilit', two: '{0} jándor amaŋŋilit', other: '{0} jándora maŋŋilit' },
            past: { one: '{0} jándor árat', two: '{0} jándora árat', other: '{0} jándora árat' }
          }
        },
        'day-short': {
          displayName: 'beaivi',
        ...
        hour: {
          ...
          relative: { 0: 'this hour' },
          relativeTime: {
            future: { one: '{0} diibmu maŋŋilit', two: '{0} diibmur maŋŋilit', other: '{0} diibmur maŋŋilit' },
            past: { one: '{0} diibmu árat', two: '{0} diibmur árat', other: '{0} diibmur árat' }
          }
        },
        'hour-short': {
          displayName: 'diibmu',
        ...
        minute: {
          ...
          relative: { 0: 'this minute' },
          relativeTime: {
            future: { one: '{0} minuhta maŋŋilit', two: '{0} minuhtta maŋŋilit', other: '{0} minuhtta maŋŋilit' },
            past: { one: '{0} minuhta árat', two: '{0} minuhtta árat', other: '{0} minuhtta árat' }
          }
        },
        'minute-short': {
          displayName: 'minuhtta',
        ...
        second: {
          ...
          relative: { 0: 'now' },
          relativeTime: {
            future: { one: '{0} sekunda maŋŋilit', two: '{0} sekundda maŋŋilit', other: '{0} sekundda maŋŋilit' },
            past: { one: '{0} sekunda árat', two: '{0} sekundda árat', other: '{0} sekundda árat' }
          }
        },
        'second-short': {
          displayName: 'sekunda',
    ...
    },
    {
      ...
      fields: {
        year: {
          displayName: 'jahki',
          relative: { 0: 'dán jagi', 1: 'boahtte jagi', '-1': 'diibmá' },
          relativeTime: {
            future: { one: '{0} jagi siste', two: '{0} jagi siste', other: '{0} jagi siste' },
            past: { one: 'diibmá', two: 'ovddet jagi', other: '{0} jagi dás ovdal' }
          }
        },
        'year-short': {
          displayName: 'j.',
          relative: { 0: 'dán jagi', 1: 'boahtte jagi', '-1': 'diibmá' },
          relativeTime: {
            future: { one: '{0} j. siste', two: '{0} jagi siste', other: '{0} j. siste' },
            past: { one: 'diibmá', two: 'ovddet jagi', other: '{0} j. dás ovdal' }
          }
        },
        month: {
          displayName: 'mánnu',
          relative: { 0: 'dán mánu', 1: 'boahtte mánu', '-1': 'mannan mánu' },
          relativeTime: {
            future: { one: '{0} mánu siste', two: '{0} mánu siste', other: '{0} mánu siste' },
            past: { one: '{0} mánnu dás ovdal', two: '{0} mánu dás ovdal', other: '{0} mánu dás ovdal' }
          }
        },
        'month-short': {
          displayName: 'm.',
        ...
        day: {
          displayName: 'beaivi',
          relative: { 0: 'odne', 1: 'ihttin', 2: 'don beaivve', '-2': 'ovddet beaivvi', '-1': 'ikte' },
          relativeTime: {
            future: { one: '{0} beaivve siste', two: '{0} beaivve siste', other: '{0} beaivve siste' },
            past: { one: 'ikte', two: 'ovddet beaivve', other: '{0} beaivve dás ovdal' }
          }
        },
        'day-short': {
          displayName: 'b.',
        ...
        hour: {
          displayName: 'diibmu',
          relative: { 0: 'dán diimmu' },
          relativeTime: {
            future: { one: '{0} diimmu siste', two: '{0} diimmu siste', other: '{0} diimmu siste' },
            past: { one: '{0} diibmu áigi', two: '{0} diimmu áigi', other: '{0} diimmu áigi' }
          }
        },
        'hour-short': {
          displayName: 'dmu',
          relative: { 0: 'dán diimmu' },
          relativeTime: {
            future: { one: '{0} dmu siste', two: '{0} diimmu siste', other: '{0} dmu siste' },
            past: { one: '{0} dmu áigi', two: '{0} diimmu áigi', other: '{0} dmu áigi' }
          }
        },
        minute: {
          displayName: 'minuhtta',
          relative: { 0: 'dán minuhta' },
          relativeTime: {
            future: { one: '{0} minuhta siste', two: '{0} minuhta siste', other: '{0} minuhta siste' },
            past: { one: '{0} minuhtta áigi', two: '{0} minuhta áigi', other: '{0} minuhta áigi' }
          }
        },
        'minute-short': {
          displayName: 'min.',
          relative: { 0: 'dán minuhta' },
          relativeTime: {
            future: { one: '{0} min. siste', two: '{0} minuhta siste', other: '{0} min. siste' },
            past: { one: '{0} min. áigi', two: '{0} minuhta áigi', other: '{0} min. áigi' }
          }
        },
        second: {
          displayName: 'sekunda',
          relative: { 0: 'dál' },
          relativeTime: {
            future: { one: '{0} sekundda siste', two: '{0} sekundda siste', other: '{0} sekundda siste' },
            past: { one: '{0} sekunda áigi', two: '{0} sekundda áigi', other: '{0} sekundda áigi' }
          }
        },
        'second-short': {
          displayName: 'sek.',
          relative: { 0: 'dál' },
          relativeTime: {
            future: { one: '{0} sek. siste', two: '{0} sekundda siste', other: '{0} sek. siste' },
            past: { one: '{0} sek. áigi', two: '{0} sekundda áigi', other: '{0} sek. áigi' }
          }
        }
      }
    },
    ...
    { locale: 'shi-Tfng', parentLocale: 'shi' },
    {
      ...
      fields: {
        ...
        'month-short': {
          displayName: 'මාස.',
          relative: { 0: 'මෙම මාස.', 1: 'ඊළඟ මාස.', '-1': 'පසුගිය මාස.' },
          relativeTime: {
            future: { one: 'මාස {0}කින්', other: 'මාස {0}කින්' },
            past: { one: 'මාස {0}කට පෙර', other: 'මාස {0}කට පෙර' }
          }
        ...
        day: {
          displayName: 'දිනය',
          relative: { 0: 'අද', 1: 'හෙට', 2: 'අනිද්දා', '-2': 'පෙරේදා', '-1': 'ඊයේ' },
          relativeTime: {
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: {
            future: { one: 'o {0} rok', few: 'o {0} roky', many: 'o {0} roka', other: 'o {0} rokov' },
            past: { one: 'pred {0} rokom', few: 'pred {0} rokmi', many: 'pred {0} roka', other: 'pred {0} rokmi' }
          }
        },
        'year-short': {
          displayName: 'r.',
          relative: { 0: 'tento rok', 1: 'budúci rok', '-1': 'minulý rok' },
          relativeTime: {
            future: { one: 'o {0} r.', few: 'o {0} r.', many: 'o {0} r.', other: 'o {0} r.' },
            past: { one: 'pred {0} r.', few: 'pred {0} r.', many: 'pred {0} r.', other: 'pred {0} r.' }
          }
        },
        month: {
          displayName: 'mesiac',
          relative: { 0: 'tento mesiac', 1: 'budúci mesiac', '-1': 'minulý mesiac' },
          relativeTime: {
            future: { one: 'o {0} mesiac', few: 'o {0} mesiace', many: 'o {0} mesiaca', other: 'o {0} mesiacov' },
            past: {
              one: 'pred {0} mesiacom',
              few: 'pred {0} mesiacmi',
              many: 'pred {0} mesiaca',
        ...
        'month-short': {
          displayName: 'mes.',
          relative: { 0: 'tento mes.', 1: 'budúci mes.', '-1': 'minulý mes.' },
          relativeTime: {
            future: { one: 'o {0} mes.', few: 'o {0} mes.', many: 'o {0} mes.', other: 'o {0} mes.' },
            past: { one: 'pred {0} mes.', few: 'pred {0} mes.', many: 'pred {0} mes.', other: 'pred {0} mes.' }
          }
        },
        day: {
          displayName: 'deň',
          relative: { 0: 'dnes', 1: 'zajtra', 2: 'pozajtra', '-2': 'predvčerom', '-1': 'včera' },
          relativeTime: {
            future: { one: 'o {0} deň', few: 'o {0} dni', many: 'o {0} dňa', other: 'o {0} dní' },
            past: { one: 'pred {0} dňom', few: 'pred {0} dňami', many: 'pred {0} dňa', other: 'pred {0} dňami' }
          }
        },
        'day-short': {
          displayName: 'd.',
          relative: { 0: 'dnes', 1: 'zajtra', 2: 'pozajtra', '-2': 'predvčerom', '-1': 'včera' },
          relativeTime: {
            future: { one: 'o {0} d.', few: 'o {0} d.', many: 'o {0} d.', other: 'o {0} d.' },
            past: { one: 'pred {0} d.', few: 'pred {0} d.', many: 'pred {0} d.', other: 'pred {0} d.' }
          }
        },
        hour: {
          displayName: 'hodina',
          ...
          relativeTime: {
            future: { one: 'o {0} hodinu', few: 'o {0} hodiny', many: 'o {0} hodiny', other: 'o {0} hodín' },
            past: {
              one: 'pred {0} hodinou',
              few: 'pred {0} hodinami',
              many: 'pred {0} hodinou',
        ...
        'hour-short': {
          ...
          relative: { 0: 'v tejto hodine' },
          relativeTime: {
            future: { one: 'o {0} h', few: 'o {0} h', many: 'o {0} h', other: 'o {0} h' },
            past: { one: 'pred {0} h', few: 'pred {0} h', many: 'pred {0} h', other: 'pred {0} h' }
          }
        },
        minute: {
          displayName: 'minúta',
          ...
          relativeTime: {
            future: { one: 'o {0} minútu', few: 'o {0} minúty', many: 'o {0} minúty', other: 'o {0} minút' },
            past: {
              one: 'pred {0} minútou',
              few: 'pred {0} minútami',
              many: 'pred {0} minúty',
        ...
        'minute-short': {
          ...
          relative: { 0: 'v tejto minúte' },
          relativeTime: {
            future: { one: 'o {0} min', few: 'o {0} min', many: 'o {0} min', other: 'o {0} min' },
            past: { one: 'pred {0} min', few: 'pred {0} min', many: 'pred {0} min', other: 'pred {0} min' }
          }
        },
        second: {
          displayName: 'sekunda',
          relative: { 0: 'teraz' },
          relativeTime: {
            future: { one: 'o {0} sekundu', few: 'o {0} sekundy', many: 'o {0} sekundy', other: 'o {0} sekúnd' },
            past: {
              one: 'pred {0} sekundou',
        ...
        'second-short': {
          ...
          relative: { 0: 'teraz' },
          relativeTime: {
            future: { one: 'o {0} s', few: 'o {0} s', many: 'o {0} s', other: 'o {0} s' },
            past: { one: 'pred {0} s', few: 'pred {0} s', many: 'pred {0} s', other: 'pred {0} s' }
          }
        }
      }
    },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: {
            future: { one: 'čez {0} leto', two: 'čez {0} leti', few: 'čez {0} leta', other: 'čez {0} let' },
            past: { one: 'pred {0} letom', two: 'pred {0} letoma', few: 'pred {0} leti', other: 'pred {0} leti' }
          }
        },
        'year-short': {
          displayName: 'leto',
        ...
        month: {
          displayName: 'mesec',
          relative: { 0: 'ta mesec', 1: 'naslednji mesec', '-1': 'prejšnji mesec' },
          relativeTime: {
            future: { one: 'čez {0} mesec', two: 'čez {0} meseca', few: 'čez {0} mesece', other: 'čez {0} mesecev' },
            past: {
              one: 'pred {0} mesecem',
              two: 'pred {0} mesecema',
              few: 'pred {0} meseci',
        ...
        'month-short': {
          ...
          relative: { 0: 'ta mesec', 1: 'naslednji mesec', '-1': 'prejšnji mesec' },
          relativeTime: {
            future: { one: 'čez {0} mes.', two: 'čez {0} mes.', few: 'čez {0} mes.', other: 'čez {0} mes.' },
            past: { one: 'pred {0} mes.', two: 'pred {0} mes.', few: 'pred {0} mes.', other: 'pred {0} mes.' }
          }
        },
        day: {
          displayName: 'dan',
          relative: { 0: 'danes', 1: 'jutri', 2: 'pojutrišnjem', '-2': 'predvčerajšnjim', '-1': 'včeraj' },
          relativeTime: {
            future: { one: 'čez {0} dan', two: 'čez {0} dneva', few: 'čez {0} dni', other: 'čez {0} dni' },
            past: { one: 'pred {0} dnevom', two: 'pred {0} dnevoma', few: 'pred {0} dnevi', other: 'pred {0} dnevi' }
          }
        },
        'day-short': {
          displayName: 'dan',
        ...
        hour: {
          ...
          relativeTime: {
            future: { one: 'čez {0} uro', two: 'čez {0} uri', few: 'čez {0} ure', other: 'čez {0} ur' },
            past: { one: 'pred {0} uro', two: 'pred {0} urama', few: 'pred {0} urami', other: 'pred {0} urami' }
          }
        },
        'hour-short': {
          displayName: 'ura',
        ...
        minute: {
          ...
          relativeTime: {
            future: { one: 'čez {0} minuto', two: 'čez {0} minuti', few: 'čez {0} minute', other: 'čez {0} minut' },
            past: {
              one: 'pred {0} minuto',
              two: 'pred {0} minutama',
              few: 'pred {0} minutami',
        ...
        'minute-short': {
          ...
          relative: { 0: 'to minuto' },
          relativeTime: {
            future: { one: 'čez {0} min.', two: 'čez {0} min.', few: 'čez {0} min.', other: 'čez {0} min.' },
            past: { one: 'pred {0} min.', two: 'pred {0} min.', few: 'pred {0} min.', other: 'pred {0} min.' }
          }
        },
        second: {
          displayName: 'sekunda',
          relative: { 0: 'zdaj' },
          relativeTime: {
            future: { one: 'čez {0} sekundo', two: 'čez {0} sekundi', few: 'čez {0} sekunde', other: 'čez {0} sekund' },
            past: {
              one: 'pred {0} sekundo',
        ...
        'second-short': {
          ...
          relative: { 0: 'zdaj' },
          relativeTime: {
            future: { one: 'čez {0} s', two: 'čez {0} s', few: 'čez {0} s', other: 'čez {0} s' },
            past: { one: 'pred {0} s', two: 'pred {0} s', few: 'pred {0} s', other: 'pred {0} s' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        year: {
          displayName: 'Year',
          relative: { 0: 'Sannadkan', 1: 'Sannadka xiga', '-1': 'Sannadkii la soo dhaafay' },
          relativeTime: { future: { one: '+{0} y', other: '+{0} y' }, past: { one: '-{0} y', other: '-{0} y' } }
        },
        'year-short': {
          displayName: 'Sanadkii',
          relative: { 0: 'Sannadkan', 1: 'Sannadka xiga', '-1': 'Sannadkii la soo dhaafay' },
          relativeTime: { future: { one: '+{0} y', other: '+{0} y' }, past: { one: '-{0} y', other: '-{0} y' } }
        },
        month: {
          displayName: 'Month',
          relative: { 0: 'Bishan', 1: 'Bisha xigta', '-1': 'Bishii la soo dhaafay' },
          relativeTime: { future: { one: '+{0} m', other: '+{0} m' }, past: { one: '-{0} m', other: '-{0} m' } }
        },
        'month-short': {
          displayName: 'Bil-gaaban',
          relative: { 0: 'Bishan', 1: 'Bisha xigta', '-1': 'Bishii la soo dhaafay' },
          relativeTime: { future: { one: '+{0} m', other: '+{0} m' }, past: { one: '-{0} m', other: '-{0} m' } }
        },
        day: {
    ...
    { locale: 'so-KE', parentLocale: 'so' },
    {
      ...
      fields: {
        year: {
          displayName: 'vit',
          relative: { 0: 'sivjet', 1: 'mot', '-1': 'vjet' },
          relativeTime: {
        ...
        'year-short': {
          displayName: 'vit',
          relative: { 0: 'këtë vit', 1: 'vitin e ardhshëm', '-1': 'vitin e kaluar' },
          relativeTime: {
            future: { one: 'pas {0} viti', other: 'pas {0} vjetësh' },
            past: { one: '{0} vit më parë', other: '{0} vjet më parë' }
          }
        ...
        month: {
          displayName: 'muaj',
          relative: { 0: 'këtë muaj', 1: 'muajin e ardhshëm', '-1': 'muajin e kaluar' },
          relativeTime: {
        ...
        'minute-short': {
          ...
          relative: { 0: 'këtë minutë' },
          relativeTime: {
            future: { one: 'pas {0} min', other: 'pas {0} min' },
            past: { one: '{0} min më parë', other: '{0} min më parë' }
          }
        },
        second: {
          displayName: 'sekondë',
        ...
        'second-short': {
          ...
          relative: { 0: 'tani' },
          relativeTime: {
            future: { one: 'pas {0} sek', other: 'pas {0} sek' },
            past: { one: '{0} sek më parë', other: '{0} sek më parë' }
          }
        }
      }
    },
    ...
    { locale: 'sq-XK', parentLocale: 'sq' },
    {
      ...
      fields: {
        ...
        'year-short': {
          displayName: 'год.',
          relative: { 0: 'ове год.', 1: 'следеће год.', '-1': 'прошле год.' },
          relativeTime: {
            future: { one: 'за {0} год.', few: 'за {0} год.', other: 'за {0} год.' },
            past: { one: 'пре {0} год.', few: 'пре {0} год.', other: 'пре {0} год.' }
          }
        },
        month: {
          displayName: 'месец',
          ...
          relativeTime: {
            future: { one: 'за {0} месец', few: 'за {0} месеца', other: 'за {0} месеци' },
            past: { one: 'пре {0} месеца', few: 'пре {0} месеца', other: 'пре {0} месеци' }
          }
        },
        'month-short': {
          displayName: 'мес.',
          relative: { 0: 'овог мес.', 1: 'следећег мес.', '-1': 'прошлог мес.' },
          relativeTime: {
            future: { one: 'за {0} мес.', few: 'за {0} мес.', other: 'за {0} мес.' },
            past: { one: 'пре {0} мес.', few: 'пре {0} мес.', other: 'пре {0} мес.' }
          }
        },
        day: {
          displayName: 'дан',
          ...
          relativeTime: {
            future: { one: 'за {0} дан', few: 'за {0} дана', other: 'за {0} дана' },
            past: { one: 'пре {0} дана', few: 'пре {0} дана', other: 'пре {0} дана' }
          }
        },
        'day-short': {
          displayName: 'д.',
          relative: { 0: 'данас', 1: 'сутра', 2: 'прекосутра', '-2': 'прекјуче', '-1': 'јуче' },
          relativeTime: {
            future: { one: 'за {0} д.', few: 'за {0} д.', other: 'за {0} д.' },
            past: { one: 'пре {0} д.', few: 'пре {0} д.', other: 'пре {0} д.' }
          }
        },
        hour: {
          displayName: 'сат',
          ...
          relativeTime: {
            future: { one: 'за {0} сат', few: 'за {0} сата', other: 'за {0} сати' },
            past: { one: 'пре {0} сата', few: 'пре {0} сата', other: 'пре {0} сати' }
          }
        },
        'hour-short': {
          displayName: 'ч.',
          relative: { 0: 'овог сата' },
          relativeTime: {
            future: { one: 'за {0} ч.', few: 'за {0} ч.', other: 'за {0} ч.' },
            past: { one: 'пре {0} ч.', few: 'пре {0} ч.', other: 'пре {0} ч.' }
          }
        },
        minute: {
          displayName: 'минут',
          ...
          relativeTime: {
            future: { one: 'за {0} минут', few: 'за {0} минута', other: 'за {0} минута' },
            past: { one: 'пре {0} минута', few: 'пре {0} минута', other: 'пре {0} минута' }
          }
        },
        'minute-short': {
          displayName: 'мин.',
          relative: { 0: 'овог минута' },
          relativeTime: {
            future: { one: 'за {0} мин.', few: 'за {0} мин.', other: 'за {0} мин.' },
            past: { one: 'пре {0} мин.', few: 'пре {0} мин.', other: 'пре {0} мин.' }
          }
        },
        second: {
          displayName: 'секунд',
          relative: { 0: 'сада' },
          relativeTime: {
            future: { one: 'за {0} секунду', few: 'за {0} секунде', other: 'за {0} секунди' },
            past: { one: 'пре {0} секунде', few: 'пре {0} секунде', other: 'пре {0} секунди' }
          }
        },
        'second-short': {
          displayName: 'сек.',
          relative: { 0: 'сада' },
          relativeTime: {
            future: { one: 'за {0} сек.', few: 'за {0} сек.', other: 'за {0} сек.' },
            past: { one: 'пре {0} сек.', few: 'пре {0} сек.', other: 'пре {0} сек.' }
          }
        }
      }
    },
    ...
    { locale: 'sr-Cyrl-XK', parentLocale: 'sr-Cyrl' },
    {
      ...
      fields: {
        year: {
          displayName: 'godina',
          relative: { 0: 'ove godine', 1: 'sledeće godine', '-1': 'prošle godine' },
          relativeTime: {
            future: { one: 'za {0} godinu', few: 'za {0} godine', other: 'za {0} godina' },
            past: { one: 'pre {0} godine', few: 'pre {0} godine', other: 'pre {0} godina' }
          }
        },
        'year-short': {
          displayName: 'god.',
          relative: { 0: 'ove god.', 1: 'sledeće god.', '-1': 'prošle god.' },
          relativeTime: {
            future: { one: 'za {0} god.', few: 'za {0} god.', other: 'za {0} god.' },
            past: { one: 'pre {0} god.', few: 'pre {0} god.', other: 'pre {0} god.' }
          }
        },
        month: {
          displayName: 'mesec',
          relative: { 0: 'ovog meseca', 1: 'sledećeg meseca', '-1': 'prošlog meseca' },
          relativeTime: {
            future: { one: 'za {0} mesec', few: 'za {0} meseca', other: 'za {0} meseci' },
            past: { one: 'pre {0} meseca', few: 'pre {0} meseca', other: 'pre {0} meseci' }
          }
        },
        'month-short': {
          displayName: 'mes.',
          relative: { 0: 'ovog mes.', 1: 'sledećeg mes.', '-1': 'prošlog mes.' },
          relativeTime: {
            future: { one: 'za {0} mes.', few: 'za {0} mes.', other: 'za {0} mes.' },
            past: { one: 'pre {0} mes.', few: 'pre {0} mes.', other: 'pre {0} mes.' }
          }
        },
        day: {
          displayName: 'dan',
          relative: { 0: 'danas', 1: 'sutra', 2: 'prekosutra', '-2': 'prekjuče', '-1': 'juče' },
          relativeTime: {
            future: { one: 'za {0} dan', few: 'za {0} dana', other: 'za {0} dana' },
            past: { one: 'pre {0} dana', few: 'pre {0} dana', other: 'pre {0} dana' }
          }
        },
        'day-short': {
          displayName: 'd.',
          ...
          relativeTime: {
            future: { one: 'za {0} d.', few: 'za {0} d.', other: 'za {0} d.' },
            past: { one: 'pre {0} d.', few: 'pre {0} d.', other: 'pre {0} d.' }
          }
        },
        hour: {
          displayName: 'sat',
          ...
          relativeTime: {
            future: { one: 'za {0} sat', few: 'za {0} sata', other: 'za {0} sati' },
            past: { one: 'pre {0} sata', few: 'pre {0} sata', other: 'pre {0} sati' }
          }
        },
        'hour-short': {
          displayName: 'č.',
          relative: { 0: 'ovog sata' },
          relativeTime: {
            future: { one: 'za {0} č.', few: 'za {0} č.', other: 'za {0} č.' },
            past: { one: 'pre {0} č.', few: 'pre {0} č.', other: 'pre {0} č.' }
          }
        },
        minute: {
          displayName: 'minut',
          ...
          relativeTime: {
            future: { one: 'za {0} minut', few: 'za {0} minuta', other: 'za {0} minuta' },
            past: { one: 'pre {0} minuta', few: 'pre {0} minuta', other: 'pre {0} minuta' }
          }
        },
        'minute-short': {
          displayName: 'min.',
          ...
          relativeTime: {
            future: { one: 'za {0} min.', few: 'za {0} min.', other: 'za {0} min.' },
            past: { one: 'pre {0} min.', few: 'pre {0} min.', other: 'pre {0} min.' }
          }
        },
        second: {
          displayName: 'sekund',
          ...
          relativeTime: {
            future: { one: 'za {0} sekundu', few: 'za {0} sekunde', other: 'za {0} sekundi' },
            past: { one: 'pre {0} sekunde', few: 'pre {0} sekunde', other: 'pre {0} sekundi' }
          }
        },
        'second-short': {
          displayName: 'sek.',
          ...
          relativeTime: {
            future: { one: 'za {0} sek.', few: 'za {0} sek.', other: 'za {0} sek.' },
            past: { one: 'pre {0} sek.', few: 'pre {0} sek.', other: 'pre {0} sek.' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      pluralRuleFunction: function (e, t) {
        var a = String(e).split('.'),
          ...
          o = i && a[0].slice(-1),
          n = i && a[0].slice(-2);
        return t ? ((1 != o && 2 != o) || 11 == n || 12 == n ? 'other' : 'one') : 1 == e && r ? 'one' : 'other';
      },
      fields: {
        year: {
          displayName: 'år',
    ...
    { locale: 'sv-FI', parentLocale: 'sv' },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'siku',
          relative: { 0: 'leo', 1: 'kesho', 2: 'kesho kutwa', '-2': 'juzi', '-1': 'jana' },
          relativeTime: {
        ...
        second: {
          ...
          relativeTime: {
            future: { one: 'baada ya sekunde {0}', other: 'baada ya sekunde {0}' },
            past: { one: 'Sekunde {0} iliyopita', other: 'Sekunde {0} zilizopita' }
          }
        },
        'second-short': {
          displayName: 'sek',
    ...
    },
    {
      ...
      fields: {
        ...
        'month-short': {
          ...
          relative: { 0: 'இந்த மாதம்', 1: 'அடுத்த மாதம்', '-1': 'கடந்த மாதம்' },
          relativeTime: {
            future: { one: '{0} மாத.', other: '{0} மாத.' },
            past: { one: '{0} மாத. முன்', other: '{0} மாத. முன்' }
          }
        },
        day: {
          displayName: 'நாள்',
          relative: { 0: 'இன்று', 1: 'நாளை', 2: 'நாளை மறுநாள்', '-2': 'நேற்று முன் தினம்', '-1': 'நேற்று' },
          relativeTime: {
        ...
        'hour-short': {
          ...
          relative: { 0: 'இந்த ஒரு மணிநேரத்தில்' },
          relativeTime: {
            future: { one: '{0} மணி.', other: '{0} மணி.' },
            past: { one: '{0} மணி. முன்', other: '{0} மணி. முன்' }
          }
        },
        minute: {
          displayName: 'நிமிடம்',
          ...
          relativeTime: {
            ...
            past: { one: '{0} நிமிடத்திற்கு முன்', other: '{0} நிமிடங்களுக்கு முன்' }
          }
        },
        'minute-short': {
          displayName: 'நிமி.',
          relative: { 0: 'இந்த ஒரு நிமிடத்தில்' },
          relativeTime: {
            future: { one: '{0} நிமி.', other: '{0} நிமி.' },
            past: { one: '{0} நிமி. முன்', other: '{0} நிமி. முன்' }
          }
        },
        second: {
          displayName: 'விநாடி',
        ...
        'second-short': {
          ...
          relative: { 0: 'இப்போது' },
          relativeTime: {
            future: { one: '{0} விநா.', other: '{0} விநா.' },
            past: { one: '{0} விநா. முன்', other: '{0} விநா. முன்' }
          }
        }
      }
    },
    ...
    { locale: 'ta-SG', parentLocale: 'ta' },
    {
      ...
      fields: {
        year: {
          ...
          relative: { 0: 'ఈ సంవత్సరం', 1: 'తదుపరి సంవత్సరం', '-1': 'గత సంవత్సరం' },
          relativeTime: {
        ...
        'year-short': {
          ...
          relative: { 0: 'ఈ సంవత్సరం', 1: 'తదుపరి సంవత్సరం', '-1': 'గత సంవత్సరం' },
          relativeTime: {
            future: { one: '{0} సం.లో', other: '{0} సం.ల్లో' },
            past: { one: '{0} సం. క్రితం', other: '{0} సం. క్రితం' }
          }
        },
        month: {
          displayName: 'నెల',
        ...
        day: {
          displayName: 'దినం',
          relative: { 0: 'ఈ రోజు', 1: 'రేపు', 2: 'ఎల్లుండి', '-2': 'మొన్న', '-1': 'నిన్న' },
          relativeTime: {
        ...
        'hour-short': {
          ...
          relative: { 0: 'ఈ గంట' },
          relativeTime: {
            future: { one: '{0} గం.లో', other: '{0} గం.లో' },
            past: { one: '{0} గం. క్రితం', other: '{0} గం. క్రితం' }
          }
        },
        minute: {
          displayName: 'నిమిషము',
        ...
        'minute-short': {
          ...
          relative: { 0: 'ఈ నిమిషం' },
          relativeTime: {
            future: { one: '{0} నిమి.లో', other: '{0} నిమి.లో' },
            past: { one: '{0} నిమి. క్రితం', other: '{0} నిమి. క్రితం' }
          }
        },
        second: {
          displayName: 'సెకను',
        ...
        'second-short': {
          ...
          relativeTime: {
            future: { one: '{0} సెకనులో', other: '{0} సెకన్లలో' },
            past: { one: '{0} సెక. క్రితం', other: '{0} సెక. క్రితం' }
          }
        }
      }
    },
    ...
    { locale: 'teo-KE', parentLocale: 'teo' },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'рӯз',
          relative: { 0: 'имрӯз', 1: 'фардо', '-1': 'дирӯз' },
          relativeTime: { future: { other: '+{0} d' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'рӯз',
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          displayName: 'ปี',
          relative: { 0: 'ปีนี้', 1: 'ปีหน้า', '-1': 'ปีที่แล้ว' },
          relativeTime: { future: { other: 'ใน {0} ปี' }, past: { other: '{0} ปีที่แล้ว' } }
        },
        month: {
          displayName: 'เดือน',
        ...
        'month-short': {
          displayName: 'เดือน',
          relative: { 0: 'เดือนนี้', 1: 'เดือนหน้า', '-1': 'เดือนที่แล้ว' },
          relativeTime: { future: { other: 'ใน {0} เดือน' }, past: { other: '{0} เดือนที่แล้ว' } }
        },
        day: {
          displayName: 'วัน',
          relative: { 0: 'วันนี้', 1: 'พรุ่งนี้', 2: 'มะรืนนี้', '-2': 'เมื่อวานซืน', '-1': 'เมื่อวาน' },
          relativeTime: { future: { other: 'ในอีก {0} วัน' }, past: { other: '{0} วันที่ผ่านมา' } }
        },
        'day-short': {
          displayName: 'วัน',
          relative: { 0: 'วันนี้', 1: 'พรุ่งนี้', 2: 'มะรืนนี้', '-2': 'เมื่อวานซืน', '-1': 'เมื่อวาน' },
          relativeTime: { future: { other: 'ใน {0} วัน' }, past: { other: '{0} วันที่แล้ว' } }
        },
        hour: {
          displayName: 'ชั่วโมง',
        ...
        'hour-short': {
          displayName: 'ชม.',
          relative: { 0: 'ชั่วโมงนี้' },
          relativeTime: { future: { other: 'ใน {0} ชม.' }, past: { other: '{0} ชม. ที่แล้ว' } }
        },
        minute: {
          displayName: 'นาที',
          relative: { 0: 'นาทีนี้' },
        ...
        'minute-short': {
          displayName: 'น.',
          relative: { 0: 'นาทีนี้' },
          relativeTime: { future: { other: 'ใน {0} นาที' }, past: { other: '{0} นาทีที่แล้ว' } }
        },
        second: {
          displayName: 'วินาที',
          relative: { 0: 'ขณะนี้' },
        ...
        'second-short': {
          displayName: 'วิ',
          relative: { 0: 'ขณะนี้' },
          relativeTime: { future: { other: 'ใน {0} วินาที' }, past: { other: '{0} วินาทีที่แล้ว' } }
        }
      }
    },
    {
      ...
      fields: {
        year: {
          displayName: 'ዓመት',
          relative: { 0: 'ሎሚ ዓመት', 1: 'ንዓመታ', '-1': 'ዓሚ' },
          relativeTime: {
            future: { one: 'ኣብ {0} ዓ', other: 'ኣብ {0} ዓ' },
            past: { one: 'ቅድሚ {0} ዓ', other: 'ቅድሚ {0} ዓ' }
          }
        },
        'year-short': {
          displayName: 'ዓመት',
        ...
        month: {
          displayName: 'ወርሒ',
          relative: { 0: 'ህሉው ወርሒ', 1: 'ዝመጽእ ወርሒ', '-1': 'last month' },
          relativeTime: {
            future: { one: 'ኣብ {0} ወርሒ', other: 'ኣብ {0} ወርሒ' },
            past: { one: 'ቅድሚ {0} ወርሒ', other: 'ቅድሚ {0} ወርሒ' }
          }
        },
        'month-short': {
          displayName: 'ወርሒ',
        ...
        day: {
          displayName: 'መዓልቲ',
          relative: { 0: 'ሎሚ', 1: 'ጽባሕ', '-1': 'ትማሊ' },
          relativeTime: {
            future: { one: 'ኣብ {0} መዓልቲ', other: 'ኣብ {0} መዓልቲ' },
            past: { one: 'ቅድሚ {0} መዓልቲ', other: 'ኣብ {0} መዓልቲ' }
          }
        },
        'day-short': {
          displayName: 'መዓልቲ',
          ...
          relativeTime: {
            future: { one: 'ኣብ {0} መዓልቲ', other: 'ኣብ {0} መዓልቲ' },
            past: { one: 'ቅድሚ {0} መዓልቲ', other: 'ቅድሚ {0} መዓልቲ' }
          }
        },
        hour: {
          displayName: 'ሰዓት',
          relative: { 0: 'ኣብዚ ሰዓት' },
          relativeTime: {
            future: { one: 'ኣብ {0} ሰዓት', other: 'ኣብ {0} ሰዓት' },
            past: { one: 'ቅድሚ {0} ሰዓት', other: 'ቅድሚ {0} ሰዓት' }
          }
        },
        'hour-short': {
          displayName: 'ሰዓት',
        ...
        minute: {
          ...
          relative: { 0: 'ኣብዚ ደቒቕ' },
          relativeTime: {
            future: { one: 'ኣብ {0} ደቒቕ', other: 'ኣብ {0} ደቒቕ' },
            past: { one: 'ቅድሚ {0} ደቒቕ', other: 'ቅድሚ {0} ደቒቕ' }
          }
        },
        'minute-short': {
          displayName: 'ደቒቕ',
        ...
        second: {
          ...
          relative: { 0: 'ሕጂ' },
          relativeTime: {
            future: { one: 'ኣብ {0} ካልኢት', other: 'ኣብ {0} ካልኢት' },
            past: { one: 'ቅድሚ {0} ካልኢት', other: 'ቅድሚ {0} ካልኢት' }
          }
        },
        'second-short': {
          displayName: 'ካልኢት',
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          ...
          relative: { 0: 'şu ýyl', 1: 'indiki ýyl', '-1': 'geçen ýyl' },
          relativeTime: {
            future: { one: '{0} ý-dan', other: '{0} ý-dan' },
            past: { one: '{0} ý. öň', other: '{0} ý. öň' }
          }
        },
        month: {
          displayName: 'aý',
        ...
        'day-short': {
          ...
          relative: { 0: 'şu gün', 1: 'ertir', '-1': 'düýn' },
          relativeTime: {
            future: { one: '{0} g-den', other: '{0} g-den' },
            past: { one: '{0} g. öň', other: '{0} g. öň' }
          }
        },
        hour: {
          displayName: 'sagat',
        ...
        'hour-short': {
          ...
          relative: { 0: 'şu sagat' },
          relativeTime: {
            future: { one: '{0} sag-dan', other: '{0} sag-dan' },
            past: { one: '{0} sag. öň', other: '{0} sag. öň' }
          }
        },
        minute: {
          displayName: 'minut',
        ...
        'minute-short': {
          ...
          relative: { 0: 'şu minut' },
          relativeTime: {
            future: { one: '{0} min-dan', other: '{0} min-dan' },
            past: { one: '{0} min. öň', other: '{0} min. öň' }
          }
        },
        second: {
          displayName: 'sekunt',
        ...
        'second-short': {
          ...
          relative: { 0: 'häzir' },
          relativeTime: {
            future: { one: '{0} sek-dan', other: '{0} sek-dan' },
            past: { one: '{0} sek. öň', other: '{0} sek. öň' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: { future: { other: 'ʻi he taʻu ʻe {0}' }, past: { other: 'taʻu ʻe {0} kuoʻosi' } }
        },
        'year-short': {
          displayName: 'taʻu',
          relative: { 0: 'taʻú ni', 1: 'taʻu kahaʻu', '-1': 'taʻu kuoʻosi' },
        ...
        month: {
          displayName: 'māhina',
          relative: { 0: 'māhiná ni', 1: 'māhina kahaʻu', '-1': 'māhina kuoʻosi' },
          relativeTime: { future: { other: 'ʻi he māhina ʻe {0}' }, past: { other: 'māhina ʻe {0} kuoʻosi' } }
        },
        'month-short': {
          displayName: 'māhina',
          relative: { 0: 'māhiná ni', 1: 'māhina kahaʻu', '-1': 'māhina kuoʻosi' },
        ...
        day: {
          displayName: 'ʻaho',
          relative: { 0: 'ʻahó ni', 1: 'ʻapongipongi', 2: 'ʻahepongipongi', '-2': 'ʻaneheafi', '-1': 'ʻaneafi' },
          relativeTime: { future: { other: 'ʻi he ʻaho ʻe {0}' }, past: { other: 'ʻaho ʻe {0} kuoʻosi' } }
        },
        'day-short': {
          displayName: 'ʻaho',
          relative: { 0: 'ʻahó ni', 1: 'ʻapongipongi', 2: 'ʻahepongipongi', '-2': 'ʻaneheafi', '-1': 'ʻaneafi' },
        ...
        hour: {
          displayName: 'houa',
          relative: { 0: 'this hour' },
          relativeTime: { future: { other: 'ʻi he houa ʻe {0}' }, past: { other: 'houa ʻe {0} kuoʻosi' } }
        },
        'hour-short': {
          displayName: 'houa',
          relative: { 0: 'this hour' },
        ...
        minute: {
          displayName: 'miniti',
          relative: { 0: 'this minute' },
          relativeTime: { future: { other: 'ʻi he miniti ʻe {0}' }, past: { other: 'miniti ʻe {0} kuoʻosi' } }
        },
        'minute-short': {
          displayName: 'miniti',
          relative: { 0: 'this minute' },
        ...
        second: {
          displayName: 'sekoni',
          relative: { 0: 'taimí ni' },
          relativeTime: { future: { other: 'ʻi he sekoni ʻe {0}' }, past: { other: 'sekoni ʻe {0} kuoʻosi' } }
        },
        'second-short': {
          displayName: 'sekoni',
          relative: { 0: 'taimí ni' },
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'gün',
          relative: { 0: 'bugün', 1: 'yarın', 2: 'öbür gün', '-2': 'evvelsi gün', '-1': 'dün' },
          relativeTime: {
        ...
        'hour-short': {
          ...
          relative: { 0: 'bu saat' },
          relativeTime: {
            future: { one: '{0} sa. sonra', other: '{0} sa. sonra' },
            past: { one: '{0} sa. önce', other: '{0} sa. önce' }
          }
        },
        minute: {
          displayName: 'dakika',
        ...
        'minute-short': {
          ...
          relative: { 0: 'bu dakika' },
          relativeTime: {
            future: { one: '{0} dk. sonra', other: '{0} dk. sonra' },
            past: { one: '{0} dk. önce', other: '{0} dk. önce' }
          }
        },
        second: {
          displayName: 'saniye',
        ...
        'second-short': {
          ...
          relative: { 0: 'şimdi' },
          relativeTime: {
            future: { one: '{0} sn. sonra', other: '{0} sn. sonra' },
            past: { one: '{0} sn. önce', other: '{0} sn. önce' }
          }
        }
      }
    },
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'көн',
          relative: { 0: 'бүген', 1: 'иртәгә', '-1': 'кичә' },
          relativeTime: { future: { other: '+{0} d' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'көн',
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          ...
          relative: { 0: 'цього року', 1: 'наступного року', '-1': 'торік' },
          relativeTime: {
            future: { one: 'через {0} р.', few: 'через {0} р.', many: 'через {0} р.', other: 'через {0} р.' },
            past: { one: '{0} р. тому', few: '{0} р. тому', many: '{0} р. тому', other: '{0} р. тому' }
          }
        },
        month: {
          displayName: 'місяць',
        ...
        'month-short': {
          ...
          relative: { 0: 'цього місяця', 1: 'наступного місяця', '-1': 'минулого місяця' },
          relativeTime: {
            future: { one: 'через {0} міс.', few: 'через {0} міс.', many: 'через {0} міс.', other: 'через {0} міс.' },
            past: { one: '{0} міс. тому', few: '{0} міс. тому', many: '{0} міс. тому', other: '{0} міс. тому' }
          }
        },
        day: {
          displayName: 'день',
          relative: { 0: 'сьогодні', 1: 'завтра', 2: 'післязавтра', '-2': 'позавчора', '-1': 'учора' },
          relativeTime: {
        ...
        'day-short': {
          ...
          relativeTime: {
            future: { one: 'через {0} дн.', few: 'через {0} дн.', many: 'через {0} дн.', other: 'через {0} дн.' },
            past: { one: '{0} дн. тому', few: '{0} дн. тому', many: '{0} дн. тому', other: '{0} дн. тому' }
          }
        },
        hour: {
          displayName: 'година',
        ...
        'hour-short': {
          ...
          relative: { 0: 'цієї години' },
          relativeTime: {
            future: { one: 'через {0} год', few: 'через {0} год', many: 'через {0} год', other: 'через {0} год' },
            past: { one: '{0} год тому', few: '{0} год тому', many: '{0} год тому', other: '{0} год тому' }
          }
        },
        minute: {
          displayName: 'хвилина',
        ...
        'minute-short': {
          ...
          relative: { 0: 'цієї хвилини' },
          relativeTime: {
            future: { one: 'через {0} хв', few: 'через {0} хв', many: 'через {0} хв', other: 'через {0} хв' },
            past: { one: '{0} хв тому', few: '{0} хв тому', many: '{0} хв тому', other: '{0} хв тому' }
          }
        },
        second: {
          displayName: 'секунда',
        ...
        'second-short': {
          ...
          relative: { 0: 'зараз' },
          relativeTime: {
            future: { one: 'через {0} с', few: 'через {0} с', many: 'через {0} с', other: 'через {0} с' },
            past: { one: '{0} с тому', few: '{0} с тому', many: '{0} с тому', other: '{0} с тому' }
          }
        }
      }
    },
    {
      ...
      fields: {
        ...
        month: {
          displayName: 'مہینہ',
          relative: { 0: 'اس مہینہ', 1: 'اگلا مہینہ', '-1': 'پچھلا مہینہ' },
          relativeTime: {
        ...
        day: {
          displayName: 'دن',
          relative: { 0: 'آج', 1: 'آئندہ کل', 2: 'آنے والا پرسوں', '-2': 'گزشتہ پرسوں', '-1': 'گزشتہ کل' },
          relativeTime: {
        ...
        hour: {
          ...
          relative: { 0: 'اس گھنٹے' },
          relativeTime: {
            future: { one: '{0} گھنٹے میں', other: '{0} گھنٹے میں' },
        ...
        'hour-short': {
          ...
          relativeTime: {
            future: { one: '{0} گھنٹے میں', other: '{0} گھنٹے میں' },
            past: { one: '{0} گھنٹے پہلے', other: '{0} گھنٹے پہلے' }
          }
        },
        minute: {
          displayName: 'منٹ',
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          ...
          relativeTime: {
            future: { one: '{0} سال میں', other: '{0} سالوں میں' },
            past: { one: '{0} سال پہلے', other: '{0} سالوں پہلے' }
          }
        },
        month: {
          displayName: 'مہینہ',
        ...
        'day-short': {
          ...
          relative: { 0: 'آج', 1: 'آئندہ کل', 2: 'آنے والا پرسوں', '-2': 'گزشتہ پرسوں', '-1': 'گزشتہ کل' },
          relativeTime: {
            future: { one: '{0} دنوں میں', other: '{0} دنوں میں' },
            past: { one: '{0} دن پہلے', other: '{0} دنوں پہلے' }
          }
        },
        hour: {
        ...
        'hour-short': {
          ...
          relativeTime: {
            future: { one: '{0} گھنٹے میں', other: '{0} گھنٹے میں' },
            past: { one: '{0} گھنٹے قبل', other: '{0} گھنٹے قبل' }
          }
        },
        minute: {
          displayName: 'منٹ',
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          displayName: 'yil',
          relative: { 0: 'bu yil', 1: 'keyingi yil', '-1': 'oʻtgan yil' },
          relativeTime: {
            future: { one: '{0} yildan keyin', other: '{0} yildan keyin' },
            past: { one: '{0} yil oldin', other: '{0} yil oldin' }
          }
    ...
    },
    {
      ...
      fields: {
        year: {
          ...
          relativeTime: { future: { other: 'sau {0} năm nữa' }, past: { other: '{0} năm trước' } }
        },
        'year-short': {
          displayName: 'Năm',
          relative: { 0: 'năm nay', 1: 'năm sau', '-1': 'năm ngoái' },
        ...
        day: {
          displayName: 'Ngày',
          relative: { 0: 'Hôm nay', 1: 'Ngày mai', 2: 'Ngày kia', '-2': 'Hôm kia', '-1': 'Hôm qua' },
          relativeTime: { future: { other: 'sau {0} ngày nữa' }, past: { other: '{0} ngày trước' } }
        },
        'day-short': {
          displayName: 'Ngày',
          relative: { 0: 'Hôm nay', 1: 'Ngày mai', 2: 'Ngày kia', '-2': 'Hôm kia', '-1': 'Hôm qua' },
        ...
        hour: {
          displayName: 'Giờ',
          relative: { 0: 'giờ này' },
          relativeTime: { future: { other: 'sau {0} giờ nữa' }, past: { other: '{0} giờ trước' } }
        },
        'hour-short': {
          displayName: 'Giờ',
          relative: { 0: 'giờ này' },
        ...
        minute: {
          displayName: 'Phút',
          relative: { 0: 'phút này' },
          relativeTime: { future: { other: 'sau {0} phút nữa' }, past: { other: '{0} phút trước' } }
        },
        'minute-short': {
          displayName: 'Phút',
          relative: { 0: 'phút này' },
        ...
        second: {
          displayName: 'Giây',
          relative: { 0: 'bây giờ' },
          relativeTime: { future: { other: 'sau {0} giây nữa' }, past: { other: '{0} giây trước' } }
        },
        'second-short': {
          displayName: 'Giây',
          relative: { 0: 'bây giờ' },
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'Tag',
          relative: { 0: 'Hitte', 1: 'Móre', 2: 'Ubermóre', '-2': 'Vorgešter', '-1': 'Gešter' },
          relativeTime: {
    ...
    },
    {
      ...
      fields: {
        ...
        'year-short': {
          ...
          relative: { 0: 'הײַ יאָר', 1: 'איבער א יאָר', '-1': 'פֿאַראַיאָר' },
          relativeTime: {
            future: { one: 'איבער א יאָר', other: 'איבער {0} יאָר' },
            past: { one: 'פֿאַר {0} יאָר', other: 'פֿאַר {0} יאָר' }
          }
        },
        month: {
          displayName: 'מאנאַט',
          relative: { 0: 'דעם חודש', 1: 'קומענדיקן חודש', '-1': 'פֿאַרגאנגענעם חודש' },
          relativeTime: {
        ...
        day: {
          ...
          relativeTime: { future: { one: 'אין {0} טאָג אַרום', other: 'אין {0} טעג אַרום' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'טאָג',
          relative: { 0: 'היינט', 1: 'מארגן', '-1': 'נעכטן' },
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'Ọjọ́',
          relative: { 0: 'Òní', 1: 'Ọ̀la', 2: 'òtúùnla', '-2': 'íjẹta', '-1': 'Àná' },
          relativeTime: { future: { other: '+{0} d' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'Ọjọ́',
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: 'Ɔjɔ́',
          relative: { 0: 'Òní', 1: 'Ɔ̀la', 2: 'òtúùnla', '-2': 'íjɛta', '-1': 'Àná' },
          relativeTime: { future: { other: '+{0} d' }, past: { other: '-{0} d' } }
        },
        'day-short': {
          displayName: 'Ɔjɔ́',
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: '日',
          relative: { 0: '今日', 1: '聽日', 2: '後天', '-2': '前天', '-1': '尋日' },
          relativeTime: { future: { other: '{0} 日後' }, past: { other: '{0} 日前' } }
        },
        'day-short': {
          displayName: '日',
    ...
    },
    {
      ...
      fields: {
        ...
        day: {
          displayName: '日',
          relative: { 0: '今日', 1: '听日', 2: '后天', '-2': '前天', '-1': '寻日' },
          relativeTime: { future: { other: '{0} 日后' }, past: { other: '{0} 日前' } }
        },
        'day-short': {
          displayName: '日',
          relative: { 0: '今日', 1: '听日', 2: '后天', '-2': '前天', '-1': '寻日' },
    ...
    { locale: 'yue-Hant', parentLocale: 'yue' },
    {
      locale: 'zgh',
      pluralRuleFunction: function (e, t) {
        return 'other';
    ...
    { locale: 'zh-Hant-MO', parentLocale: 'zh-Hant-HK' },
    {
      ...
      fields: {
        year: {
          displayName: 'Unyaka',
          relative: { 0: 'kulo nyaka', 1: 'unyaka ozayo', '-1': 'onyakeni odlule' },
          relativeTime: {
            future: { one: 'onyakeni ongu-{0} ozayo', other: 'eminyakeni engu-{0} ezayo' },
        ...
        'year-short': {
          ...
          relativeTime: {
            future: { one: 'onyakeni ongu-{0} ozayo', other: 'eminyakeni engu-{0} ezayo' },
            past: { one: '{0} unyaka odlule', other: '{0} unyaka odlule' }
          }
        },
        month: {
          displayName: 'Inyanga',
          relative: { 0: 'le nyanga', 1: 'inyanga ezayo', '-1': 'inyanga edlule' },
          relativeTime: {
            future: { one: 'enyangeni engu-{0}', other: 'ezinyangeni ezingu-{0} ezizayo' },
        ...
        'month-short': {
          ...
          relative: { 0: 'le nyanga', 1: 'inyanga ezayo', '-1': 'inyanga edlule' },
          relativeTime: {
            future: { one: 'ezinyangeni ezingu-{0} ezizayo', other: 'ezinyangeni ezingu-{0} ezizayo' },
            past: { one: '{0} izinyanga ezedlule', other: '{0} izinyanga ezedlule' }
          }
        },
        day: {
          displayName: 'Usuku',
          ...
          relativeTime: {
            future: { one: 'osukwini olungu-{0} oluzayo', other: 'ezinsukwini ezingu-{0} ezizayo' },
            past: { one: 'osukwini olungu-{0} olwedlule', other: 'ezinsukwini ezingu-{0} ezedlule.' }
          }
        },
        'day-short': {
          displayName: 'Usuku',
          ...
          relativeTime: {
            future: { one: 'osukwini olungu-{0} oluzayo', other: 'ezinsukwini ezingu-{0} ezizayo' },
            past: { one: '{0} usuku olwedlule', other: '{0} izinsuku ezedlule' }
          }
        },
        hour: {
          displayName: 'Ihora',
          ...
          relativeTime: {
            future: { one: 'ehoreni elingu-{0} elizayo', other: 'emahoreni angu-{0} ezayo' },
            past: { one: '{0} ihora eledlule', other: 'emahoreni angu-{0} edlule' }
          }
        },
        'hour-short': {
          displayName: 'Ihora',
        ...
        minute: {
          ...
          relativeTime: {
            future: { one: 'kuminithi elingu-{0} elizayo', other: 'kumaminithi angu-{0} ezayo' },
            past: { one: '{0} iminithi eledlule', other: '{0} amaminithi edlule' }
          }
        },
        'minute-short': {
          displayName: 'Iminithi',
        ...
        second: {
          ...
          relative: { 0: 'manje' },
          relativeTime: {
            future: { one: 'kusekhondi elingu-{0} elizayo', other: 'kumasekhondi angu-{0} ezayo' },
            past: { one: '{0} isekhondi eledlule', other: '{0} amasekhondi edlule' }
          }
        },
        'second-short': {
          displayName: 'Isekhondi',
