...
test('invalidRect', () => {
  ...
  expect(monitorLayoutReducer(reduxState, addMonitorRect(1, { x: 100, y: 100 }, { x: 10, y: 200 }))).toEqual(
    reduxState
  );

  // Problem: y end is before y start
  expect(monitorLayoutReducer(reduxState, addMonitorRect(1, { x: 100, y: 100 }, { x: 200, y: 10 }))).toEqual(
    reduxState
  );
});
...
test('invalidMoveMonitorRect', () => {
  ...
  expect(monitorLayoutReducer(reduxState, moveMonitorRect(monitorId, 1 /* newX */, 1 /* newY */))).toEqual(reduxState);
