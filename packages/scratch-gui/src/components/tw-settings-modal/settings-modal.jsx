...
const CustomFPS = (props) => (
  <BooleanSetting
    ...
    label={
      <FormattedMessage defaultMessage="60 FPS (Custom FPS)" description="FPS setting" id="tw.settingsModal.fps" />
    }
    help={
      <FormattedMessage
        // eslint-disable-next-line max-len
...
const WarpTimer = (props) => (
  <BooleanSetting
    {...props}
    label={
      <FormattedMessage defaultMessage="Warp Timer" description="Warp Timer setting" id="tw.settingsModal.warpTimer" />
    }
    help={
      <FormattedMessage
        // eslint-disable-next-line max-len
...
const WarningTip = (props) => {
  return <div className={styles.warning}>{props.children}</div>;
};
const SettingsModalComponent = (props) => {
  ...
  return (
    ...
    >
      ...
      >
        <button
          className={settingsTab == 1 ? styles.tabButtonEnable : styles.tabButtonUnable}
          style={{
        ...
        >
          <FormattedMessage defaultMessage="Project" description="Settings modal tab" id="tw.settingsModal.project" />
        </button>
        <button
          className={settingsTab == 2 ? styles.tabButtonEnable : styles.tabButtonUnable}
          style={{
            display: 'inline-block',
            width: `50%`,
            height: '100%'
        ...
        {settingsTab == 2 && (
          <>
            ...
            <AutoDisplayREADME
              ...
              onChange={(e) => {
                set('enableREADMEAutoDisplay', e.target.checked);
                update();
              }}
            />
            <EnableHTMLSupportREADME
              ...
              onChange={(e) => {
                set('enableHTMLSupportInREADME', e.target.checked);
                update();
              }}
            />
            <Header>
            ...
            <SkipCustomExtWarn
              ...
              onChange={(e) => {
                set('skipExtWarn', e.target.checked);
                update();
              }}
            />
            <Header>
            ...
            <EnableVSCodeLayout
              ...
              onChange={(e) => {
                set('EnableVSCodeLayout', e.target.checked);
                location.reload();
                update();
              }}
            />
