...
class MonacoEditorComponent extends React.Component {
  ...
  updateEditorContent() {
    ...
    if (activeFile) {
      ...
      const newModel = monaco.editor.createModel(activeFile.content, getFileLanguage(extension));
  ...
  updateFileContent = (fileId, content) => {
    this.setState((prevState) => ({
      files: prevState.files.map((f) => (f.id === fileId ? { ...f, content } : f)),
      blockGenerationStatus: null
    }));
  };
  ...
  handleRenameSubmit = () => {
    ...
    this.setState((prevState) => ({
      files: prevState.files.map((f) => (f.id === editingFileName ? { ...f, name: finalName } : f)),
      editingFileName: null,
      newFileName: ''
    }));
  };
        ...
        <Box className={styles.settingsModalContent}>
          <div className={styles.settingsSection}>
            <span className={styles.settingsSectionTitle}>
              <FormattedMessage defaultMessage="Editor" id="gui.monacoEditor.settingsEditor" />
            </span>
            <div className={styles.settingsRow}>
              <label className={styles.settingsLabel}>
                <FormattedMessage defaultMessage="Font Size" id="gui.monacoEditor.settingsFontSize" />
              </label>
              <input
                type="number"
            ...
            <div className={styles.settingsRow}>
              <label className={styles.settingsLabel}>
                <FormattedMessage defaultMessage="Tab Size" id="gui.monacoEditor.settingsTabSize" />
              </label>
              <select
            ...
            <div className={styles.settingsRow}>
              <label className={styles.settingsLabel}>
                <FormattedMessage defaultMessage="Word Wrap" id="gui.monacoEditor.settingsWordWrap" />
              </label>
              <input
                type="checkbox"
            ...
            <div className={styles.settingsRow}>
              <label className={styles.settingsLabel}>
                <FormattedMessage defaultMessage="Bracket Matching" id="gui.monacoEditor.settingsBracketMatching" />
              </label>
              <select
                className={styles.settingsSelect}
          ...
          <div className={styles.settingsSection}>
            <span className={styles.settingsSectionTitle}>
              <FormattedMessage defaultMessage="View" id="gui.monacoEditor.settingsView" />
            </span>
            <div className={styles.settingsRow}>
              <label className={styles.settingsLabel}>
                <FormattedMessage defaultMessage="Minimap" id="gui.monacoEditor.settingsMinimap" />
              </label>
              <input
                type="checkbox"
                className={styles.settingsCheckbox}
            ...
            <div className={styles.settingsRow}>
              <label className={styles.settingsLabel}>
                <FormattedMessage defaultMessage="Line Numbers" id="gui.monacoEditor.settingsLineNumbers" />
              </label>
              <select
                className={styles.settingsSelect}
            ...
            <div className={styles.settingsRow}>
              <label className={styles.settingsLabel}>
                <FormattedMessage defaultMessage="Smooth Scrolling" id="gui.monacoEditor.settingsSmoothScrolling" />
              </label>
              <input
                type="checkbox"
                className={styles.settingsCheckbox}
            ...
            <div className={styles.settingsRow}>
              <label className={styles.settingsLabel}>
                <FormattedMessage defaultMessage="Folding" id="gui.monacoEditor.settingsFolding" />
              </label>
              <input
                type="checkbox"
                className={styles.settingsCheckbox}
      ...
      <React.Fragment>
        <div className={styles.editorWrapper}>
            ...
            {this.state.showNewFileInput ? (
              <div className={styles.newFileSection}>
                ...
                <div className={styles.newFileActions}>
                  <button onClick={this.handleNewFileSubmit} className={styles.newFileBtnCreate}>
                    <FormattedMessage
                  ...
                  <button onClick={this.handleNewFileCancel} className={styles.newFileBtnCancel}>
                    <FormattedMessage
              ...
              <div className={styles.newFileTrigger} onClick={this.createNewFile}>
          ...
          <div className={styles.editorArea}>
              ...
              <div className={styles.editorHeader}>
                <div className={styles.editorHeaderLeft}>
                  <div
                    className={classNames(styles.fileIcon, {
                      [styles.lightText]:
                        getFileTypeInfo(activeExtension).color === '#f7df1e' ||
                        getFileTypeInfo(activeExtension).color === '#cbcb41'
                    })}
                ...
                <div className={styles.editorHeaderRight}>
                  <div className={styles.zoomControl}>
                    ...
                    <span className={styles.zoomValue}>{this.state.fontSize}px</span>
                    <button
                      onClick={this.zoomIn}
                      className={styles.zoomBtn}
            ...
            {(activeFile || this.state.files.length > 0) && (
              <div ref={this.containerRef} className={styles.editorContent} />
            )}
          </div>
        </div>
      ...
      >
        <Box className={styles.modalBox}>
          <div className={styles.modalHeader}>
            ...
            >
              {allSelected ? (
                <FormattedMessage defaultMessage="Deselect all" id="gui.monacoEditor.deselectAll" />
              ) : (
                <FormattedMessage defaultMessage="Select all" id="gui.monacoEditor.selectAll" />
              )}
            </button>
          </div>
          <div className={styles.modalBody}>
                ...
                >
                  ...
                  <span className={styles.modalFunctionCount}>
                    {funcCount > 0 ? (
                      ...
                      <FormattedMessage defaultMessage="No exports" id="gui.monacoEditor.noExports" />
                    )}
                  </span>
                </div>
              );
            ...
            {pythonFiles.length === 0 && (
              <p className={styles.modalEmptyText}>
                <FormattedMessage defaultMessage="No Python files" id="gui.monacoEditor.noPythonFiles" />
              </p>
            )}
          </div>
          <div className={styles.modalButtons}>
            <button className={styles.modalCancelBtn} onClick={this.closeFileSelectionModal}>
              <FormattedMessage defaultMessage="Cancel" description="Cancel button" id="gui.monacoEditor.cancel" />
            </button>
            <button
              className={classNames(styles.modalConfirmBtn, {
                [styles.disabled]: this.state.selectedFileIds.length === 0
              })}
