...
!(function (t, e) {
  ...
  const ti = (t) => 0 === t || 1 === t,
    ...
    si = {
      ...
      easeInOutExpo: (t) =>
        ti(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (2 * t - 1)) : 0.5 * (2 - Math.pow(2, -10 * (2 * t - 1))),
  ...
  class $s extends Es {
    ...
    _computeGridLineItems(t) {
      ...
      if ('top' === a) ((b = m(this.bottom)), (w = this.bottom - d), (k = b - p), (P = m(t.top) + p), (O = t.bottom));
        ...
        ((b = m(this.right)), (v = this.right - d), (M = b - p), (S = m(t.left) + p), (D = t.right));
      else if ('right' === a)
  ...
  class Eo extends Es {
    ...
    drawTitle() {
      ...
      let h,
        ...
        d = this.width;
      if (this.isHorizontal())
        ((d = Math.max(...this.lineWidths)), (h = this.top + l), (c = ut(t.align, c, this.right - d)));
      else {
