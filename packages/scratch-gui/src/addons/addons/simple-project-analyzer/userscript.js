...
export default function ({ addon, msg, console }) {
  ...
  class SimpleProjectAnalyzer {
    ...
    calculateDrScratchScores(projectData) {
      ...
      const hasClones =
        controlBlockTypes.has('control_create_clone_of') || controlBlockTypes.has('control_start_as_clone');
      ...
      const hasBackdropChange =
        looksBlockTypes.has('looks_nextbackdrop') || looksBlockTypes.has('looks_switchbackdropto');
